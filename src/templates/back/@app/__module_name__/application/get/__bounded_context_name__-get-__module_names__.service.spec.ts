...
describe('{{ toPascalCase schema.boundedContextName }}Get{{ toPascalCase schema.moduleNames }}Service', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        service = module.get({{ toPascalCase schema.boundedContextName }}Get{{ toPascalCase schema.moduleNames }}Service);
