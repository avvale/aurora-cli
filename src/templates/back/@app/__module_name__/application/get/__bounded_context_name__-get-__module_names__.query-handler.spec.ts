{{
    setVar 'importsArray' (
        array
            ...
            (
                object
                    items=(sumStrings (toPascalCase schema.boundedContextName) 'Get' (toPascalCase schema.moduleNames) 'QueryHandler')
                    path=(sumStrings config.appContainer '/' (toKebabCase schema.boundedContextName) '/' (toKebabCase schema.moduleName) '/application/get/' (toKebabCase schema.boundedContextName) '-get-' (toKebabCase schema.moduleNames) '.query-handler')
            )
    )
~}}
...
{
    let queryHandler: {{ toPascalCase schema.boundedContextName }}Get{{ toPascalCase schema.moduleNames }}QueryHandler;
    let service: {{ toPascalCase schema.boundedContextName }}Get{{ toPascalCase schema.moduleNames }}Service;
    ...
    beforeAll(async () =>
    {
        const module: TestingModule = await Test.createTestingModule({
            providers: [
                ...
                {
                    provide : {{ toPascalCase schema.boundedContextName }}Get{{ toPascalCase schema.moduleNames }}Service,
                    useValue: {
                        main: () => { /**/ },
                    },
                },
        ...
        queryHandler = module.get<{{ toPascalCase schema.boundedContextName }}Get{{ toPascalCase schema.moduleNames }}QueryHandler>({{ toPascalCase schema.boundedContextName }}Get{{ toPascalCase schema.moduleNames }}QueryHandler);
        service = module.get<{{ toPascalCase schema.boundedContextName }}Get{{ toPascalCase schema.moduleNames }}Service>({{ toPascalCase schema.boundedContextName }}Get{{ toPascalCase schema.moduleNames }}Service);
    ...
    describe('main', () =>
    {
        test('{{ toPascalCase schema.boundedContextName }}Get{{ toPascalCase schema.moduleNames }}QueryHandler should be defined', () =>
        {
        ...
        test('should return an {{ toCamelCase schema.moduleNames }} founded', async () =>
        {
            ...
            expect(await queryHandler.execute(
                new {{ toPascalCase schema.boundedContextName }}Get{{ toPascalCase schema.moduleNames }}Query(),
