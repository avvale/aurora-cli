...
describe('application', () => {
    ...
    beforeAll(async () => {
        const module: TestingModule = await Test.createTestingModule({
            ...
            providers: [OAuthMockApplicationSeeder],
        })
        ...
        applicationRepository = module.get<OAuthIApplicationRepository>(
            OAuthIApplicationRepository,
        );
        applicationSeeder = module.get<OAuthMockApplicationSeeder>(
            OAuthMockApplicationSeeder,
        );
        ...
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for OAuthApplicationId must be defined, can not be null',
                );
            });
    });

    test('/REST:POST o-auth/application/create - Got 400 Conflict, ApplicationRowId property can not to be null', () => {
        return request(app.getHttpServer())
            .post('/o-auth/application/create')
            .set('Accept', 'application/json')
            .send({
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for OAuthApplicationRowId must be defined, can not be null',
                );
            });
    });
    ...
    test('/REST:POST o-auth/application/create - Got 400 Conflict, ApplicationCode property can not to be null', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for OAuthApplicationCode must be defined, can not be null',
                );
            });
    });
    ...
    test('/REST:POST o-auth/application/create - Got 400 Conflict, ApplicationName property can not to be null', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for OAuthApplicationName must be defined, can not be null',
                );
            });
    });
    ...
    test('/REST:POST o-auth/application/create - Got 400 Conflict, ApplicationSecret property can not to be null', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for OAuthApplicationSecret must be defined, can not be null',
                );
            });
    });
    ...
    test('/REST:POST o-auth/application/create - Got 400 Conflict, ApplicationIsMaster property can not to be null', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for OAuthApplicationIsMaster must be defined, can not be null',
                );
            });
    });
    ...
    test('/REST:POST o-auth/application/create - Got 400 Conflict, ApplicationId property can not to be undefined', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for OAuthApplicationId must be defined, can not be undefined',
                );
            });
    });

    test('/REST:POST o-auth/application/create - Got 400 Conflict, ApplicationRowId property can not to be undefined', () => {
        return request(app.getHttpServer())
            .post('/o-auth/application/create')
            .set('Accept', 'application/json')
            .send({
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for OAuthApplicationRowId must be defined, can not be undefined',
                );
            });
    });
    ...
    test('/REST:POST o-auth/application/create - Got 400 Conflict, ApplicationCode property can not to be undefined', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for OAuthApplicationCode must be defined, can not be undefined',
                );
            });
    });
    ...
    test('/REST:POST o-auth/application/create - Got 400 Conflict, ApplicationName property can not to be undefined', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for OAuthApplicationName must be defined, can not be undefined',
                );
            });
    });
    ...
    test('/REST:POST o-auth/application/create - Got 400 Conflict, ApplicationSecret property can not to be undefined', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for OAuthApplicationSecret must be defined, can not be undefined',
                );
            });
    });
    ...
    test('/REST:POST o-auth/application/create - Got 400 Conflict, ApplicationIsMaster property can not to be undefined', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for OAuthApplicationIsMaster must be defined, can not be undefined',
                );
            });
    });
    ...
    test('/REST:POST o-auth/application/create - Got 400 Conflict, ApplicationId is not allowed, must be a length of 36', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for OAuthApplicationId is not allowed, must be a length of 36',
                );
            });
    });
    ...
    test('/REST:POST o-auth/application/create - Got 400 Conflict, ApplicationCode is too large, has a maximum length of 64', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for OAuthApplicationCode is too large, has a maximum length of 64',
                );
            });
    });
    ...
    test('/REST:POST o-auth/application/create - Got 400 Conflict, ApplicationName is too large, has a maximum length of 128', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for OAuthApplicationName is too large, has a maximum length of 128',
                );
            });
    });
    ...
    test('/REST:POST o-auth/application/create - Got 400 Conflict, ApplicationSecret is too large, has a maximum length of 128', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for OAuthApplicationSecret is too large, has a maximum length of 128',
                );
            });
    });
    ...
    test('/REST:POST o-auth/application/create - Got 400 Conflict, ApplicationIsMaster has to be a boolean value', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for OAuthApplicationIsMaster has to be a boolean value',
                );
            });
    });
        ...
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body).toEqual({
                    ...
                    rows: applicationSeeder.collectionResponse
                        .map((item) =>
    ...
    test('/REST:POST o-auth/applications/get', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body).toEqual(
                    applicationSeeder.collectionResponse.map((item) =>
                        expect.objectContaining(
                            _.omit(item, [
                                'createdAt',
                                'updatedAt',
    ...
    test('/REST:POST o-auth/application/find/{id} - Got 404 Not Found', () => {
        return request(app.getHttpServer())
            .post(
                '/o-auth/application/find/a667176e-6937-5bf2-9ab3-58ec2e5d5cbf',
            )
            .set('Accept', 'application/json')
            .expect(404);
    });
    ...
    test('/REST:POST o-auth/application/find/{id}', () => {
        return request(app.getHttpServer())
            .post(
                '/o-auth/application/find/5b19d6ac-4081-573b-96b3-56964d5326a8',
            )
            .set('Accept', 'application/json')
            .expect(200)
            .then((res) => {
    ...
    test('/REST:DELETE o-auth/application/delete/{id} - Got 404 Not Found', () => {
        return request(app.getHttpServer())
            .delete(
                '/o-auth/application/delete/a769d002-3f18-5ceb-b62b-acd9963a2686',
            )
            .set('Accept', 'application/json')
            .expect(404);
    });
    ...
    test('/REST:DELETE o-auth/application/delete/{id}', () => {
        return request(app.getHttpServer())
            .delete(
                '/o-auth/application/delete/5b19d6ac-4081-573b-96b3-56964d5326a8',
            )
            .set('Accept', 'application/json')
            .expect(200);
    });
        ...
        return request(app.getHttpServer())
            ...
            .then((res) => {
                for (const [
                    index,
                    value,
                ] of res.body.data.oAuthGetApplications.entries()) {
                    expect(applicationSeeder.collectionResponse[index]).toEqual(
                        expect.objectContaining(
                            _.omit(value, [
                                'createdAt',
                                'updatedAt',
    ...
    test('/GraphQL oAuthCreateApplication', () => {
        return request(app.getHttpServer())
            ...
            .expect(200)
            .then((res) => {
                expect(res.body.data.oAuthCreateApplication).toHaveProperty(
                    'id',
                    '5b19d6ac-4081-573b-96b3-56964d5326a8',
                );
            });
    ...
    test('/GraphQL oAuthFindApplication', () => {
        return request(app.getHttpServer())
            ...
            .expect(200)
            .then((res) => {
                expect(res.body.data.oAuthFindApplication.id).toStrictEqual(
                    '5b19d6ac-4081-573b-96b3-56964d5326a8',
                );
            });
    });
    ...
    test('/GraphQL oAuthFindApplicationById', () => {
        return request(app.getHttpServer())
            ...
            .expect(200)
            .then((res) => {
                expect(res.body.data.oAuthFindApplicationById.id).toStrictEqual(
                    '5b19d6ac-4081-573b-96b3-56964d5326a8',
                );
            });
    });
    ...
    test('/GraphQL oAuthUpdateApplicationById', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(
                    res.body.data.oAuthUpdateApplicationById.id,
    ...
    test('/GraphQL oAuthUpdateApplications', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(
                    res.body.data.oAuthUpdateApplications[0].id,
                ).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
            });
    });
    ...
    test('/GraphQL oAuthDeleteApplicationById', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(
                    res.body.data.oAuthDeleteApplicationById.id,
                ).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
            });
    });
