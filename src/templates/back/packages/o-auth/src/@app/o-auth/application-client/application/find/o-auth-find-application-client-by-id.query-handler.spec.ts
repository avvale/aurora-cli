import { OAuthApplicationClientMapper, OAuthFindApplicationClientByIdQuery, OAuthIApplicationClientRepository, oAuthMockApplicationClientData, OAuthMockApplicationClientRepository } from '@app/o-auth/application-client';
...
describe('OAuthFindApplicationClientByIdQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<OAuthFindApplicationClientByIdQueryHandler>(OAuthFindApplicationClientByIdQueryHandler);
        service = module.get<OAuthFindApplicationClientByIdService>(OAuthFindApplicationClientByIdService);
