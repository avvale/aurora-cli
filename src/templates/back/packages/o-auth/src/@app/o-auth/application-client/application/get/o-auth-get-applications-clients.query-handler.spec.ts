import { OAuthApplicationClientMapper, OAuthGetApplicationsClientsQuery, OAuthIApplicationClientRepository, OAuthMockApplicationClientRepository } from '@app/o-auth/application-client';
...
describe('GetApplicationsClientsQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<OAuthGetApplicationsClientsQueryHandler>(OAuthGetApplicationsClientsQueryHandler);
        service = module.get<OAuthGetApplicationsClientsService>(OAuthGetApplicationsClientsService);
    ...
    describe('main', () =>
    {
        ...
        test('should return an applicationsClients founded', async () =>
        {
            ...
            expect(await queryHandler.execute(
                new OAuthGetApplicationsClientsQuery(),
