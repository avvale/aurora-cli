...
import { OAuthCreateApplicationClientCommand, oAuthMockApplicationClientData } from '@app/o-auth/application-client';
...
describe('OAuthCreateApplicationClientCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<OAuthCreateApplicationClientCommandHandler>(OAuthCreateApplicationClientCommandHandler);
    });
