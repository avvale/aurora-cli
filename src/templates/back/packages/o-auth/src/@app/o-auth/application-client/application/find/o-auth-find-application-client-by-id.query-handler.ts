...
export class OAuthFindApplicationClientByIdQueryHandler
    implements IQueryHandler<OAuthFindApplicationClientByIdQuery>
{
    ...
    async execute(
        query: OAuthFindApplicationClientByIdQuery,
    ): Promise<OAuthApplicationClientResponse> {
        const applicationClient =
            await this.findApplicationClientByIdService.main(
