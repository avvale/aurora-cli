import { OAuthApplicationClientMapper, OAuthApplicationClientResponse, OAuthFindApplicationClientQuery } from '@app/o-auth/application-client';
...
export class OAuthFindApplicationClientQueryHandler implements IQueryHandler<OAuthFindApplicationClientQuery>
{
    ...
    async execute(query: OAuthFindApplicationClientQuery): Promise<OAuthApplicationClientResponse>
    {
