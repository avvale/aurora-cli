...
@Injectable()
export class OAuthSequelizeRefreshTokenRepository
    extends SequelizeRepository<OAuthRefreshToken, OAuthRefreshTokenModel>
    implements OAuthIRefreshTokenRepository
{
    public readonly aggregateName: string = 'OAuthRefreshToken';
    public readonly mapper: OAuthRefreshTokenMapper =
