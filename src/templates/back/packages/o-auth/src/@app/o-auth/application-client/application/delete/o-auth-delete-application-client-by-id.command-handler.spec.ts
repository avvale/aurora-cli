import { OAuthDeleteApplicationClientByIdCommand, oAuthMockApplicationClientData } from '@app/o-auth/application-client';
...
describe('OAuthDeleteApplicationClientByIdCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<OAuthDeleteApplicationClientByIdCommandHandler>(OAuthDeleteApplicationClientByIdCommandHandler);
    });
