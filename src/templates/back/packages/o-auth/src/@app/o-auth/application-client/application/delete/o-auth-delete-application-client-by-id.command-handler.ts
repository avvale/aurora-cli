...
export class OAuthDeleteApplicationClientByIdCommandHandler
  implements ICommandHandler<OAuthDeleteApplicationClientByIdCommand>
{
  constructor(
  ...
  async execute(
    command: OAuthDeleteApplicationClientByIdCommand,
  ): Promise<void> {
