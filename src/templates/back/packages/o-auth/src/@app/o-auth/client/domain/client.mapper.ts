...
export class ClientMapper implements IMapper
{
    ...
    private makeAggregate(client: LiteralObject, cQMetadata?: CQMetadata): OAuthClient
    {
        return OAuthClient.register(
            ...
            new ClientScopeOptions(client.scopeOptions, { undefinable: true }),
            ...
            this.options.eagerLoading ? new AccessTokenMapper({ eagerLoading: true }).mapModelsToAggregates(client.accessTokens, cQMetadata) : undefined,
            this.options.eagerLoading ? new ApplicationMapper({ eagerLoading: true }).mapModelsToAggregates(client.applications, cQMetadata) : undefined,
        );
    }
