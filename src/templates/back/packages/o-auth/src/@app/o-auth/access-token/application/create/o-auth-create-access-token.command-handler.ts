...
export class OAuthCreateAccessTokenCommandHandler
  implements ICommandHandler<OAuthCreateAccessTokenCommand>
{
  constructor(
    ...
    await this.createAccessTokenService.main(
      {
        ...
        expiredAccessToken: new OAuthAccessTokenExpiredAccessToken(
