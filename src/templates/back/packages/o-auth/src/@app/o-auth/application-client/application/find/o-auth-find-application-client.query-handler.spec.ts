import { OAuthApplicationClientMapper, OAuthFindApplicationClientQuery, OAuthIApplicationClientRepository, OAuthMockApplicationClientRepository } from '@app/o-auth/application-client';
...
describe('OAuthFindApplicationClientQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<OAuthFindApplicationClientQueryHandler>(OAuthFindApplicationClientQueryHandler);
        service = module.get<OAuthFindApplicationClientService>(OAuthFindApplicationClientService);
    ...
    describe('main', () =>
    {
        ...
        test('should return an applicationClient founded', async () =>
        {
            ...
            expect(await queryHandler.execute(
                new OAuthFindApplicationClientQuery(),
