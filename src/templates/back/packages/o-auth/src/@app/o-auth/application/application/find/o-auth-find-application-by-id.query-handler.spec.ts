import { OAuthApplicationMapper, OAuthFindApplicationByIdQuery, OAuthIApplicationRepository, oAuthMockApplicationData, OAuthMockApplicationRepository } from '@app/o-auth/application';
