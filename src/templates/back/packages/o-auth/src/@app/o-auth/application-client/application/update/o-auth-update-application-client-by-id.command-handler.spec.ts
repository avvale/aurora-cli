import { oAuthMockApplicationClientData, OAuthUpdateApplicationClientByIdCommand } from '@app/o-auth/application-client';
...
describe('OAuthUpdateApplicationClientByIdCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<OAuthUpdateApplicationClientByIdCommandHandler>(OAuthUpdateApplicationClientByIdCommandHandler);
    });
