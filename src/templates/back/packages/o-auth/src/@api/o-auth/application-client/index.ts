...
export { OAuthUpdateApplicationsClientsHandler } from './handlers/o-auth-update-applications-clients.handler';
export { OAuthUpsertApplicationClientHandler } from './handlers/o-auth-upsert-application-client.handler';
...
export { OAuthUpdateApplicationsClientsController } from './controllers/o-auth-update-applications-clients.controller';
export { OAuthUpsertApplicationClientController } from './controllers/o-auth-upsert-application-client.controller';
...
export { OAuthUpdateApplicationsClientsResolver } from './resolvers/o-auth-update-applications-clients.resolver';
export { OAuthUpsertApplicationClientResolver } from './resolvers/o-auth-upsert-application-client.resolver';
...
import { OAuthUpdateApplicationsClientsController } from './controllers/o-auth-update-applications-clients.controller';
import { OAuthUpsertApplicationClientController } from './controllers/o-auth-upsert-application-client.controller';
...
import { OAuthUpdateApplicationsClientsResolver } from './resolvers/o-auth-update-applications-clients.resolver';
import { OAuthUpsertApplicationClientResolver } from './resolvers/o-auth-upsert-application-client.resolver';
...
import { OAuthUpdateApplicationsClientsHandler } from './handlers/o-auth-update-applications-clients.handler';
import { OAuthUpsertApplicationClientHandler } from './handlers/o-auth-upsert-application-client.handler';
...
export const OAuthApplicationClientApiServices = [
    OAuthApplicationClientSeeder,
];
