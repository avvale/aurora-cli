import { OAuthUpdateApplicationClientByIdController, OAuthUpdateApplicationClientByIdHandler } from '@api/o-auth/application-client';
...
describe('OAuthUpdateApplicationClientByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<OAuthUpdateApplicationClientByIdController>(OAuthUpdateApplicationClientByIdController);
