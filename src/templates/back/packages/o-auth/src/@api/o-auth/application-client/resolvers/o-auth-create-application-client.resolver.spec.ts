...
import { OAuthCreateApplicationClientHandler, OAuthCreateApplicationClientResolver } from '@api/o-auth/application-client';
...
describe('OAuthCreateApplicationClientResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<OAuthCreateApplicationClientResolver>(OAuthCreateApplicationClientResolver);
        handler = module.get<OAuthCreateApplicationClientHandler>(OAuthCreateApplicationClientHandler);
    });
    ...
    describe('main', () =>
    {
        ...
        test('should return an applicationClient created', async () =>
        {
            ...
            expect(await resolver.main(<OAuthCreateApplicationClientInput>oAuthMockApplicationClientData[0])).toBe(oAuthMockApplicationClientData[0]);
        });
    });
});
