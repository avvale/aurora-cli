import { OAuthPaginateApplicationsClientsController, OAuthPaginateApplicationsClientsHandler } from '@api/o-auth/application-client';
...
describe('OAuthPaginateApplicationsClientsController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<OAuthPaginateApplicationsClientsController>(OAuthPaginateApplicationsClientsController);
        handler = module.get<OAuthPaginateApplicationsClientsHandler>(OAuthPaginateApplicationsClientsHandler);
    });
