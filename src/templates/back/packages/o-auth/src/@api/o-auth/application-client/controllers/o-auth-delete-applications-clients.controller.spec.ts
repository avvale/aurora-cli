import { OAuthDeleteApplicationsClientsController, OAuthDeleteApplicationsClientsHandler } from '@api/o-auth/application-client';
...
describe('OAuthDeleteApplicationsClientsController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<OAuthDeleteApplicationsClientsController>(OAuthDeleteApplicationsClientsController);
