...
describe('OAuthCreateClientsController', () => {
    ...
    beforeAll(async () => {
        const module: TestingModule = await Test.createTestingModule({
            controllers: [OAuthCreateClientsController],
            providers: [
                {
        ...
        controller = module.get<OAuthCreateClientsController>(
            OAuthCreateClientsController,
        );
    });
    ...
    describe('main', () => {
        ...
        test('should return an oAuthMockClientData created', async () => {
            expect(await controller.main(oAuthMockClientData)).toBe(undefined);
        });
    });
});
