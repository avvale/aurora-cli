...
import { OAuthPaginateApplicationsClientsHandler, OAuthPaginateApplicationsClientsResolver } from '@api/o-auth/application-client';
...
describe('OAuthPaginateApplicationsClientsResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<OAuthPaginateApplicationsClientsResolver>(OAuthPaginateApplicationsClientsResolver);
