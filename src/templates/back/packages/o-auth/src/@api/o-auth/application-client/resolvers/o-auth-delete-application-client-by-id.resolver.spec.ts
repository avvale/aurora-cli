...
import { OAuthDeleteApplicationClientByIdHandler, OAuthDeleteApplicationClientByIdResolver } from '@api/o-auth/application-client';
...
describe('OAuthDeleteApplicationClientByIdResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<OAuthDeleteApplicationClientByIdResolver>(OAuthDeleteApplicationClientByIdResolver);
