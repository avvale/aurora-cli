import { OAuthCreateApplicationClientController, OAuthCreateApplicationClientHandler } from '@api/o-auth/application-client';
...
describe('OAuthCreateApplicationClientController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<OAuthCreateApplicationClientController>(OAuthCreateApplicationClientController);
