...
import { OAuthApplicationClientDto, OAuthFindApplicationClientByIdHandler } from '@api/o-auth/application-client';
...
export class OAuthFindApplicationClientByIdController
{
    ...
    @ApiOkResponse({ description: 'The record has been successfully requested.', type: OAuthApplicationClientDto })
    async main(
