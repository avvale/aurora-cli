...
import { StorageAccountFileManagerFileDto, StorageAccountGetBase64FileFileManagerHandler } from '@api/storage-account/file-manager';
...
export class StorageAccountGetBase64FileFileManagerController
{
    ...
    main(
        @Body('file') file: StorageAccountFileManagerFileDto,
    )
    {
