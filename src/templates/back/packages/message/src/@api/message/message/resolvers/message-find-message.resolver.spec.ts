...
import { MessageFindMessageHandler, MessageFindMessageResolver } from '@api/message/message';
...
describe('MessageFindMessageResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<MessageFindMessageResolver>(MessageFindMessageResolver);
