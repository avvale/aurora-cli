...
import { MessageGetMessagesHandler, MessageMessageDto } from '@api/message/message';
...
export class MessageGetMessagesController
{
    ...
    @ApiOkResponse({ description: 'The records has been found successfully.', type: [MessageMessageDto]})
