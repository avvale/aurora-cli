...
import { MessageCreateInboxSettingHandler, MessageCreateInboxSettingResolver } from '@api/message/inbox-setting';
...
describe('MessageCreateInboxSettingResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<MessageCreateInboxSettingResolver>(MessageCreateInboxSettingResolver);
    ...
    describe('main', () =>
    {
        ...
        test('should return an inboxSetting created', async () =>
        {
            ...
            expect(await resolver.main(<MessageCreateInboxSettingInput>messageMockInboxSettingData[0])).toBe(messageMockInboxSettingData[0]);
        });
    });
});
