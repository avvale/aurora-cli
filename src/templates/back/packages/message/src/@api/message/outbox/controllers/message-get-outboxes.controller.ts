...
import { MessageGetOutboxesHandler, MessageOutboxDto } from '@api/message/outbox';
...
export class MessageGetOutboxesController
{
    ...
    @ApiOkResponse({ description: 'The records has been found successfully.', type: [MessageOutboxDto]})
