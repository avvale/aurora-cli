...
import { MessageCreateInboxesHandler, MessageCreateInboxesResolver } from '@api/message/inbox';
...
describe('MessageCreateInboxesResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<MessageCreateInboxesResolver>(MessageCreateInboxesResolver);
    });
    ...
    describe('main', () =>
    {
        ...
        {
            expect(await resolver.main(<MessageCreateInboxInput[]>messageMockInboxData)).toBe(undefined);
        });
    });
});
