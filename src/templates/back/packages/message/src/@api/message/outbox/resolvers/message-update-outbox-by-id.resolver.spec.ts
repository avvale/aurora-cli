...
import { MessageUpdateOutboxByIdHandler, MessageUpdateOutboxByIdResolver } from '@api/message/outbox';
...
describe('MessageUpdateOutboxByIdResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<MessageUpdateOutboxByIdResolver>(MessageUpdateOutboxByIdResolver);
