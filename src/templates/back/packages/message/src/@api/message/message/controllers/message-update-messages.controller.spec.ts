import { MessageUpdateMessagesController, MessageUpdateMessagesHandler } from '@api/message/message';
...
describe('MessageUpdateMessagesController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<MessageUpdateMessagesController>(MessageUpdateMessagesController);
