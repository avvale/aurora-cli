import { MessageGetMessagesController, MessageGetMessagesHandler } from '@api/message/message';
...
describe('MessageGetMessagesController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<MessageGetMessagesController>(MessageGetMessagesController);
