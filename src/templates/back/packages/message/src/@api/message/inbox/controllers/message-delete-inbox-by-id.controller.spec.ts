...
import { MessageDeleteInboxByIdController, MessageDeleteInboxByIdHandler } from '@api/message/inbox';
...
describe('MessageDeleteInboxByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<MessageDeleteInboxByIdController>(MessageDeleteInboxByIdController);
