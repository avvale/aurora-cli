...
import { MessageFindMessageByIdHandler, MessageFindMessageByIdResolver } from '@api/message/message';
...
describe('MessageFindMessageByIdResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<MessageFindMessageByIdResolver>(MessageFindMessageByIdResolver);
        handler = module.get<MessageFindMessageByIdHandler>(MessageFindMessageByIdHandler);
    });
    ...
    describe('main', () =>
    {
        ...
        test('should return an message by id', async () =>
        {
            ...
            expect(await resolver.main(messageMockMessageData[0].id)).toBe(messageMockMessageData[0]);
        });
    });
});
