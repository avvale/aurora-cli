...
import { MessageGetInboxSettingsHandler, MessageGetInboxSettingsResolver } from '@api/message/inbox-setting';
...
describe('MessageGetInboxSettingsResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<MessageGetInboxSettingsResolver>(MessageGetInboxSettingsResolver);
