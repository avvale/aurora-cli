...
import { MessageInboxSettingDto, MessageUpdateInboxSettingsDto, MessageUpdateInboxSettingsHandler } from '@api/message/inbox-setting';
...
{
    constructor(
        private readonly handler: MessageUpdateInboxSettingsHandler,
    ) {}
