...
import { MessageFindOutboxHandler, MessageFindOutboxResolver } from '@api/message/outbox';
...
describe('MessageFindOutboxResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<MessageFindOutboxResolver>(MessageFindOutboxResolver);
