...
import { MessageDeleteMessagesHandler, MessageMessageDto } from '@api/message/message';
...
export class MessageDeleteMessagesController
{
    ...
    @ApiOkResponse({ description: 'The records has been deleted successfully.', type: [MessageMessageDto]})
