...
import { MessageCreateInboxDto, MessageCreateInboxesHandler, MessageInboxDto } from '@api/message/inbox';
...
export class MessageCreateInboxesController
{
    ...
    @ApiCreatedResponse({ description: 'The records has been created successfully.' , type: [MessageInboxDto]})
