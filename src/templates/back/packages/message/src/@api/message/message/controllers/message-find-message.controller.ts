...
import { MessageFindMessageHandler, MessageMessageDto } from '@api/message/message';
...
export class MessageFindMessageController
{
    ...
    @ApiOkResponse({ description: 'The record has been successfully created.', type: MessageMessageDto })
