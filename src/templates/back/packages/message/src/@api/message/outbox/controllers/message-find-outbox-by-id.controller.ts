...
import { MessageFindOutboxByIdHandler, MessageOutboxDto } from '@api/message/outbox';
...
export class MessageFindOutboxByIdController
{
    ...
    @ApiOkResponse({ description: 'The record has been successfully requested.', type: MessageOutboxDto })
    async main(
        @Param('id') id: string,
