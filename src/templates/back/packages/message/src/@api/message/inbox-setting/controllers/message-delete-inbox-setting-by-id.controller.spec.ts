...
import { MessageDeleteInboxSettingByIdController, MessageDeleteInboxSettingByIdHandler } from '@api/message/inbox-setting';
...
describe('MessageDeleteInboxSettingByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<MessageDeleteInboxSettingByIdController>(MessageDeleteInboxSettingByIdController);
    ...
    describe('main', () =>
    {
        ...
        test('should return an inboxSetting deleted', async () =>
        {
            ...
            expect(await controller.main(messageMockInboxSettingData[0].id)).toBe(messageMockInboxSettingData[0]);
        });
    });
});
