...
import { MessageCreateMessageHandler, MessageCreateMessageResolver } from '@api/message/message';
...
describe('MessageCreateMessageResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<MessageCreateMessageResolver>(MessageCreateMessageResolver);
    ...
    describe('main', () =>
    {
        ...
        test('should return an message created', async () =>
        {
            ...
            expect(await resolver.main(<MessageCreateMessageInput>messageMockMessageData[0])).toBe(messageMockMessageData[0]);
        });
    });
});
