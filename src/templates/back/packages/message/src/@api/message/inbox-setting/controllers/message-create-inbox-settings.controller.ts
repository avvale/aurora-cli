...
import { MessageCreateInboxSettingDto, MessageCreateInboxSettingsHandler, MessageInboxSettingDto } from '@api/message/inbox-setting';
...
export class MessageCreateInboxSettingsController
{
    ...
    @ApiCreatedResponse({ description: 'The records has been created successfully.' , type: [MessageInboxSettingDto]})
