...
import { MessageMessageDto, MessageUpdateMessageByIdDto, MessageUpdateMessageByIdHandler } from '@api/message/message';
...
{
    constructor(
        private readonly handler: MessageUpdateMessageByIdHandler,
    ) {}
