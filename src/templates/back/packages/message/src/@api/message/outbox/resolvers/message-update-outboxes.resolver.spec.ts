...
import { MessageUpdateOutboxesHandler, MessageUpdateOutboxesResolver } from '@api/message/outbox';
...
describe('MessageUpdateOutboxesResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<MessageUpdateOutboxesResolver>(MessageUpdateOutboxesResolver);
    ...
    describe('main', () =>
    {
        ...
        test('should return a outboxes updated', async () =>
        {
            ...
            expect(await resolver.main(<MessageUpdateOutboxesInput>messageMockOutboxData[0])).toBe(messageMockOutboxData[0]);
        });
    });
});
