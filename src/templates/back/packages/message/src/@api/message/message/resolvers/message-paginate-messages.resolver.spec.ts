...
import { MessagePaginateMessagesHandler, MessagePaginateMessagesResolver } from '@api/message/message';
...
describe('MessagePaginateMessagesResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<MessagePaginateMessagesResolver>(MessagePaginateMessagesResolver);
