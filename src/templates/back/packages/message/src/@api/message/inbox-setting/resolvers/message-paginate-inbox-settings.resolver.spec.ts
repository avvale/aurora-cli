...
import { MessagePaginateInboxSettingsHandler, MessagePaginateInboxSettingsResolver } from '@api/message/inbox-setting';
...
describe('MessagePaginateInboxSettingsResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<MessagePaginateInboxSettingsResolver>(MessagePaginateInboxSettingsResolver);
