...
describe('MessageUnreadCustomerMessageInboxController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<MessageUnreadCustomerMessageInboxController>(MessageUnreadCustomerMessageInboxController);
        handler = module.get<MessageUnreadCustomerMessageInboxHandler>(MessageUnreadCustomerMessageInboxHandler);
    });
