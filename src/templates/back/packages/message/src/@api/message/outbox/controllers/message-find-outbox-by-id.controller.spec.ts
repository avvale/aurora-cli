import { MessageFindOutboxByIdController, MessageFindOutboxByIdHandler } from '@api/message/outbox';
...
describe('MessageFindOutboxByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<MessageFindOutboxByIdController>(MessageFindOutboxByIdController);
