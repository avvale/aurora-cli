...
import { MessageUpdateInboxSettingsHandler, MessageUpdateInboxSettingsResolver } from '@api/message/inbox-setting';
...
describe('MessageUpdateInboxSettingsResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<MessageUpdateInboxSettingsResolver>(MessageUpdateInboxSettingsResolver);
    ...
    describe('main', () =>
    {
        ...
        test('should return a inboxSettings updated', async () =>
        {
            ...
            expect(await resolver.main(<MessageUpdateInboxSettingsInput>messageMockInboxSettingData[0])).toBe(messageMockInboxSettingData[0]);
        });
    });
});
