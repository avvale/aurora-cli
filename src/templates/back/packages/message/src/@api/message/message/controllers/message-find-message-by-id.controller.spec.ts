import { MessageFindMessageByIdController, MessageFindMessageByIdHandler } from '@api/message/message';
...
describe('MessageFindMessageByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<MessageFindMessageByIdController>(MessageFindMessageByIdController);
