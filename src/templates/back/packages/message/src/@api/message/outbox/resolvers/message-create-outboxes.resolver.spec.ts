...
import { MessageCreateOutboxesHandler, MessageCreateOutboxesResolver } from '@api/message/outbox';
...
describe('MessageCreateOutboxesResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<MessageCreateOutboxesResolver>(MessageCreateOutboxesResolver);
    });
    ...
    describe('main', () =>
    {
        ...
        {
            expect(await resolver.main(<MessageCreateOutboxInput[]>messageMockOutboxData)).toBe(undefined);
        });
    });
});
