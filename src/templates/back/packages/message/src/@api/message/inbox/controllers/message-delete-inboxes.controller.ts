...
import { MessageDeleteInboxesHandler, MessageInboxDto } from '@api/message/inbox';
...
export class MessageDeleteInboxesController
{
    ...
    @ApiOkResponse({ description: 'The records has been deleted successfully.', type: [MessageInboxDto]})
