...
describe('MessageCreateInboxSettingsController', () => {
    ...
    beforeAll(async () => {
        const module: TestingModule = await Test.createTestingModule({
            controllers: [MessageCreateInboxSettingsController],
            providers: [
                {
        ...
        controller = module.get<MessageCreateInboxSettingsController>(
            MessageCreateInboxSettingsController,
        );
    });
    ...
    describe('main', () => {
        ...
        test('should return an messageMockInboxSettingData created', async () => {
            expect(await controller.main(messageMockInboxSettingData)).toBe(
                undefined,
            );
        });
    });
