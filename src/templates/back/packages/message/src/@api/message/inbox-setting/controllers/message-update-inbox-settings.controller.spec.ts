import { MessageUpdateInboxSettingsController, MessageUpdateInboxSettingsHandler } from '@api/message/inbox-setting';
...
describe('MessageUpdateInboxSettingsController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<MessageUpdateInboxSettingsController>(MessageUpdateInboxSettingsController);
