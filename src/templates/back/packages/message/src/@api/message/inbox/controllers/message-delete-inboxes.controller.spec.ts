import { MessageDeleteInboxesController, MessageDeleteInboxesHandler } from '@api/message/inbox';
...
describe('MessageDeleteInboxesController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<MessageDeleteInboxesController>(MessageDeleteInboxesController);
