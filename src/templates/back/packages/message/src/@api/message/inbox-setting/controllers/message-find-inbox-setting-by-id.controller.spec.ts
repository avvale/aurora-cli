import { MessageFindInboxSettingByIdController, MessageFindInboxSettingByIdHandler } from '@api/message/inbox-setting';
...
describe('MessageFindInboxSettingByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<MessageFindInboxSettingByIdController>(MessageFindInboxSettingByIdController);
