import { MessagePaginateOutboxesController, MessagePaginateOutboxesHandler } from '@api/message/outbox';
...
describe('MessagePaginateOutboxesController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<MessagePaginateOutboxesController>(MessagePaginateOutboxesController);
