import { MessageUpdateInboxSettingByIdController, MessageUpdateInboxSettingByIdHandler } from '@api/message/inbox-setting';
...
describe('MessageUpdateInboxSettingByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<MessageUpdateInboxSettingByIdController>(MessageUpdateInboxSettingByIdController);
