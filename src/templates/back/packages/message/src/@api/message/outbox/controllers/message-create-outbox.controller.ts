...
import { MessageCreateOutboxDto, MessageCreateOutboxHandler, MessageOutboxDto } from '@api/message/outbox';
...
export class MessageCreateOutboxController
{
    ...
    @ApiCreatedResponse({ description: 'The record has been successfully created.', type: MessageOutboxDto })
    async main(
