...
import { MessagePaginateOutboxesHandler, MessagePaginateOutboxesResolver } from '@api/message/outbox';
...
describe('MessagePaginateOutboxesResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<MessagePaginateOutboxesResolver>(MessagePaginateOutboxesResolver);
