import { MessageUpdateInboxByIdController, MessageUpdateInboxByIdHandler } from '@api/message/inbox';
...
describe('MessageUpdateInboxByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<MessageUpdateInboxByIdController>(MessageUpdateInboxByIdController);
