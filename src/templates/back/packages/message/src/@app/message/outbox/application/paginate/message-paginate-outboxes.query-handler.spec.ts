import { MessageIOutboxRepository, MessageMockOutboxRepository, MessagePaginateOutboxesQuery } from '@app/message/outbox';
...
describe('MessagePaginateOutboxesQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<MessagePaginateOutboxesQueryHandler>(MessagePaginateOutboxesQueryHandler);
        service = module.get<MessagePaginateOutboxesService>(MessagePaginateOutboxesService);
