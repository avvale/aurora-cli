import { MessageIMessageRepository, MessageMockMessageRepository, MessagePaginateMessagesQuery } from '@app/message/message';
...
describe('MessagePaginateMessagesQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<MessagePaginateMessagesQueryHandler>(MessagePaginateMessagesQueryHandler);
        service = module.get<MessagePaginateMessagesService>(MessagePaginateMessagesService);
