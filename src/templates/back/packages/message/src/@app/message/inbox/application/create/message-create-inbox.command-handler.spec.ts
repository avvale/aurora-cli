...
import { MessageCreateInboxCommand, messageMockInboxData } from '@app/message/inbox';
...
describe('MessageCreateInboxCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<MessageCreateInboxCommandHandler>(MessageCreateInboxCommandHandler);
    });
