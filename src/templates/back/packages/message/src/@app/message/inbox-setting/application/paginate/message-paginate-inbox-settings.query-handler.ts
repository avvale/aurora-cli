...
export class MessagePaginateInboxSettingsQueryHandler implements IQueryHandler<MessagePaginateInboxSettingsQuery>
{
    constructor(
        private readonly paginateInboxSettingsService: MessagePaginateInboxSettingsService,
    ) {}

    async execute(query: MessagePaginateInboxSettingsQuery): Promise<PaginationResponse>
    {
