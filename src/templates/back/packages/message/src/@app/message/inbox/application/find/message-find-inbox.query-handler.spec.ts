import { MessageFindInboxQuery, MessageIInboxRepository, MessageInboxMapper, MessageMockInboxRepository } from '@app/message/inbox';
...
describe('MessageFindInboxQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<MessageFindInboxQueryHandler>(MessageFindInboxQueryHandler);
