import { messageMockOutboxData, MessageUpdateOutboxesCommand } from '@app/message/outbox';
...
describe('MessageUpdateOutboxesCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<MessageUpdateOutboxesCommandHandler>(MessageUpdateOutboxesCommandHandler);
    });
