import { MessageDeleteInboxSettingByIdCommand, messageMockInboxSettingData } from '@app/message/inbox-setting';
...
describe('MessageDeleteInboxSettingByIdCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<MessageDeleteInboxSettingByIdCommandHandler>(MessageDeleteInboxSettingByIdCommandHandler);
    });
