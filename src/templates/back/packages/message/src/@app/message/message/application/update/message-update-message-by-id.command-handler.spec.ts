import { messageMockMessageData, MessageUpdateMessageByIdCommand } from '@app/message/message';
...
describe('MessageUpdateMessageByIdCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<MessageUpdateMessageByIdCommandHandler>(MessageUpdateMessageByIdCommandHandler);
    });
