...
@Injectable()
export class MessageMockOutboxRepository
    extends MockRepository<MessageOutbox>
        ...
        for (const itemCollection of <any[]>messageMockOutboxData) {
            ...
            this.collectionSource.push(
                MessageOutbox.register(
                    ...
                    new MessageOutboxRowId(itemCollection.rowId),
                    ...
                    new MessageOutboxScopeRecipients(
                        itemCollection.scopeRecipients,
                    ),
                    new MessageOutboxTagRecipients(
                        itemCollection.tagRecipients,
                    ),
