import { MessageFindOutboxQuery, MessageIOutboxRepository, MessageMockOutboxRepository, MessageOutboxMapper } from '@app/message/outbox';
...
describe('MessageFindOutboxQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<MessageFindOutboxQueryHandler>(MessageFindOutboxQueryHandler);
