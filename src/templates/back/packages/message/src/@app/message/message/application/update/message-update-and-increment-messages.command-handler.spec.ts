import { messageMockMessageData, MessageUpdateAndIncrementMessagesCommand } from '@app/message/message';
...
describe('MessageUpdateAndIncrementMessagesCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<MessageUpdateAndIncrementMessagesCommandHandler>(MessageUpdateAndIncrementMessagesCommandHandler);
    });
