import { MessageGetOutboxesQuery, MessageIOutboxRepository, MessageMockOutboxRepository, MessageOutboxMapper } from '@app/message/outbox';
...
describe('GetOutboxesQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<MessageGetOutboxesQueryHandler>(MessageGetOutboxesQueryHandler);
