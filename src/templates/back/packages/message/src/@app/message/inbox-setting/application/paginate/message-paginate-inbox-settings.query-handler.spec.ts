import { MessageIInboxSettingRepository, MessageMockInboxSettingRepository, MessagePaginateInboxSettingsQuery } from '@app/message/inbox-setting';
...
describe('MessagePaginateInboxSettingsQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<MessagePaginateInboxSettingsQueryHandler>(MessagePaginateInboxSettingsQueryHandler);
        service = module.get<MessagePaginateInboxSettingsService>(MessagePaginateInboxSettingsService);
