...
describe('MessageUpdateAndIncrementMessagesService', () => {
  let service: MessageUpdateAndIncrementMessagesService;
  ...
  beforeAll(async () => {
    ...
    service = module.get(MessageUpdateAndIncrementMessagesService);
  });
        ...
        await service.main(
          {
            ...
            rowId: new MessageMessageRowId(messageMockMessageData[0].rowId),
