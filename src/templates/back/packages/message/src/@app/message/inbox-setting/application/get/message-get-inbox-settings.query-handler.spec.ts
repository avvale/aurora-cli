...
describe('GetInboxSettingsQueryHandler', () => {
    ...
    beforeAll(async () => {
        ...
        queryHandler = module.get<MessageGetInboxSettingsQueryHandler>(
            MessageGetInboxSettingsQueryHandler,
        );
        ...
        repository = <MessageMockInboxSettingRepository>(
            module.get<MessageIInboxSettingRepository>(
                MessageIInboxSettingRepository,
            )
        );
    ...
    describe('main', () => {
        ...
        test('should return an inboxSettings founded', async () => {
            ...
            expect(
                await queryHandler.execute(new MessageGetInboxSettingsQuery()),
            ).toStrictEqual(
