import { MessageDeleteInboxByIdCommand, messageMockInboxData } from '@app/message/inbox';
...
describe('MessageDeleteInboxByIdCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<MessageDeleteInboxByIdCommandHandler>(MessageDeleteInboxByIdCommandHandler);
    });
