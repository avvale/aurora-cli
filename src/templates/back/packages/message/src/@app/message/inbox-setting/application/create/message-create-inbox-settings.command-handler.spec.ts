import { MessageCreateInboxSettingsCommand, messageMockInboxSettingData } from '@app/message/inbox-setting';
...
describe('messageCreateInboxSettingsCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<MessageCreateInboxSettingsCommandHandler>(MessageCreateInboxSettingsCommandHandler);
    });
