import { messageMockOutboxData, MessageUpdateOutboxByIdCommand } from '@app/message/outbox';
...
describe('MessageUpdateOutboxByIdCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<MessageUpdateOutboxByIdCommandHandler>(MessageUpdateOutboxByIdCommandHandler);
    });
