import { MessageFindInboxQuery, MessageInboxMapper, MessageInboxResponse } from '@app/message/inbox';
...
export class MessageFindInboxQueryHandler implements IQueryHandler<MessageFindInboxQuery>
{
    private readonly mapper: MessageInboxMapper = new MessageInboxMapper();

    constructor(
        private readonly findInboxService: MessageFindInboxService,
    ) {}
