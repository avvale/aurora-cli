import { messageMockMessageData, MessageUpdateMessagesCommand } from '@app/message/message';
...
describe('MessageUpdateMessagesCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<MessageUpdateMessagesCommandHandler>(MessageUpdateMessagesCommandHandler);
    });
