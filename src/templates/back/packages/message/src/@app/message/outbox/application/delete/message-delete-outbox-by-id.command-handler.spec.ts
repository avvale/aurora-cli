import { MessageDeleteOutboxByIdCommand, messageMockOutboxData } from '@app/message/outbox';
...
describe('MessageDeleteOutboxByIdCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<MessageDeleteOutboxByIdCommandHandler>(MessageDeleteOutboxByIdCommandHandler);
    });
    ...
    describe('main', () =>
    {
        ...
        test('should create the value object id and pass them as parameters to the MessageDeleteOutboxByIdService', async () =>
        {
            expect(await commandHandler.execute(
                new MessageDeleteOutboxByIdCommand(
