...
@Injectable()
export class MessageSequelizeInboxSettingRepository
  extends SequelizeRepository<MessageInboxSetting, MessageInboxSettingModel>
  implements MessageIInboxSettingRepository
{
  public readonly aggregateName: string = 'MessageInboxSetting';
  public readonly mapper: MessageInboxSettingMapper =
