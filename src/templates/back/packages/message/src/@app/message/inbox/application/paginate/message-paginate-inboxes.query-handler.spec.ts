import { MessageIInboxRepository, MessageMockInboxRepository, MessagePaginateInboxesQuery } from '@app/message/inbox';
...
describe('MessagePaginateInboxesQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<MessagePaginateInboxesQueryHandler>(MessagePaginateInboxesQueryHandler);
        service = module.get<MessagePaginateInboxesService>(MessagePaginateInboxesService);
