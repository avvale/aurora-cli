...
export class MessageFindInboxSettingByIdQueryHandler
    implements IQueryHandler<MessageFindInboxSettingByIdQuery>
{
    ...
    async execute(
        query: MessageFindInboxSettingByIdQuery,
    ): Promise<MessageInboxSettingResponse> {
