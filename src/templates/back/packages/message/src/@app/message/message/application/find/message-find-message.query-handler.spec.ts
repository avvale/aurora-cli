import { MessageFindMessageQuery, MessageIMessageRepository, MessageMessageMapper, MessageMockMessageRepository } from '@app/message/message';
...
describe('MessageFindMessageQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<MessageFindMessageQueryHandler>(MessageFindMessageQueryHandler);
        service = module.get<MessageFindMessageService>(MessageFindMessageService);
