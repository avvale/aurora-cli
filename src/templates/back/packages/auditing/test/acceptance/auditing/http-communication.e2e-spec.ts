...
describe('http-communication', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [AuditingMockHttpCommunicationSeeder],
    })
    ...
    httpCommunicationSeeder = module.get<AuditingMockHttpCommunicationSeeder>(
      AuditingMockHttpCommunicationSeeder,
    );

    // seed mock data in memory database
    await httpCommunicationRepository.insert(
      httpCommunicationSeeder.collectionSource,
    );
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for AuditingHttpCommunicationId must be defined, can not be null',
        );
      });
  });

  test('/REST:POST auditing/http-communication/create - Got 400 Conflict, HttpCommunicationRowId property can not to be null', () => {
    return request(app.getHttpServer())
      .post('/auditing/http-communication/create')
      .set('Accept', 'application/json')
      .send({
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for AuditingHttpCommunicationRowId must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST auditing/http-communication/create - Got 400 Conflict, HttpCommunicationEvent property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for AuditingHttpCommunicationEvent must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST auditing/http-communication/create - Got 400 Conflict, HttpCommunicationMethod property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for AuditingHttpCommunicationMethod must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST auditing/http-communication/create - Got 400 Conflict, HttpCommunicationUrl property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for AuditingHttpCommunicationUrl must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST auditing/http-communication/create - Got 400 Conflict, HttpCommunicationIsReprocessing property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for AuditingHttpCommunicationIsReprocessing must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST auditing/http-communication/create - Got 400 Conflict, HttpCommunicationId property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for AuditingHttpCommunicationId must be defined, can not be undefined',
        );
      });
  });

  test('/REST:POST auditing/http-communication/create - Got 400 Conflict, HttpCommunicationRowId property can not to be undefined', () => {
    return request(app.getHttpServer())
      .post('/auditing/http-communication/create')
      .set('Accept', 'application/json')
      .send({
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for AuditingHttpCommunicationRowId must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST auditing/http-communication/create - Got 400 Conflict, HttpCommunicationEvent property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for AuditingHttpCommunicationEvent must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST auditing/http-communication/create - Got 400 Conflict, HttpCommunicationMethod property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for AuditingHttpCommunicationMethod must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST auditing/http-communication/create - Got 400 Conflict, HttpCommunicationUrl property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for AuditingHttpCommunicationUrl must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST auditing/http-communication/create - Got 400 Conflict, HttpCommunicationIsReprocessing property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for AuditingHttpCommunicationIsReprocessing must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST auditing/http-communication/create - Got 400 Conflict, HttpCommunicationId is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for AuditingHttpCommunicationId is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST auditing/http-communication/create - Got 400 Conflict, HttpCommunicationReprocessingHttpCommunicationId is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for AuditingHttpCommunicationReprocessingHttpCommunicationId is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST auditing/http-communication/create - Got 400 Conflict, HttpCommunicationMethod is too large, has a maximum length of 25', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for AuditingHttpCommunicationMethod is too large, has a maximum length of 25',
        );
      });
  });
  ...
  test('/REST:POST auditing/http-communication/create - Got 400 Conflict, HttpCommunicationUrl is too large, has a maximum length of 2046', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for AuditingHttpCommunicationUrl is too large, has a maximum length of 2046',
        );
      });
  });
  ...
  test('/REST:POST auditing/http-communication/create - Got 400 Conflict, HttpCommunicationIsReprocessing has to be a boolean value', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for AuditingHttpCommunicationIsReprocessing has to be a boolean value',
        );
      });
  });
  test('/REST:POST auditing/http-communication/create - Got 400 Conflict, HttpCommunicationEvent has to be a enum option of REQUEST_FULFILLED, REQUEST_REJECTED, RESPONSE_FULFILLED, RESPONSE_REJECTED', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for AuditingHttpCommunicationEvent has to be any of this options: REQUEST_FULFILLED, REQUEST_REJECTED, RESPONSE_FULFILLED, RESPONSE_REJECTED',
        );
      });
  });
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body).toEqual({
          ...
          rows: httpCommunicationSeeder.collectionResponse
            .map((item) =>
  ...
  test('/REST:POST auditing/http-communications/get', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body).toEqual(
          httpCommunicationSeeder.collectionResponse.map((item) =>
            expect.objectContaining(
              _.omit(item, ['createdAt', 'updatedAt', 'deletedAt']),
            ),
          ),
  ...
  test('/REST:POST auditing/http-communication/find/{id} - Got 404 Not Found', () => {
    return request(app.getHttpServer())
      .post(
        '/auditing/http-communication/find/ce619700-b01f-580b-987f-270c026b447d',
      )
      .set('Accept', 'application/json')
      .expect(404);
  });
  ...
  test('/REST:POST auditing/http-communication/find/{id}', () => {
    return request(app.getHttpServer())
      .post(
        '/auditing/http-communication/find/5b19d6ac-4081-573b-96b3-56964d5326a8',
      )
      .set('Accept', 'application/json')
      .expect(200)
      .then((res) => {
  ...
  test('/REST:DELETE auditing/http-communication/delete/{id} - Got 404 Not Found', () => {
    return request(app.getHttpServer())
      .delete(
        '/auditing/http-communication/delete/3c015ae8-e4eb-5440-bb2a-f2a59364681d',
      )
      .set('Accept', 'application/json')
      .expect(404);
  });
  ...
  test('/REST:DELETE auditing/http-communication/delete/{id}', () => {
    return request(app.getHttpServer())
      .delete(
        '/auditing/http-communication/delete/5b19d6ac-4081-573b-96b3-56964d5326a8',
      )
      .set('Accept', 'application/json')
      .expect(200);
  });
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        for (const [
          index,
          value,
        ] of res.body.data.auditingGetHttpCommunications.entries()) {
          expect(httpCommunicationSeeder.collectionResponse[index]).toEqual(
            expect.objectContaining(
  ...
  test('/GraphQL auditingCreateHttpCommunication', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.auditingCreateHttpCommunication).toHaveProperty(
          'id',
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  ...
  test('/GraphQL auditingFindHttpCommunication', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.auditingFindHttpCommunication.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL auditingFindHttpCommunicationById', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(
          res.body.data.auditingFindHttpCommunicationById.id,
  ...
  test('/GraphQL auditingUpdateHttpCommunicationById', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(
          res.body.data.auditingUpdateHttpCommunicationById.id,
        ).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
      });
  });
  ...
  test('/GraphQL auditingUpdateHttpCommunications', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(
          res.body.data.auditingUpdateHttpCommunications[0].id,
        ).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
      });
  });
  ...
  test('/GraphQL auditingDeleteHttpCommunicationById', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(
          res.body.data.auditingDeleteHttpCommunicationById.id,
        ).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
      });
  });
