...
describe('http-communication', () => {
    ...
    beforeAll(async () => {
        ...
        httpCommunicationSeeder =
            module.get<AuditingMockHttpCommunicationSeeder>(
                AuditingMockHttpCommunicationSeeder,
            );
    ...
    test('/GraphQL auditingPaginateHttpCommunications', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(
                    res.body.data.auditingPaginateHttpCommunications,
                ).toEqual({
                    total: httpCommunicationSeeder.collectionResponse.length,
                    count: httpCommunicationSeeder.collectionResponse.length,
                    rows: httpCommunicationSeeder.collectionResponse
        ...
        return request(app.getHttpServer())
            ...
            .then((res) => {
                for (const [
                    ...
                    expect(
                        httpCommunicationSeeder.collectionResponse[index],
                    ).toEqual(
                        expect.objectContaining(
                            _.omit(value, [
                                'createdAt',
    ...
    test('/GraphQL auditingCreateHttpCommunication', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(
                    res.body.data.auditingCreateHttpCommunication,
    ...
    test('/GraphQL auditingFindHttpCommunication', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(
                    res.body.data.auditingFindHttpCommunication.id,
