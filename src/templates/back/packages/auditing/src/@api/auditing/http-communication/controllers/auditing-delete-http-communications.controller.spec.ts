...
describe('AuditingDeleteHttpCommunicationsController', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      imports: [],
      controllers: [AuditingDeleteHttpCommunicationsController],
      providers: [
        {
    ...
    controller = module.get<AuditingDeleteHttpCommunicationsController>(
      AuditingDeleteHttpCommunicationsController,
    );
    handler = module.get<AuditingDeleteHttpCommunicationsHandler>(
      AuditingDeleteHttpCommunicationsHandler,
    );
  });
