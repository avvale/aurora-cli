...
export class AuditingCreateHttpCommunicationsService
{
    ...
    ): Promise<void>
    {
        ...
        const httpCommunicationsRegistered = this.publisher.mergeObjectContext(new AuditingAddHttpCommunicationsContextEvent(aggregateHttpCommunications));
