...
describe('AuditingUpdateSideEffectsService', () => {
    ...
    beforeAll(async () => {
        ...
        service = module.get(AuditingUpdateSideEffectsService);
    });
                ...
                await service.main(
                    {
                        ...
                        ip: new AuditingSideEffectIp(
                            auditingMockSideEffectData[0].ip,
                        ),
