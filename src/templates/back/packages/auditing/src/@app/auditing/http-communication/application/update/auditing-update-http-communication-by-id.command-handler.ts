...
export class AuditingUpdateHttpCommunicationByIdCommandHandler
  implements ICommandHandler<AuditingUpdateHttpCommunicationByIdCommand>
{
  constructor(
  ...
  async execute(
    command: AuditingUpdateHttpCommunicationByIdCommand,
  ): Promise<void> {
