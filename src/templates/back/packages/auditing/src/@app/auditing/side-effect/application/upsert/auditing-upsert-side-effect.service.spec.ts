...
describe('AuditingUpsertSideEffectService', () =>

{
    ...
    beforeAll(async () =>
    {
        ...
        service = module.get(AuditingUpsertSideEffectService);
    });

    describe('main', () =>
    {
        test('AuditingUpsertSideEffectService should be defined', () =>
        {
            expect(service).toBeDefined();
        });

        test('should upsert a sideEffect and emit event', async () =>
        {
            expect(
                await service.main(
                    {
