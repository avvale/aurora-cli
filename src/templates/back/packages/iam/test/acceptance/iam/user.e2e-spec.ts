...
describe('user', () => {
        ...
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserId must be defined, can not be null',
                );
            });
    });

    test('/REST:POST iam/user/create - Got 400 Conflict, UserRowId property can not to be null', () => {
        return request(app.getHttpServer())
            .post('/iam/user/create')
            .set('Accept', 'application/json')
            .send({
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserRowId must be defined, can not be null',
                );
            });
    });
    ...
    test('/REST:POST iam/user/create - Got 400 Conflict, UserAccountId property can not to be null', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserAccountId must be defined, can not be null',
                );
            });
    });
    ...
    test('/REST:POST iam/user/create - Got 400 Conflict, UserName property can not to be null', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserName must be defined, can not be null',
                );
            });
    });
    ...
    test('/REST:POST iam/user/create - Got 400 Conflict, UserPassword property can not to be null', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserPassword must be defined, can not be null',
                );
            });
    });
    ...
    test('/REST:POST iam/user/create - Got 400 Conflict, UserIsTwoFactorAuthenticationEnabled property can not to be null', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserIsTwoFactorAuthenticationEnabled must be defined, can not be null',
                );
            });
    });
    ...
    test('/REST:POST iam/user/create - Got 400 Conflict, UserId property can not to be undefined', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserId must be defined, can not be undefined',
                );
            });
    });

    test('/REST:POST iam/user/create - Got 400 Conflict, UserRowId property can not to be undefined', () => {
        return request(app.getHttpServer())
            .post('/iam/user/create')
            .set('Accept', 'application/json')
            .send({
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserRowId must be defined, can not be undefined',
                );
            });
    });
    ...
    test('/REST:POST iam/user/create - Got 400 Conflict, UserAccountId property can not to be undefined', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserAccountId must be defined, can not be undefined',
                );
            });
    });
    ...
    test('/REST:POST iam/user/create - Got 400 Conflict, UserName property can not to be undefined', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserName must be defined, can not be undefined',
                );
            });
    });
    ...
    test('/REST:POST iam/user/create - Got 400 Conflict, UserPassword property can not to be undefined', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserPassword must be defined, can not be undefined',
                );
            });
    });
    ...
    test('/REST:POST iam/user/create - Got 400 Conflict, UserIsTwoFactorAuthenticationEnabled property can not to be undefined', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserIsTwoFactorAuthenticationEnabled must be defined, can not be undefined',
                );
            });
    });
    ...
    test('/REST:POST iam/user/create - Got 400 Conflict, UserId is not allowed, must be a length of 36', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserId is not allowed, must be a length of 36',
                );
            });
    });
    ...
    test('/REST:POST iam/user/create - Got 400 Conflict, UserAccountId is not allowed, must be a length of 36', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserAccountId is not allowed, must be a length of 36',
                );
            });
    });
    ...
    test('/REST:POST iam/user/create - Got 400 Conflict, UserLangId is not allowed, must be a length of 36', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserLangId is not allowed, must be a length of 36',
                );
            });
    });
    ...
    test('/REST:POST iam/user/create - Got 400 Conflict, UserName is too large, has a maximum length of 128', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserName is too large, has a maximum length of 128',
                );
            });
    });
    ...
    test('/REST:POST iam/user/create - Got 400 Conflict, UserSurname is too large, has a maximum length of 255', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserSurname is too large, has a maximum length of 255',
                );
            });
    });
    ...
    test('/REST:POST iam/user/create - Got 400 Conflict, UserAvatar is too large, has a maximum length of 255', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserAvatar is too large, has a maximum length of 255',
                );
            });
    });
    ...
    test('/REST:POST iam/user/create - Got 400 Conflict, UserMobile is too large, has a maximum length of 64', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserMobile is too large, has a maximum length of 64',
                );
            });
    });
    ...
    test('/REST:POST iam/user/create - Got 400 Conflict, UserPassword is too large, has a maximum length of 255', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserPassword is too large, has a maximum length of 255',
                );
            });
    });
    ...
    test('/REST:POST iam/user/create - Got 400 Conflict, UserTwoFactorAuthenticationSecret is too large, has a maximum length of 16', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserTwoFactorAuthenticationSecret is too large, has a maximum length of 16',
                );
            });
    });
    ...
    test('/REST:POST iam/user/create - Got 400 Conflict, UserRememberToken is too large, has a maximum length of 255', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserRememberToken is too large, has a maximum length of 255',
                );
            });
    });
    ...
    test('/REST:POST iam/user/create - Got 400 Conflict, UserIsTwoFactorAuthenticationEnabled has to be a boolean value', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body.message).toContain(
                    'Value for IamUserIsTwoFactorAuthenticationEnabled has to be a boolean value',
                );
            });
    });
        ...
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body).toEqual({
                    ...
                    rows: userSeeder.collectionResponse
                        .map((item) =>
    ...
    test('/REST:POST iam/users/get', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(res.body).toEqual(
                    userSeeder.collectionResponse.map((item) =>
                        expect.objectContaining(
                            _.omit(item, [
                                'createdAt',
                                'updatedAt',
        ...
        return request(app.getHttpServer())
            ...
            .then((res) => {
                for (const [
                    index,
                    value,
                ] of res.body.data.iamGetUsers.entries()) {
                    expect(userSeeder.collectionResponse[index]).toEqual(
                        expect.objectContaining(
                            _.omit(value, [
                                'createdAt',
                                'updatedAt',
    ...
    test('/GraphQL iamCreateUser', () => {
        return request(app.getHttpServer())
            ...
            .expect(200)
            .then((res) => {
                expect(res.body.data.iamCreateUser).toHaveProperty(
                    'id',
                    '5b19d6ac-4081-573b-96b3-56964d5326a8',
                );
            });
    ...
    test('/GraphQL iamFindUser', () => {
        return request(app.getHttpServer())
            ...
            .expect(200)
            .then((res) => {
                expect(res.body.data.iamFindUser.id).toStrictEqual(
                    '5b19d6ac-4081-573b-96b3-56964d5326a8',
                );
            });
    });
    ...
    test('/GraphQL iamFindUserById', () => {
        return request(app.getHttpServer())
            ...
            .expect(200)
            .then((res) => {
                expect(res.body.data.iamFindUserById.id).toStrictEqual(
                    '5b19d6ac-4081-573b-96b3-56964d5326a8',
                );
            });
    });
    ...
    test('/GraphQL iamUpdateUserById', () => {
        return request(app.getHttpServer())
            ...
            .expect(200)
            .then((res) => {
                expect(res.body.data.iamUpdateUserById.id).toStrictEqual(
                    '5b19d6ac-4081-573b-96b3-56964d5326a8',
                );
            });
    });
    ...
    test('/GraphQL iamUpdateUsers', () => {
        return request(app.getHttpServer())
            ...
            .expect(200)
            .then((res) => {
                expect(res.body.data.iamUpdateUsers[0].id).toStrictEqual(
                    '5b19d6ac-4081-573b-96b3-56964d5326a8',
                );
            });
    });
    ...
    test('/GraphQL iamDeleteUserById', () => {
        return request(app.getHttpServer())
            ...
            .expect(200)
            .then((res) => {
                expect(res.body.data.iamDeleteUserById.id).toStrictEqual(
                    '5b19d6ac-4081-573b-96b3-56964d5326a8',
                );
            });
    });
