...
describe('bounded-context', () => {
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        for (const [
          ...
          expect(boundedContextSeeder.collectionResponse[index]).toEqual(
            expect.objectContaining(
  ...
  test('/GraphQL iamFindBoundedContextById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.iamFindBoundedContextById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL iamUpdateBoundedContextById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.iamUpdateBoundedContextById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL iamUpdateBoundedContexts', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.iamUpdateBoundedContexts[0].id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL iamDeleteBoundedContextById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.iamDeleteBoundedContextById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
