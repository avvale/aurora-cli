...
import { IamDeleteTenantAccountByIdController, IamDeleteTenantAccountByIdHandler } from '@api/iam/tenant-account';
...
describe('IamDeleteTenantAccountByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<IamDeleteTenantAccountByIdController>(IamDeleteTenantAccountByIdController);
