...
import { IamGetPermissionsRolesHandler, IamGetPermissionsRolesResolver } from '@api/iam/permission-role';
...
describe('IamGetPermissionsRolesResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<IamGetPermissionsRolesResolver>(IamGetPermissionsRolesResolver);
