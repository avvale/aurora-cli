...
import { IamRoleAccountDto, IamUpdateRolesAccountsDto, IamUpdateRolesAccountsHandler } from '@api/iam/role-account';
...
{
    constructor(
        private readonly handler: IamUpdateRolesAccountsHandler,
    ) {}
