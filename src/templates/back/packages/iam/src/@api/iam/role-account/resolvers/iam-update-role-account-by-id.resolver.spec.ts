...
import { IamUpdateRoleAccountByIdHandler, IamUpdateRoleAccountByIdResolver } from '@api/iam/role-account';
...
describe('IamUpdateRoleAccountByIdResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<IamUpdateRoleAccountByIdResolver>(IamUpdateRoleAccountByIdResolver);
