import { IamUpdatePermissionRoleByIdController, IamUpdatePermissionRoleByIdHandler } from '@api/iam/permission-role';
...
describe('IamUpdatePermissionRoleByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<IamUpdatePermissionRoleByIdController>(IamUpdatePermissionRoleByIdController);
