import { IamUpdateTenantAccountByIdController, IamUpdateTenantAccountByIdHandler } from '@api/iam/tenant-account';
...
describe('IamUpdateTenantAccountByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<IamUpdateTenantAccountByIdController>(IamUpdateTenantAccountByIdController);
