...
import { IamFindRoleAccountByIdHandler, IamFindRoleAccountByIdResolver } from '@api/iam/role-account';
...
describe('IamFindRoleAccountByIdResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<IamFindRoleAccountByIdResolver>(IamFindRoleAccountByIdResolver);
