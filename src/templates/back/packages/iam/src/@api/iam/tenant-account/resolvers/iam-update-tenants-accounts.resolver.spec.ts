...
import { IamUpdateTenantsAccountsHandler, IamUpdateTenantsAccountsResolver } from '@api/iam/tenant-account';
...
describe('IamUpdateTenantsAccountsResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<IamUpdateTenantsAccountsResolver>(IamUpdateTenantsAccountsResolver);
        handler = module.get<IamUpdateTenantsAccountsHandler>(IamUpdateTenantsAccountsHandler);
    });
    ...
    describe('main', () =>
    {
        ...
        test('should return a tenantsAccounts updated', async () =>
        {
            ...
            expect(await resolver.main(<IamUpdateTenantsAccountsInput>iamMockTenantAccountData[0])).toBe(iamMockTenantAccountData[0]);
        });
    });
});
