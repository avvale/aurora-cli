import { IamFindRoleAccountByIdController, IamFindRoleAccountByIdHandler } from '@api/iam/role-account';
...
describe('IamFindRoleAccountByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<IamFindRoleAccountByIdController>(IamFindRoleAccountByIdController);
        handler = module.get<IamFindRoleAccountByIdHandler>(IamFindRoleAccountByIdHandler);
    });
