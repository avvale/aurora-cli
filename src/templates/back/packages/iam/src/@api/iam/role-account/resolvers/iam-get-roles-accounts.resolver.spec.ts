...
import { IamGetRolesAccountsHandler, IamGetRolesAccountsResolver } from '@api/iam/role-account';
...
describe('IamGetRolesAccountsResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<IamGetRolesAccountsResolver>(IamGetRolesAccountsResolver);
