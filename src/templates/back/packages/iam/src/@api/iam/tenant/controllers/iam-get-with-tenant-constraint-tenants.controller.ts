...
export class IamGetWithTenantConstraintTenantsController
{
    ...
    @Post()
    @HttpCode(200)
    @ApiOperation({ summary: 'Get tenants filtered by the tenants of the user consuming the API' })
    @ApiCreatedResponse({ description: 'Defines the action performed', type: [IamTenantDto]})
