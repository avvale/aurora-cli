import { IamGetRolesAccountsController, IamGetRolesAccountsHandler } from '@api/iam/role-account';
...
describe('IamGetRolesAccountsController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<IamGetRolesAccountsController>(IamGetRolesAccountsController);
        handler = module.get<IamGetRolesAccountsHandler>(IamGetRolesAccountsHandler);
    });
