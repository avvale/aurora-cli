...
import { IamFindTenantAccountByIdHandler, IamFindTenantAccountByIdResolver } from '@api/iam/tenant-account';
...
describe('IamFindTenantAccountByIdResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<IamFindTenantAccountByIdResolver>(IamFindTenantAccountByIdResolver);
