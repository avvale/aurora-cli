import { IamCreateRolesAccountsController, IamCreateRolesAccountsHandler } from '@api/iam/role-account';
...
describe('IamCreateRolesAccountsController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<IamCreateRolesAccountsController>(IamCreateRolesAccountsController);
    });
