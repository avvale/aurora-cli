...
import { IamTenantAccountDto, IamUpdateTenantAccountByIdDto, IamUpdateTenantAccountByIdHandler } from '@api/iam/tenant-account';
...
export class IamUpdateTenantAccountByIdController
{
    ...
    @ApiOkResponse({ description: 'The record has been successfully updated.', type: IamTenantAccountDto })
    async main(
