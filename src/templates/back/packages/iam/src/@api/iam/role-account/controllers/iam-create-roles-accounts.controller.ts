...
import { IamCreateRoleAccountDto, IamCreateRolesAccountsHandler, IamRoleAccountDto } from '@api/iam/role-account';
...
{
    constructor(
        private readonly handler: IamCreateRolesAccountsHandler,
    ) {}

    @Post()
    @ApiOperation({ summary: 'Create roles-accounts in batch' })
    @ApiCreatedResponse({ description: 'The records has been created successfully.' , type: [IamRoleAccountDto]})
