import { IamFindPermissionRoleByIdController, IamFindPermissionRoleByIdHandler } from '@api/iam/permission-role';
...
describe('IamFindPermissionRoleByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<IamFindPermissionRoleByIdController>(IamFindPermissionRoleByIdController);
