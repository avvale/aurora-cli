import { IamGetTenantsAccountsController, IamGetTenantsAccountsHandler } from '@api/iam/tenant-account';
...
describe('IamGetTenantsAccountsController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<IamGetTenantsAccountsController>(IamGetTenantsAccountsController);
