import { IamUpdateRolesAccountsController, IamUpdateRolesAccountsHandler } from '@api/iam/role-account';
...
describe('IamUpdateRolesAccountsController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<IamUpdateRolesAccountsController>(IamUpdateRolesAccountsController);
