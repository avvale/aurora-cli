...
import { IamCreateTenantAccountDto, IamCreateTenantsAccountsHandler, IamTenantAccountDto } from '@api/iam/tenant-account';
...
{
    constructor(
        private readonly handler: IamCreateTenantsAccountsHandler,
    ) {}

    @Post()
    @ApiOperation({ summary: 'Create tenants-accounts in batch' })
    @ApiCreatedResponse({ description: 'The records has been created successfully.' , type: [IamTenantAccountDto]})
