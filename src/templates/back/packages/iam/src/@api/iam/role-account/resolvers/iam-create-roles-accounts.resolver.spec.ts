...
import { IamCreateRolesAccountsHandler, IamCreateRolesAccountsResolver } from '@api/iam/role-account';
...
describe('IamCreateRolesAccountsResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<IamCreateRolesAccountsResolver>(IamCreateRolesAccountsResolver);
    });
    ...
    describe('main', () =>
    {
        ...
        {
            expect(await resolver.main(<IamCreateRoleAccountInput[]>iamMockRoleAccountData)).toBe(undefined);
        });
    });
});
