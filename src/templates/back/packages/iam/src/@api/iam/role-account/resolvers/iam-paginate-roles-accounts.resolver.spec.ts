...
import { IamPaginateRolesAccountsHandler, IamPaginateRolesAccountsResolver } from '@api/iam/role-account';
...
describe('IamPaginateRolesAccountsResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<IamPaginateRolesAccountsResolver>(IamPaginateRolesAccountsResolver);
