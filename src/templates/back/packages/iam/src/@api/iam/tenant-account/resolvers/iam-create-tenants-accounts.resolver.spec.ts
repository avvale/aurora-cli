...
import { IamCreateTenantsAccountsHandler, IamCreateTenantsAccountsResolver } from '@api/iam/tenant-account';
...
describe('IamCreateTenantsAccountsResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<IamCreateTenantsAccountsResolver>(IamCreateTenantsAccountsResolver);
    });
    ...
    describe('main', () =>
    {
        ...
        {
            expect(await resolver.main(<IamCreateTenantAccountInput[]>iamMockTenantAccountData)).toBe(undefined);
        });
    });
});
