import { IamDeleteRolesAccountsController, IamDeleteRolesAccountsHandler } from '@api/iam/role-account';
...
describe('IamDeleteRolesAccountsController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<IamDeleteRolesAccountsController>(IamDeleteRolesAccountsController);
        handler = module.get<IamDeleteRolesAccountsHandler>(IamDeleteRolesAccountsHandler);
    });
    ...
    describe('main', () =>
    {
        ...
        {
            jest.spyOn(handler, 'main').mockImplementation(() => new Promise(resolve => resolve(iamMockRoleAccountData)));
