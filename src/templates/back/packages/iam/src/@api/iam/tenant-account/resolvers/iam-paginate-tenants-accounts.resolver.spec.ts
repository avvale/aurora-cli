...
import { IamPaginateTenantsAccountsHandler, IamPaginateTenantsAccountsResolver } from '@api/iam/tenant-account';
...
describe('IamPaginateTenantsAccountsResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<IamPaginateTenantsAccountsResolver>(IamPaginateTenantsAccountsResolver);
