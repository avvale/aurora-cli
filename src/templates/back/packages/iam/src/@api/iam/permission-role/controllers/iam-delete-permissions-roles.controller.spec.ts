import { IamDeletePermissionsRolesController, IamDeletePermissionsRolesHandler } from '@api/iam/permission-role';
...
describe('IamDeletePermissionsRolesController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<IamDeletePermissionsRolesController>(IamDeletePermissionsRolesController);
