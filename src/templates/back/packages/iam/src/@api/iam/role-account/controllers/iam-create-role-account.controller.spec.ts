import { IamCreateRoleAccountController, IamCreateRoleAccountHandler } from '@api/iam/role-account';
...
describe('IamCreateRoleAccountController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<IamCreateRoleAccountController>(IamCreateRoleAccountController);
