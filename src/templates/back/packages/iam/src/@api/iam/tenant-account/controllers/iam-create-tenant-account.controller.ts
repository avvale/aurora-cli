...
import { IamCreateTenantAccountDto, IamCreateTenantAccountHandler, IamTenantAccountDto } from '@api/iam/tenant-account';
...
export class IamCreateTenantAccountController
{
    ...
    @ApiCreatedResponse({ description: 'The record has been successfully created.', type: IamTenantAccountDto })
    async main(
