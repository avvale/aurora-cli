import { IamUpdateTenantsAccountsController, IamUpdateTenantsAccountsHandler } from '@api/iam/tenant-account';
...
describe('IamUpdateTenantsAccountsController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<IamUpdateTenantsAccountsController>(IamUpdateTenantsAccountsController);
