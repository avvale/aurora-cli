import { IamPaginateRolesAccountsController, IamPaginateRolesAccountsHandler } from '@api/iam/role-account';
...
describe('IamPaginateRolesAccountsController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<IamPaginateRolesAccountsController>(IamPaginateRolesAccountsController);
