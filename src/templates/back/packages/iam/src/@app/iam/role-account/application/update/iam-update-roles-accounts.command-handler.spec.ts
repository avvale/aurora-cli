import { iamMockRoleAccountData, IamUpdateRolesAccountsCommand } from '@app/iam/role-account';
...
describe('IamUpdateRolesAccountsCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<IamUpdateRolesAccountsCommandHandler>(IamUpdateRolesAccountsCommandHandler);
    });
