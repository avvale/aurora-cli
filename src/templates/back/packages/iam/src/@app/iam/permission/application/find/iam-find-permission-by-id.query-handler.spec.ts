import { IamFindPermissionByIdQuery, IamIPermissionRepository, iamMockPermissionData, IamMockPermissionRepository, IamPermissionMapper } from '@app/iam/permission';
