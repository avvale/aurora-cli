                ...
                await service.main(
                    {
                        ...
                        username: new IamAccountUsername(
                            iamMockAccountData[0].username,
                        ),
                        isActive: new IamAccountIsActive(
                            iamMockAccountData[0].isActive,
                        ),
                        clientId: new IamAccountClientId(
                            iamMockAccountData[0].clientId,
                        ),
                        tags: new IamAccountTags(iamMockAccountData[0].tags),
                        scopes: new IamAccountScopes(
                            iamMockAccountData[0].scopes,
                        ),
                        ...
                        dTenants: new IamAccountDTenants(
                            iamMockAccountData[0].dTenants,
                        ),
                        meta: new IamAccountMeta(iamMockAccountData[0].meta),
                        roleIds: new IamAccountRoleIds(
                            iamMockAccountData[0].roleIds,
                        ),
                        tenantIds: new IamAccountTenantIds(
                            iamMockAccountData[0].tenantIds,
                        ),
                    },
                    {},
                    {},
