...
@Injectable()
export class IamMockPermissionRepository
    extends MockRepository<IamPermission>
        ...
        for (const itemCollection of <any[]>iamMockPermissionData) {
            ...
            this.collectionSource.push(
                IamPermission.register(
                    ...
                    new IamPermissionRowId(itemCollection.rowId),
                    new IamPermissionName(itemCollection.name),
                    new IamPermissionBoundedContextId(
                        itemCollection.boundedContextId,
                    ),
