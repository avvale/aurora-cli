import { IamGetTagsQuery, IamITagRepository, IamMockTagRepository, IamTagMapper } from '@app/iam/tag';
...
describe('GetTagsQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<IamGetTagsQueryHandler>(IamGetTagsQueryHandler);
