import { IamFindPermissionRoleQuery, IamIPermissionRoleRepository, IamMockPermissionRoleRepository, IamPermissionRoleMapper } from '@app/iam/permission-role';
...
describe('IamFindPermissionRoleQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<IamFindPermissionRoleQueryHandler>(IamFindPermissionRoleQueryHandler);
        service = module.get<IamFindPermissionRoleService>(IamFindPermissionRoleService);
    ...
    describe('main', () =>
    {
        ...
        test('should return an permissionRole founded', async () =>
        {
            ...
            expect(await queryHandler.execute(
                new IamFindPermissionRoleQuery(),
