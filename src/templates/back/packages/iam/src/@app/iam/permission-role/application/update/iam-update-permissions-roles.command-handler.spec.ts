import { iamMockPermissionRoleData, IamUpdatePermissionsRolesCommand } from '@app/iam/permission-role';
...
describe('IamUpdatePermissionsRolesCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<IamUpdatePermissionsRolesCommandHandler>(IamUpdatePermissionsRolesCommandHandler);
    });
