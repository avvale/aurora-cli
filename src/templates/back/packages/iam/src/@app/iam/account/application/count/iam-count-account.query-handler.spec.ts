import { IamCountAccountQuery, IamIAccountRepository, IamMockAccountRepository } from '@app/iam/account';
...
describe('IamCountAccountQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<IamCountAccountQueryHandler>(IamCountAccountQueryHandler);
