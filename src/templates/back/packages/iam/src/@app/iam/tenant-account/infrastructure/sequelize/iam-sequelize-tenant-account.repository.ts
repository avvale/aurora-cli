...
@Injectable()
export class IamSequelizeTenantAccountRepository
    extends SequelizeRepository<IamTenantAccount, IamTenantAccountModel>
    implements IamITenantAccountRepository
{
    public readonly aggregateName: string = 'IamTenantAccount';
    public readonly mapper: IamTenantAccountMapper =
