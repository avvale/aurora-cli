import { IamGetTenantsAccountsQuery, IamITenantAccountRepository, IamMockTenantAccountRepository, IamTenantAccountMapper } from '@app/iam/tenant-account';
...
describe('GetTenantsAccountsQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<IamGetTenantsAccountsQueryHandler>(IamGetTenantsAccountsQueryHandler);
        service = module.get<IamGetTenantsAccountsService>(IamGetTenantsAccountsService);
    ...
    describe('main', () =>
    {
        ...
        test('should return an tenantsAccounts founded', async () =>
        {
            ...
            expect(await queryHandler.execute(
                new IamGetTenantsAccountsQuery(),
