import { IamFindTenantAccountByIdQuery, IamTenantAccountMapper, IamTenantAccountResponse } from '@app/iam/tenant-account';
...
export class IamFindTenantAccountByIdQueryHandler implements IQueryHandler<IamFindTenantAccountByIdQuery>
{
    ...
    async execute(query: IamFindTenantAccountByIdQuery): Promise<IamTenantAccountResponse>
    {
