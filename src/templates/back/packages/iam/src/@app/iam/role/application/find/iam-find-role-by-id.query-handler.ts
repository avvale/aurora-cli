...
export class IamFindRoleByIdQueryHandler
  implements IQueryHandler<IamFindRoleByIdQuery>
{
  private readonly mapper: IamRoleMapper = new IamRoleMapper();

  constructor(private readonly findRoleByIdService: IamFindRoleByIdService) {}
