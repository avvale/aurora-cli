import { IamCreateRolesAccountsCommand, iamMockRoleAccountData } from '@app/iam/role-account';
...
describe('iamCreateRolesAccountsCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<IamCreateRolesAccountsCommandHandler>(IamCreateRolesAccountsCommandHandler);
    });
    ...
    describe('main', () =>
    {
        ...
        test('should return IamMockRoleAccountData created', async () =>
        {
            expect(await commandHandler.execute(
                new IamCreateRolesAccountsCommand(
