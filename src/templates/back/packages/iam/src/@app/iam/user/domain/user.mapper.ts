...
export class UserMapper implements IMapper
{
    ...
    private makeAggregate(user: LiteralObject, cQMetadata?: CQMetadata): IamUser
    {
        return IamUser.register(
            ...
            new UserMeta(user.meta, { undefinable: true }),
            ...
            this.options.eagerLoading ? new AccountMapper({ eagerLoading: true }).mapModelToAggregate(user.account, cQMetadata) : undefined,
        );
    }
