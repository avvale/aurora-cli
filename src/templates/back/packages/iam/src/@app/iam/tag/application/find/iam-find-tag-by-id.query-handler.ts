import { IamFindTagByIdQuery, IamTagMapper, IamTagResponse } from '@app/iam/tag';
...
export class IamFindTagByIdQueryHandler implements IQueryHandler<IamFindTagByIdQuery>
{
    private readonly mapper: IamTagMapper = new IamTagMapper();

    constructor(
        private readonly findTagByIdService: IamFindTagByIdService,
    ) {}
