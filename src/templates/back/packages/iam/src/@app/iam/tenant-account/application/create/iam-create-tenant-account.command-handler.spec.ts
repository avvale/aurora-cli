...
import { IamCreateTenantAccountCommand, iamMockTenantAccountData } from '@app/iam/tenant-account';
...
describe('IamCreateTenantAccountCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<IamCreateTenantAccountCommandHandler>(IamCreateTenantAccountCommandHandler);
    });
