import { IamFindPermissionRoleByIdQuery, IamIPermissionRoleRepository, iamMockPermissionRoleData, IamMockPermissionRoleRepository, IamPermissionRoleMapper } from '@app/iam/permission-role';
...
describe('IamFindPermissionRoleByIdQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<IamFindPermissionRoleByIdQueryHandler>(IamFindPermissionRoleByIdQueryHandler);
        service = module.get<IamFindPermissionRoleByIdService>(IamFindPermissionRoleByIdService);
