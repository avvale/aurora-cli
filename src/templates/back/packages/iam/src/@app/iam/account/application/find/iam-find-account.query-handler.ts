...
export class IamFindAccountQueryHandler
  implements IQueryHandler<IamFindAccountQuery>
{
  private readonly mapper: IamAccountMapper = new IamAccountMapper();

  constructor(private readonly findAccountService: IamFindAccountService) {}
