import { IamFindRoleAccountByIdQuery, IamIRoleAccountRepository, iamMockRoleAccountData, IamMockRoleAccountRepository, IamRoleAccountMapper } from '@app/iam/role-account';
...
describe('IamFindRoleAccountByIdQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<IamFindRoleAccountByIdQueryHandler>(IamFindRoleAccountByIdQueryHandler);
        service = module.get<IamFindRoleAccountByIdService>(IamFindRoleAccountByIdService);
