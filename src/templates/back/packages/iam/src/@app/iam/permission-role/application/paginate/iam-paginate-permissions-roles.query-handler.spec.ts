import { IamIPermissionRoleRepository, IamMockPermissionRoleRepository, IamPaginatePermissionsRolesQuery } from '@app/iam/permission-role';
...
describe('IamPaginatePermissionsRolesQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<IamPaginatePermissionsRolesQueryHandler>(IamPaginatePermissionsRolesQueryHandler);
        service = module.get<IamPaginatePermissionsRolesService>(IamPaginatePermissionsRolesService);
