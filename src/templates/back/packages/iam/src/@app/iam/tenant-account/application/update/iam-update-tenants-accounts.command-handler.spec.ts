import { iamMockTenantAccountData, IamUpdateTenantsAccountsCommand } from '@app/iam/tenant-account';
...
describe('IamUpdateTenantsAccountsCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<IamUpdateTenantsAccountsCommandHandler>(IamUpdateTenantsAccountsCommandHandler);
    });
