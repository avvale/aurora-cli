...
export class IamRoleMapper implements IMapper
{
    ...
    private makeAggregate(role: LiteralObject, cQMetadata?: CQMetadata): IamRole
    {
        return IamRole.register(
            ...
            new IamRoleCreatedAt(role.createdAt, { undefinable: true }, { addTimezone: cQMetadata?.timezone }),
            new IamRoleUpdatedAt(role.updatedAt, { undefinable: true }, { addTimezone: cQMetadata?.timezone }),
            new IamRoleDeletedAt(role.deletedAt, { undefinable: true }, { addTimezone: cQMetadata?.timezone }),
            ...
            this.options.eagerLoading ? new IamAccountMapper({ eagerLoading: true }).mapModelsToAggregates(role.accounts, cQMetadata) : undefined,
        );
    }
    ...
    private makeResponse(role: IamRole): IamRoleResponse
    {
        ...
        return new IamRoleResponse(
            ...
            this.options.eagerLoading ? new IamAccountMapper({ eagerLoading: true }).mapAggregatesToResponses(role.accounts) : undefined,
        );
    }
}
