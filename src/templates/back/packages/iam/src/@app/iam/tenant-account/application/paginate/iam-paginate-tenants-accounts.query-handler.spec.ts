import { IamITenantAccountRepository, IamMockTenantAccountRepository, IamPaginateTenantsAccountsQuery } from '@app/iam/tenant-account';
...
describe('IamPaginateTenantsAccountsQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<IamPaginateTenantsAccountsQueryHandler>(IamPaginateTenantsAccountsQueryHandler);
        service = module.get<IamPaginateTenantsAccountsService>(IamPaginateTenantsAccountsService);
