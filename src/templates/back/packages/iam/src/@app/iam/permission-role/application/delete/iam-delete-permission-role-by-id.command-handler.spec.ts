import { IamDeletePermissionRoleByIdCommand, iamMockPermissionRoleData } from '@app/iam/permission-role';
...
describe('IamDeletePermissionRoleByIdCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<IamDeletePermissionRoleByIdCommandHandler>(IamDeletePermissionRoleByIdCommandHandler);
    });
