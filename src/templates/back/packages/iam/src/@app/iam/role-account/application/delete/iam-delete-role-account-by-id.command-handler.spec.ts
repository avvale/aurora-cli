import { IamDeleteRoleAccountByIdCommand, iamMockRoleAccountData } from '@app/iam/role-account';
...
describe('IamDeleteRoleAccountByIdCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<IamDeleteRoleAccountByIdCommandHandler>(IamDeleteRoleAccountByIdCommandHandler);
    });
