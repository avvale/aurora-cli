import { IamFindRoleAccountQuery, IamIRoleAccountRepository, IamMockRoleAccountRepository, IamRoleAccountMapper } from '@app/iam/role-account';
...
describe('IamFindRoleAccountQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<IamFindRoleAccountQueryHandler>(IamFindRoleAccountQueryHandler);
