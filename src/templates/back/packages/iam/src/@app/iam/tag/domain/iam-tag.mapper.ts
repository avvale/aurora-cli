...
export class IamTagMapper implements IMapper
{
     ...
     * @param tags
     */
    mapModelsToAggregates(tags: LiteralObject[], cQMetadata?: CQMetadata): IamTag[]
    {
    ...
    private makeAggregate(tag: LiteralObject, cQMetadata?: CQMetadata): IamTag
    {
        return IamTag.register(
            ...
            new IamTagCreatedAt(tag.createdAt, { undefinable: true }, { addTimezone: cQMetadata?.timezone }),
            new IamTagUpdatedAt(tag.updatedAt, { undefinable: true }, { addTimezone: cQMetadata?.timezone }),
            new IamTagDeletedAt(tag.deletedAt, { undefinable: true }, { addTimezone: cQMetadata?.timezone }),
        );
    }
