...
describe('job-registry', () => {
  ...
  test('/GraphQL queueManagerCreateJobRegistry', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.queueManagerCreateJobRegistry).toHaveProperty(
          'id',
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  ...
  test('/GraphQL queueManagerFindJobRegistry', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.queueManagerFindJobRegistry.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL queueManagerFindJobRegistryById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.queueManagerFindJobRegistryById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
