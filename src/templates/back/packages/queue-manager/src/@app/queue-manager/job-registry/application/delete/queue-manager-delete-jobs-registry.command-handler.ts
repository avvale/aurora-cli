...
export class QueueManagerDeleteJobsRegistryCommandHandler
    implements ICommandHandler<QueueManagerDeleteJobsRegistryCommand>
{
    constructor(
    ...
    async execute(
        command: QueueManagerDeleteJobsRegistryCommand,
    ): Promise<void> {
