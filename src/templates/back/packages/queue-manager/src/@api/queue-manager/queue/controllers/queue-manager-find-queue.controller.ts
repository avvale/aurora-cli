...
import { QueueManagerFindQueueHandler, QueueManagerQueueDto } from '@api/queue-manager/queue';
...
export class QueueManagerFindQueueController
{
    ...
    @ApiOkResponse({ description: 'The record has been successfully created.', type: QueueManagerQueueDto })
