...
describe('QueueManagerFindJobRegistryController', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      imports: [],
      controllers: [QueueManagerFindJobRegistryController],
      providers: [
        {
    ...
    controller = module.get<QueueManagerFindJobRegistryController>(
      QueueManagerFindJobRegistryController,
    );
    handler = module.get<QueueManagerFindJobRegistryHandler>(
      QueueManagerFindJobRegistryHandler,
    );
  });
