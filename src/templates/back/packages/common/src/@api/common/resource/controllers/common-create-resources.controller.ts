...
import { CommonCreateResourceDto, CommonCreateResourcesHandler, CommonResourceDto } from '@api/common/resource';
...
export class CommonCreateResourcesController
{
    ...
    @ApiCreatedResponse({ description: 'The records has been created successfully.' , type: [CommonResourceDto]})
