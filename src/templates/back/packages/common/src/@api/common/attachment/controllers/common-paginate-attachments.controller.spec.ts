import { CommonPaginateAttachmentsController, CommonPaginateAttachmentsHandler } from '@api/common/attachment';
...
describe('CommonPaginateAttachmentsController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<CommonPaginateAttachmentsController>(CommonPaginateAttachmentsController);
