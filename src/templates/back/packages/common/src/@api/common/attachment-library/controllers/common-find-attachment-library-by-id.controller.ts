...
import { CommonAttachmentLibraryDto, CommonFindAttachmentLibraryByIdHandler } from '@api/common/attachment-library';
...
export class CommonFindAttachmentLibraryByIdController
{
    ...
    @ApiOkResponse({ description: 'The record has been successfully requested.', type: CommonAttachmentLibraryDto })
    async main(
        @Param('id') id: string,
