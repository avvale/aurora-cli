...
import { CommonFindResourceHandler, CommonResourceDto } from '@api/common/resource';
...
export class CommonFindResourceController
{
    ...
    @ApiOkResponse({ description: 'The record has been successfully created.', type: CommonResourceDto })
