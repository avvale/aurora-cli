...
describe('CommonUpdateResourcesController', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      imports: [],
      controllers: [CommonUpdateResourcesController],
      providers: [
        {
    ...
    controller = module.get<CommonUpdateResourcesController>(
      CommonUpdateResourcesController,
    );
    handler = module.get<CommonUpdateResourcesHandler>(
      CommonUpdateResourcesHandler,
    );
  });
  ...
  describe('main', () => {
    ...
    test('should return a resources updated', async () => {
      ...
      expect(await controller.main(commonMockResourceData[0])).toBe(
