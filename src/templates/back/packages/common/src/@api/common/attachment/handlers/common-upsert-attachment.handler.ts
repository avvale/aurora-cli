...
import { CommonFindAttachmentByIdQuery, CommonUpsertAttachmentCommand } from '@app/common/attachment';
...
export class CommonUpsertAttachmentHandler
{
    ...
    {
        await this.commandBus.dispatch(new CommonUpsertAttachmentCommand(
            payload,
            {
                timezone,
                repositoryOptions: {
