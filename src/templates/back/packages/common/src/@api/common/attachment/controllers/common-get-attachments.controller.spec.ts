import { CommonGetAttachmentsController, CommonGetAttachmentsHandler } from '@api/common/attachment';
...
describe('CommonGetAttachmentsController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<CommonGetAttachmentsController>(CommonGetAttachmentsController);
