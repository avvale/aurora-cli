...
import { CommonAttachmentDto, CommonDeleteAttachmentsHandler } from '@api/common/attachment';
...
export class CommonDeleteAttachmentsController
{
    ...
    @ApiOkResponse({ description: 'The records has been deleted successfully.', type: [CommonAttachmentDto]})
