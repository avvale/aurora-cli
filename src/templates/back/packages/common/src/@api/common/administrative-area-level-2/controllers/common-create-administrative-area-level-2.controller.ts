...
import { CommonAdministrativeAreaLevel2Dto, CommonCreateAdministrativeAreaLevel2Dto, CommonCreateAdministrativeAreaLevel2Handler } from '@api/common/administrative-area-level-2';
