...
import { CommonAttachmentLibraryDto, CommonDeleteAttachmentLibrariesHandler } from '@api/common/attachment-library';
...
export class CommonDeleteAttachmentLibrariesController
{
    ...
    @ApiOkResponse({ description: 'The records has been deleted successfully.', type: [CommonAttachmentLibraryDto]})
