import { CommonCreateAttachmentController, CommonCreateAttachmentHandler } from '@api/common/attachment';
...
describe('CommonCreateAttachmentController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<CommonCreateAttachmentController>(CommonCreateAttachmentController);
