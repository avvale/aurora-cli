...
import { CommonAttachmentFamilyDto, CommonDeleteAttachmentFamilyByIdHandler } from '@api/common/attachment-family';
...
export class CommonDeleteAttachmentFamilyByIdController
{
    ...
    @ApiOkResponse({ description: 'The record has been deleted successfully.', type: CommonAttachmentFamilyDto })
    async main(
        @Param('id') id: string,
