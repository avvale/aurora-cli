...
describe('CommonCreateAdministrativeAreasLevel1Controller', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      controllers: [CommonCreateAdministrativeAreasLevel1Controller],
      providers: [
        {
    ...
    controller = module.get<CommonCreateAdministrativeAreasLevel1Controller>(
      CommonCreateAdministrativeAreasLevel1Controller,
    );
  });
  ...
  describe('main', () => {
    ...
    test('should return an commonMockAdministrativeAreaLevel1Data created', async () => {
      expect(
        await controller.main(commonMockAdministrativeAreaLevel1Data),
      ).toBe(undefined);
    });
  });
});
