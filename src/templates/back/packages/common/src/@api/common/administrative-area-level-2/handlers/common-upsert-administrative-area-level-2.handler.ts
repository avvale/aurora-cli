...
import { CommonFindAdministrativeAreaLevel2ByIdQuery, CommonUpsertAdministrativeAreaLevel2Command } from '@app/common/administrative-area-level-2';
...
export class CommonUpsertAdministrativeAreaLevel2Handler
{
    ...
    {
        await this.commandBus.dispatch(new CommonUpsertAdministrativeAreaLevel2Command(
            payload,
            {
                timezone,
                repositoryOptions: {
