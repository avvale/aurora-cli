...
import { CommonUpdateAttachmentLibrariesHandler, CommonUpdateAttachmentLibrariesResolver } from '@api/common/attachment-library';
...
describe('CommonUpdateAttachmentLibrariesResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<CommonUpdateAttachmentLibrariesResolver>(CommonUpdateAttachmentLibrariesResolver);
    ...
    describe('main', () =>
    {
        ...
        test('should return a attachmentLibraries updated', async () =>
        {
            ...
            expect(await resolver.main(<CommonUpdateAttachmentLibrariesInput>commonMockAttachmentLibraryData[0])).toBe(commonMockAttachmentLibraryData[0]);
        });
    });
});
