...
import { CommonDeleteAttachmentByIdHandler, CommonDeleteAttachmentByIdResolver } from '@api/common/attachment';
...
describe('CommonDeleteAttachmentByIdResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<CommonDeleteAttachmentByIdResolver>(CommonDeleteAttachmentByIdResolver);
    ...
    describe('main', () =>
    {
        ...
        test('should return an attachment deleted', async () =>
        {
            ...
            expect(await resolver.main(commonMockAttachmentData[0].id)).toBe(commonMockAttachmentData[0]);
        });
    });
});
