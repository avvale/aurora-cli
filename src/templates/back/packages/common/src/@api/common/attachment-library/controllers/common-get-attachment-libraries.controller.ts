...
import { CommonAttachmentLibraryDto, CommonGetAttachmentLibrariesHandler } from '@api/common/attachment-library';
...
export class CommonGetAttachmentLibrariesController
{
    ...
    @ApiOkResponse({ description: 'The records has been found successfully.', type: [CommonAttachmentLibraryDto]})
