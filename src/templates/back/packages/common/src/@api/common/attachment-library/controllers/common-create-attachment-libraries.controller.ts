...
import { CommonAttachmentLibraryDto, CommonCreateAttachmentLibrariesHandler, CommonCreateAttachmentLibraryDto } from '@api/common/attachment-library';
...
export class CommonCreateAttachmentLibrariesController
{
    ...
    @ApiCreatedResponse({ description: 'The records has been created successfully.' , type: [CommonAttachmentLibraryDto]})
