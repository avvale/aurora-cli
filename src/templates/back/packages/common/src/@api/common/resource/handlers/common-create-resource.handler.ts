import { CommonCreateResourceDto, CommonResourceDto } from '@api/common/resource';
import { CommonCreateResourceInput, CommonResource } from '@api/graphql';
import { CommonCreateResourceCommand, CommonFindResourceByIdQuery } from '@app/common/resource';
...
export class CommonCreateResourceHandler
{
    ...
    {
        await this.commandBus.dispatch(new CommonCreateResourceCommand(
            payload,
            {
                timezone,
                repositoryOptions: {
