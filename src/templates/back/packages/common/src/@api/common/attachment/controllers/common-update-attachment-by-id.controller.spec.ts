import { CommonUpdateAttachmentByIdController, CommonUpdateAttachmentByIdHandler } from '@api/common/attachment';
...
describe('CommonUpdateAttachmentByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<CommonUpdateAttachmentByIdController>(CommonUpdateAttachmentByIdController);
