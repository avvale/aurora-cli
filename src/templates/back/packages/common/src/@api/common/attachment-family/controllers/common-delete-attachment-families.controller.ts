...
import { CommonAttachmentFamilyDto, CommonDeleteAttachmentFamiliesHandler } from '@api/common/attachment-family';
...
export class CommonDeleteAttachmentFamiliesController
{
    ...
    @ApiOkResponse({ description: 'The records has been deleted successfully.', type: [CommonAttachmentFamilyDto]})
