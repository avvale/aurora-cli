...
import { CommonFindAdministrativeAreaLevel1ByIdQuery, CommonUpsertAdministrativeAreaLevel1Command } from '@app/common/administrative-area-level-1';
...
export class CommonUpsertAdministrativeAreaLevel1Handler
{
    ...
    {
        await this.commandBus.dispatch(new CommonUpsertAdministrativeAreaLevel1Command(
            payload,
            {
                timezone,
                repositoryOptions: {
