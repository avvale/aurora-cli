import { CommonFindAttachmentLibraryController, CommonFindAttachmentLibraryHandler } from '@api/common/attachment-library';
...
describe('CommonFindAttachmentLibraryController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<CommonFindAttachmentLibraryController>(CommonFindAttachmentLibraryController);
