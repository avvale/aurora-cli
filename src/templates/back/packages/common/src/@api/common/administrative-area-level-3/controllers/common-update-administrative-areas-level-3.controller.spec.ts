...
describe('CommonUpdateAdministrativeAreasLevel3Controller', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      imports: [],
      controllers: [CommonUpdateAdministrativeAreasLevel3Controller],
      providers: [
        {
    ...
    controller = module.get<CommonUpdateAdministrativeAreasLevel3Controller>(
      CommonUpdateAdministrativeAreasLevel3Controller,
    );
    handler = module.get<CommonUpdateAdministrativeAreasLevel3Handler>(
      CommonUpdateAdministrativeAreasLevel3Handler,
    );
  });
