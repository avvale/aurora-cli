...
import { CommonDeleteResourceByIdHandler, CommonResourceDto } from '@api/common/resource';
...
export class CommonDeleteResourceByIdController
{
    ...
    @ApiOkResponse({ description: 'The record has been deleted successfully.', type: CommonResourceDto })
    async main(
        @Param('id') id: string,
