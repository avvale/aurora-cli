...
describe('CommonCreateAdministrativeAreaLevel3Controller', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      imports: [],
      controllers: [CommonCreateAdministrativeAreaLevel3Controller],
      providers: [
        {
    ...
    controller = module.get<CommonCreateAdministrativeAreaLevel3Controller>(
      CommonCreateAdministrativeAreaLevel3Controller,
    );
    handler = module.get<CommonCreateAdministrativeAreaLevel3Handler>(
      CommonCreateAdministrativeAreaLevel3Handler,
    );
  });
