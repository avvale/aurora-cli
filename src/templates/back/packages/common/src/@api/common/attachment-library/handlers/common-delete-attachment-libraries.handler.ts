...
import { CommonDeleteAttachmentLibrariesCommand, CommonGetAttachmentLibrariesQuery } from '@app/common/attachment-library';
...
export class CommonDeleteAttachmentLibrariesHandler
{
    ...
    {
        const attachmentLibraries = await this.queryBus.ask(new CommonGetAttachmentLibrariesQuery(
            queryStatement,
            constraint,
            {
                timezone,
