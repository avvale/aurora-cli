import { CommonAttachmentFamilyDto, CommonCreateAttachmentFamilyDto } from '@api/common/attachment-family';
import { CommonAttachmentFamily, CommonCreateAttachmentFamilyInput } from '@api/graphql';
import { CommonCreateAttachmentFamilyCommand, CommonFindAttachmentFamilyByIdQuery } from '@app/common/attachment-family';
...
export class CommonCreateAttachmentFamilyHandler
{
    ...
    {
        await this.commandBus.dispatch(new CommonCreateAttachmentFamilyCommand(
            payload,
            {
                timezone,
                repositoryOptions: {
