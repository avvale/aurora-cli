...
import { CommonDeleteResourcesHandler, CommonResourceDto } from '@api/common/resource';
...
export class CommonDeleteResourcesController
{
    ...
    @ApiOkResponse({ description: 'The records has been deleted successfully.', type: [CommonResourceDto]})
