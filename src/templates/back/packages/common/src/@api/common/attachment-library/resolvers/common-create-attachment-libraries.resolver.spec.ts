import { CommonCreateAttachmentLibrariesHandler, CommonCreateAttachmentLibrariesResolver } from '@api/common/attachment-library';
...
describe('CommonCreateAttachmentLibrariesResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<CommonCreateAttachmentLibrariesResolver>(CommonCreateAttachmentLibrariesResolver);
    });
    ...
    describe('main', () =>
    {
        ...
        {
            expect(await resolver.main(<CommonCreateAttachmentLibraryInput[]>commonMockAttachmentLibraryData)).toBe(undefined);
        });
    });
});
