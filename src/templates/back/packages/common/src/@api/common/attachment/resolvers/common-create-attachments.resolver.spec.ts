import { CommonCreateAttachmentsHandler, CommonCreateAttachmentsResolver } from '@api/common/attachment';
...
describe('CommonCreateAttachmentsResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<CommonCreateAttachmentsResolver>(CommonCreateAttachmentsResolver);
    });
    ...
    describe('main', () =>
    {
        ...
        {
            expect(await resolver.main(<CommonCreateAttachmentInput[]>commonMockAttachmentData)).toBe(undefined);
        });
    });
});
