...
import { CommonAdministrativeAreaLevel3Dto, CommonUpdateAdministrativeAreaLevel3ByIdDto, CommonUpsertAdministrativeAreaLevel3Handler } from '@api/common/administrative-area-level-3';
...
export class CommonUpsertAdministrativeAreaLevel3Controller
{
    ...
    @ApiCreatedResponse({ description: 'The record has been successfully upserted.', type: CommonAdministrativeAreaLevel3Dto })
    async main(
