...
import { CommonCreateResourceDto, CommonCreateResourceHandler, CommonResourceDto } from '@api/common/resource';
...
export class CommonCreateResourceController
{
    ...
    @ApiCreatedResponse({ description: 'The record has been successfully created.', type: CommonResourceDto })
    async main(
