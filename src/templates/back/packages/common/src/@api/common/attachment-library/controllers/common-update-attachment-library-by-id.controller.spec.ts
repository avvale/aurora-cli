import { CommonUpdateAttachmentLibraryByIdController, CommonUpdateAttachmentLibraryByIdHandler } from '@api/common/attachment-library';
...
describe('CommonUpdateAttachmentLibraryByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<CommonUpdateAttachmentLibraryByIdController>(CommonUpdateAttachmentLibraryByIdController);
