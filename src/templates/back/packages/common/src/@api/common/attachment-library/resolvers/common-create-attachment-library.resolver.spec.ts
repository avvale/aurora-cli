...
import { CommonCreateAttachmentLibraryHandler, CommonCreateAttachmentLibraryResolver } from '@api/common/attachment-library';
...
describe('CommonCreateAttachmentLibraryResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<CommonCreateAttachmentLibraryResolver>(CommonCreateAttachmentLibraryResolver);
        handler = module.get<CommonCreateAttachmentLibraryHandler>(CommonCreateAttachmentLibraryHandler);
    });
    ...
    describe('main', () =>
    {
        ...
        test('should return an attachmentLibrary created', async () =>
        {
            ...
            expect(await resolver.main(<CommonCreateAttachmentLibraryInput>commonMockAttachmentLibraryData[0])).toBe(commonMockAttachmentLibraryData[0]);
        });
    });
});
