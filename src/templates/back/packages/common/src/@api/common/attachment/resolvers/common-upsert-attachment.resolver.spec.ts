...
import { CommonUpsertAttachmentHandler, CommonUpsertAttachmentResolver } from '@api/common/attachment';
...
describe('CommonUpsertAttachmentResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<CommonUpsertAttachmentResolver>(CommonUpsertAttachmentResolver);
