import { CommonFindAttachmentLibraryByIdController, CommonFindAttachmentLibraryByIdHandler } from '@api/common/attachment-library';
...
describe('CommonFindAttachmentLibraryByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<CommonFindAttachmentLibraryByIdController>(CommonFindAttachmentLibraryByIdController);
