...
describe('CommonCreateAttachmentFamiliesController', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      controllers: [CommonCreateAttachmentFamiliesController],
      providers: [
        {
    ...
    controller = module.get<CommonCreateAttachmentFamiliesController>(
      CommonCreateAttachmentFamiliesController,
    );
  });
  ...
  describe('main', () => {
    ...
    test('should return an commonMockAttachmentFamilyData created', async () => {
      expect(await controller.main(commonMockAttachmentFamilyData)).toBe(
        undefined,
      );
    });
  });
