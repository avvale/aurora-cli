import { CommonUpdateAttachmentsController, CommonUpdateAttachmentsHandler } from '@api/common/attachment';
...
describe('CommonUpdateAttachmentsController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<CommonUpdateAttachmentsController>(CommonUpdateAttachmentsController);
