...
describe('CommonGetAttachmentFamiliesController', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      imports: [],
      controllers: [CommonGetAttachmentFamiliesController],
      providers: [
        {
    ...
    controller = module.get<CommonGetAttachmentFamiliesController>(
      CommonGetAttachmentFamiliesController,
    );
    handler = module.get<CommonGetAttachmentFamiliesHandler>(
      CommonGetAttachmentFamiliesHandler,
    );
  });
