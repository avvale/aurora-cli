import { CommonUpdateAttachmentFamiliesController, CommonUpdateAttachmentFamiliesHandler } from '@api/common/attachment-family';
...
describe('CommonUpdateAttachmentFamiliesController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<CommonUpdateAttachmentFamiliesController>(CommonUpdateAttachmentFamiliesController);
