...
import { CommonAttachmentDto, CommonCreateAttachmentDto, CommonCreateAttachmentsHandler } from '@api/common/attachment';
...
export class CommonCreateAttachmentsController
{
    ...
    @ApiCreatedResponse({ description: 'The records has been created successfully.' , type: [CommonAttachmentDto]})
