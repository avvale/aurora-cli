...
import { CommonAttachmentFamilyDto, CommonCreateAttachmentFamilyDto, CommonCreateAttachmentFamilyHandler } from '@api/common/attachment-family';
...
export class CommonCreateAttachmentFamilyController
{
    ...
    @ApiCreatedResponse({ description: 'The record has been successfully created.', type: CommonAttachmentFamilyDto })
    async main(
