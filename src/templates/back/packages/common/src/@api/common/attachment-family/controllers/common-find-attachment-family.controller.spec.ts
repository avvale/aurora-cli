import { CommonFindAttachmentFamilyController, CommonFindAttachmentFamilyHandler } from '@api/common/attachment-family';
...
describe('CommonFindAttachmentFamilyController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<CommonFindAttachmentFamilyController>(CommonFindAttachmentFamilyController);
