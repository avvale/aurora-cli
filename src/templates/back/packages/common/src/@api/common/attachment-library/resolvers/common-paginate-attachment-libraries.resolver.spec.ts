...
import { CommonPaginateAttachmentLibrariesHandler, CommonPaginateAttachmentLibrariesResolver } from '@api/common/attachment-library';
...
describe('CommonPaginateAttachmentLibrariesResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<CommonPaginateAttachmentLibrariesResolver>(CommonPaginateAttachmentLibrariesResolver);
