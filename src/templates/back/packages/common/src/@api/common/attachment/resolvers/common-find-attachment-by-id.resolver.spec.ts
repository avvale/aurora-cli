...
import { CommonFindAttachmentByIdHandler, CommonFindAttachmentByIdResolver } from '@api/common/attachment';
...
describe('CommonFindAttachmentByIdResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<CommonFindAttachmentByIdResolver>(CommonFindAttachmentByIdResolver);
