...
import { CommonDeleteAttachmentLibrariesHandler, CommonDeleteAttachmentLibrariesResolver } from '@api/common/attachment-library';
...
describe('CommonDeleteAttachmentLibrariesResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<CommonDeleteAttachmentLibrariesResolver>(CommonDeleteAttachmentLibrariesResolver);
