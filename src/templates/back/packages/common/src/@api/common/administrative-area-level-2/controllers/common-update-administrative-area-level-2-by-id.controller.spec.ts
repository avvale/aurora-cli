...
describe('CommonUpdateAdministrativeAreaLevel2ByIdController', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      imports: [],
      controllers: [CommonUpdateAdministrativeAreaLevel2ByIdController],
      providers: [
        {
    ...
    controller = module.get<CommonUpdateAdministrativeAreaLevel2ByIdController>(
      CommonUpdateAdministrativeAreaLevel2ByIdController,
    );
  ...
  describe('main', () => {
    ...
    test('should return a administrativeAreaLevel2 updated', async () => {
      ...
      expect(
        await controller.main(commonMockAdministrativeAreaLevel2Data[0]),
