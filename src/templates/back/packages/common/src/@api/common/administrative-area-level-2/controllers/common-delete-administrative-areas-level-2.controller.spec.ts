...
describe('CommonDeleteAdministrativeAreasLevel2Controller', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      imports: [],
      controllers: [CommonDeleteAdministrativeAreasLevel2Controller],
      providers: [
        {
    ...
    controller = module.get<CommonDeleteAdministrativeAreasLevel2Controller>(
      CommonDeleteAdministrativeAreasLevel2Controller,
    );
    handler = module.get<CommonDeleteAdministrativeAreasLevel2Handler>(
      CommonDeleteAdministrativeAreasLevel2Handler,
    );
  });
