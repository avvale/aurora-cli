...
import { CommonDeleteAttachmentByIdController, CommonDeleteAttachmentByIdHandler } from '@api/common/attachment';
...
describe('CommonDeleteAttachmentByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<CommonDeleteAttachmentByIdController>(CommonDeleteAttachmentByIdController);
