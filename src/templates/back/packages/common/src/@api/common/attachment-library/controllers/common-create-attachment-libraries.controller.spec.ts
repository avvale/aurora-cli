...
describe('CommonCreateAttachmentLibrariesController', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      controllers: [CommonCreateAttachmentLibrariesController],
      providers: [
        {
    ...
    controller = module.get<CommonCreateAttachmentLibrariesController>(
      CommonCreateAttachmentLibrariesController,
    );
  });
  ...
  describe('main', () => {
    ...
    test('should return an commonMockAttachmentLibraryData created', async () => {
      expect(await controller.main(commonMockAttachmentLibraryData)).toBe(
        undefined,
      );
    });
  });
