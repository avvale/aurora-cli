...
import { CommonAttachmentLibraryDto, CommonCreateAttachmentLibraryDto, CommonCreateAttachmentLibraryHandler } from '@api/common/attachment-library';
...
export class CommonCreateAttachmentLibraryController
{
    ...
    @ApiCreatedResponse({ description: 'The record has been successfully created.', type: CommonAttachmentLibraryDto })
    async main(
