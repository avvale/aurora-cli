import { CommonAdministrativeAreaLevel2Dto, CommonCreateAdministrativeAreaLevel2Dto } from '@api/common/administrative-area-level-2';
import { CommonAdministrativeAreaLevel2, CommonCreateAdministrativeAreaLevel2Input } from '@api/graphql';
import { CommonCreateAdministrativeAreaLevel2Command, CommonFindAdministrativeAreaLevel2ByIdQuery } from '@app/common/administrative-area-level-2';
...
export class CommonCreateAdministrativeAreaLevel2Handler
{
    ...
    {
        await this.commandBus.dispatch(new CommonCreateAdministrativeAreaLevel2Command(
            payload,
            {
                timezone,
                repositoryOptions: {
