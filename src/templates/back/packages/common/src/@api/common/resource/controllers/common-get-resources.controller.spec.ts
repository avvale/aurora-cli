import { CommonGetResourcesController, CommonGetResourcesHandler } from '@api/common/resource';
...
describe('CommonGetResourcesController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<CommonGetResourcesController>(CommonGetResourcesController);
