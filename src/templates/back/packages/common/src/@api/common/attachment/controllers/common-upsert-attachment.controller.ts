...
import { CommonAttachmentDto, CommonUpdateAttachmentByIdDto, CommonUpsertAttachmentHandler } from '@api/common/attachment';
...
export class CommonUpsertAttachmentController
{
    ...
    @ApiCreatedResponse({ description: 'The record has been successfully upserted.', type: CommonAttachmentDto })
    async main(
