import { CommonDeleteAttachmentsController, CommonDeleteAttachmentsHandler } from '@api/common/attachment';
...
describe('CommonDeleteAttachmentsController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<CommonDeleteAttachmentsController>(CommonDeleteAttachmentsController);
