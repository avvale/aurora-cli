...
import { CommonAttachmentLibraryDto, CommonUpdateAttachmentLibraryByIdDto, CommonUpsertAttachmentLibraryHandler } from '@api/common/attachment-library';
...
export class CommonUpsertAttachmentLibraryController
{
    ...
    @ApiCreatedResponse({ description: 'The record has been successfully upserted.', type: CommonAttachmentLibraryDto })
    async main(
