...
import { CommonDeleteAttachmentFamilyByIdCommand, CommonFindAttachmentFamilyByIdQuery } from '@app/common/attachment-family';
...
export class CommonDeleteAttachmentFamilyByIdHandler
{
    ...
    ): Promise<CommonAttachmentFamily | CommonAttachmentFamilyDto>
    {
        ...
        await this.commandBus.dispatch(new CommonDeleteAttachmentFamilyByIdCommand(
            id,
            constraint,
            {
                timezone,
