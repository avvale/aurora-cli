import { CommonUpsertAttachmentLibraryController, CommonUpsertAttachmentLibraryHandler } from '@api/common/attachment-library';
...
describe('CommonUpsertAttachmentLibraryController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<CommonUpsertAttachmentLibraryController>(CommonUpsertAttachmentLibraryController);
