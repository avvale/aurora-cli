...
describe('CommonUpdateAttachmentFamilyByIdController', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      imports: [],
      controllers: [CommonUpdateAttachmentFamilyByIdController],
      providers: [
        {
    ...
    controller = module.get<CommonUpdateAttachmentFamilyByIdController>(
      CommonUpdateAttachmentFamilyByIdController,
    );
    handler = module.get<CommonUpdateAttachmentFamilyByIdHandler>(
      CommonUpdateAttachmentFamilyByIdHandler,
    );
  });
