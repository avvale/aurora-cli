import { CommonCreateAttachmentLibraryController, CommonCreateAttachmentLibraryHandler } from '@api/common/attachment-library';
...
describe('CommonCreateAttachmentLibraryController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<CommonCreateAttachmentLibraryController>(CommonCreateAttachmentLibraryController);
