import { CommonCreateAttachmentsController, CommonCreateAttachmentsHandler } from '@api/common/attachment';
...
describe('CommonCreateAttachmentsController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<CommonCreateAttachmentsController>(CommonCreateAttachmentsController);
    });
