import { CommonPaginateResourcesController, CommonPaginateResourcesHandler } from '@api/common/resource';
...
describe('CommonPaginateResourcesController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<CommonPaginateResourcesController>(CommonPaginateResourcesController);
