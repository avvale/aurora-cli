import { CommonGetAttachmentLibrariesController, CommonGetAttachmentLibrariesHandler } from '@api/common/attachment-library';
...
describe('CommonGetAttachmentLibrariesController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<CommonGetAttachmentLibrariesController>(CommonGetAttachmentLibrariesController);
