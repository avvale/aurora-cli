...
import { CommonDeleteAttachmentFamilyByIdController, CommonDeleteAttachmentFamilyByIdHandler } from '@api/common/attachment-family';
...
describe('CommonDeleteAttachmentFamilyByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<CommonDeleteAttachmentFamilyByIdController>(CommonDeleteAttachmentFamilyByIdController);
