...
export class CommonFindAttachmentFamilyByIdQueryHandler
  implements IQueryHandler<CommonFindAttachmentFamilyByIdQuery>
{
  ...
  async execute(
    query: CommonFindAttachmentFamilyByIdQuery,
