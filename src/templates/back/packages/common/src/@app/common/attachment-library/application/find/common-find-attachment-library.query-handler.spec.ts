import { CommonAttachmentLibraryMapper, CommonFindAttachmentLibraryQuery, CommonIAttachmentLibraryRepository, CommonMockAttachmentLibraryRepository } from '@app/common/attachment-library';
...
describe('CommonFindAttachmentLibraryQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<CommonFindAttachmentLibraryQueryHandler>(CommonFindAttachmentLibraryQueryHandler);
        service = module.get<CommonFindAttachmentLibraryService>(CommonFindAttachmentLibraryService);
    ...
    describe('main', () =>
    {
        ...
        test('should return an attachmentLibrary founded', async () =>
        {
            ...
            expect(await queryHandler.execute(
                new CommonFindAttachmentLibraryQuery(),
