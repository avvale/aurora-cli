...
export class CommonRawSQLAdministrativeAreasLevel1QueryHandler
  implements IQueryHandler<CommonRawSQLAdministrativeAreasLevel1Query>
{
  ...
  async execute(
    query: CommonRawSQLAdministrativeAreasLevel1Query,
  ): Promise<CommonAdministrativeAreaLevel1Response[]> {
    return this.mapper.mapAggregatesToResponses(
      await this.rawSQLAdministrativeAreasLevel1Service.main(
        query.rawSQL,
        query.cQMetadata,
      ),
    );
