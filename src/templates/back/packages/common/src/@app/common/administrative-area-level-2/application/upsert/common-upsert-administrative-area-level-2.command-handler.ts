...
export class CommonUpsertAdministrativeAreaLevel2CommandHandler
  implements ICommandHandler<CommonUpsertAdministrativeAreaLevel2Command>
{
  constructor(
  ...
  async execute(
    command: CommonUpsertAdministrativeAreaLevel2Command,
  ): Promise<void> {
