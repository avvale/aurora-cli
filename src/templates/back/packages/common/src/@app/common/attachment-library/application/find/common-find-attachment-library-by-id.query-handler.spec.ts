import { CommonAttachmentLibraryMapper, CommonFindAttachmentLibraryByIdQuery, CommonIAttachmentLibraryRepository, commonMockAttachmentLibraryData, CommonMockAttachmentLibraryRepository } from '@app/common/attachment-library';
...
describe('CommonFindAttachmentLibraryByIdQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<CommonFindAttachmentLibraryByIdQueryHandler>(CommonFindAttachmentLibraryByIdQueryHandler);
        service = module.get<CommonFindAttachmentLibraryByIdService>(CommonFindAttachmentLibraryByIdService);
