...
export abstract class CommonIAdministrativeAreaLevel2Repository
  implements IRepository<CommonAdministrativeAreaLevel2>
{
  ...
  abstract create(
    ...
    options?: {
      ...
      dataFactory?: (
        aggregate: CommonAdministrativeAreaLevel2,
      ) => LiteralObject;
