...
export class CommonCreateAdministrativeAreasLevel3Service
{
    ...
    ): Promise<void>
    {
        ...
        const administrativeAreasLevel3Registered = this.publisher.mergeObjectContext(new CommonAddAdministrativeAreasLevel3ContextEvent(aggregateAdministrativeAreasLevel3));
