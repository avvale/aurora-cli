import { CommonAttachmentMapper, CommonFindAttachmentByIdQuery, CommonIAttachmentRepository, commonMockAttachmentData, CommonMockAttachmentRepository } from '@app/common/attachment';
...
describe('CommonFindAttachmentByIdQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<CommonFindAttachmentByIdQueryHandler>(CommonFindAttachmentByIdQueryHandler);
        service = module.get<CommonFindAttachmentByIdService>(CommonFindAttachmentByIdService);
