...
export class CommonUpdateAttachmentByIdCommandHandler
  implements ICommandHandler<CommonUpdateAttachmentByIdCommand>
{
  constructor(
    ...
    await this.updateAttachmentByIdService.main(
      {
        ...
        libraryFilename: new CommonAttachmentLibraryFilename(
          command.payload.libraryFilename,
        ),
