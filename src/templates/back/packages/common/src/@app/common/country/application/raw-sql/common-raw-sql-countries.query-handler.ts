...
export class CommonRawSQLCountriesQueryHandler
  implements IQueryHandler<CommonRawSQLCountriesQuery>
{
  ...
  async execute(
    query: CommonRawSQLCountriesQuery,
  ): Promise<CommonCountryResponse[]> {
    return this.mapper.mapAggregatesToResponses(
      await this.rawSQLCountriesService.main(query.rawSQL, query.cQMetadata),
    );
  }
}
