import { CommonAttachmentMapper, CommonGetAttachmentsQuery, CommonIAttachmentRepository, CommonMockAttachmentRepository } from '@app/common/attachment';
...
describe('GetAttachmentsQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<CommonGetAttachmentsQueryHandler>(CommonGetAttachmentsQueryHandler);
        service = module.get<CommonGetAttachmentsService>(CommonGetAttachmentsService);
