import { CommonDeleteAttachmentLibraryByIdCommand, commonMockAttachmentLibraryData } from '@app/common/attachment-library';
...
describe('CommonDeleteAttachmentLibraryByIdCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<CommonDeleteAttachmentLibraryByIdCommandHandler>(CommonDeleteAttachmentLibraryByIdCommandHandler);
    });
