...
export class CommonPaginateAttachmentsQueryHandler implements IQueryHandler<CommonPaginateAttachmentsQuery>
{
    constructor(
        private readonly paginateAttachmentsService: CommonPaginateAttachmentsService,
    ) {}

    async execute(query: CommonPaginateAttachmentsQuery): Promise<PaginationResponse>
    {
