...
export abstract class CommonIAdministrativeAreaLevel3Repository
  implements IRepository<CommonAdministrativeAreaLevel3>
{
  ...
  abstract create(
    ...
    options?: {
      ...
      dataFactory?: (
        aggregate: CommonAdministrativeAreaLevel3,
      ) => LiteralObject;
