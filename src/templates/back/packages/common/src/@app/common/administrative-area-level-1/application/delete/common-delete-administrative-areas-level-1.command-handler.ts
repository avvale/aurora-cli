...
export class CommonDeleteAdministrativeAreasLevel1CommandHandler
  implements ICommandHandler<CommonDeleteAdministrativeAreasLevel1Command>
{
  constructor(
  ...
  async execute(
    command: CommonDeleteAdministrativeAreasLevel1Command,
  ): Promise<void> {
