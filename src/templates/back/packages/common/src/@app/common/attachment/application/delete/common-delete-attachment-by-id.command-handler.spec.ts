import { CommonDeleteAttachmentByIdCommand, commonMockAttachmentData } from '@app/common/attachment';
...
describe('CommonDeleteAttachmentByIdCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<CommonDeleteAttachmentByIdCommandHandler>(CommonDeleteAttachmentByIdCommandHandler);
    });
