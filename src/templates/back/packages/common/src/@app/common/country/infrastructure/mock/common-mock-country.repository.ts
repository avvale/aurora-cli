...
@Injectable()
export class CommonMockCountryRepository
  extends MockRepository<CommonCountry>
    ...
    for (const itemCollection of <any[]>commonMockCountryData) {
      ...
      this.collectionSource.push(
        CommonCountry.register(
          ...
          new CommonCountryAdministrativeAreas(
            itemCollection.administrativeAreas,
          ),
          ...
          new CommonCountryI18nAdministrativeAreaLevel1(
            itemCollection.administrativeAreaLevel1,
          ),
          new CommonCountryI18nAdministrativeAreaLevel2(
            itemCollection.administrativeAreaLevel2,
          ),
          new CommonCountryI18nAdministrativeAreaLevel3(
            itemCollection.administrativeAreaLevel3,
          ),
        ),
      );
    }
