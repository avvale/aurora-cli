...
export class CommonRawSQLAttachmentFamiliesQueryHandler
  implements IQueryHandler<CommonRawSQLAttachmentFamiliesQuery>
{
  ...
  async execute(
    query: CommonRawSQLAttachmentFamiliesQuery,
  ): Promise<CommonAttachmentFamilyResponse[]> {
    return this.mapper.mapAggregatesToResponses(
      await this.rawSQLAttachmentFamiliesService.main(
        query.rawSQL,
        query.cQMetadata,
      ),
    );
