...
export class CommonDeleteAdministrativeAreasLevel2CommandHandler
  implements ICommandHandler<CommonDeleteAdministrativeAreasLevel2Command>
{
  constructor(
  ...
  async execute(
    command: CommonDeleteAdministrativeAreasLevel2Command,
  ): Promise<void> {
