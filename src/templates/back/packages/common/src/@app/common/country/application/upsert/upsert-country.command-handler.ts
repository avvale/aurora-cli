...
@CommandHandler(UpsertCountryCommand)
export class UpsertCountryCommandHandler implements ICommandHandler<UpsertCountryCommand>
{
    constructor(
        private readonly upsertCountryService: UpsertCountryService,
    ) {}

    async execute(command: UpsertCountryCommand): Promise<void>
    {
        ...
        await this.upsertCountryService.main(
            {
                ...
                mapType: new CountryMapType(command.payload.mapType),
