import { CommonAttachmentMapper, CommonFindAttachmentQuery, CommonIAttachmentRepository, CommonMockAttachmentRepository } from '@app/common/attachment';
...
describe('CommonFindAttachmentQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<CommonFindAttachmentQueryHandler>(CommonFindAttachmentQueryHandler);
        service = module.get<CommonFindAttachmentService>(CommonFindAttachmentService);
