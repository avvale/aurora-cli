...
export class CommonDeleteAdministrativeAreaLevel2ByIdCommandHandler
  implements ICommandHandler<CommonDeleteAdministrativeAreaLevel2ByIdCommand>
{
  constructor(
  ...
  async execute(
    command: CommonDeleteAdministrativeAreaLevel2ByIdCommand,
  ): Promise<void> {
