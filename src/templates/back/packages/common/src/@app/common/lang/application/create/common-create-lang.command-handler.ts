...
export class CommonCreateLangCommandHandler
  implements ICommandHandler<CommonCreateLangCommand>
{
  constructor(private readonly createLangService: CommonCreateLangService) {}
