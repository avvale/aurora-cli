...
@Injectable()
export class CommonMockAttachmentLibraryRepository
  extends MockRepository<CommonAttachmentLibrary>
  implements CommonIAttachmentLibraryRepository
{
