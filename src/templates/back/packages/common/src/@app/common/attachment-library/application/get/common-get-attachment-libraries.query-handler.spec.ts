import { CommonAttachmentLibraryMapper, CommonGetAttachmentLibrariesQuery, CommonIAttachmentLibraryRepository, CommonMockAttachmentLibraryRepository } from '@app/common/attachment-library';
...
describe('GetAttachmentLibrariesQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<CommonGetAttachmentLibrariesQueryHandler>(CommonGetAttachmentLibrariesQueryHandler);
        service = module.get<CommonGetAttachmentLibrariesService>(CommonGetAttachmentLibrariesService);
    ...
    describe('main', () =>
    {
        ...
        test('should return an attachmentLibraries founded', async () =>
        {
            ...
            expect(await queryHandler.execute(
                new CommonGetAttachmentLibrariesQuery(),
