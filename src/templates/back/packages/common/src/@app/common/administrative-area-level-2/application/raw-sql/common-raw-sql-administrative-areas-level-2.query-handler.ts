import { CommonAdministrativeAreaLevel2Mapper, CommonAdministrativeAreaLevel2Response, CommonRawSQLAdministrativeAreasLevel2Query } from '@app/common/administrative-area-level-2';
