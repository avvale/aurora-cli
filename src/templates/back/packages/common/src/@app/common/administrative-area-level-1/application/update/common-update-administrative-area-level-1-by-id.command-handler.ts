...
export class CommonUpdateAdministrativeAreaLevel1ByIdCommandHandler
  implements ICommandHandler<CommonUpdateAdministrativeAreaLevel1ByIdCommand>
{
  constructor(
  ...
  async execute(
    command: CommonUpdateAdministrativeAreaLevel1ByIdCommand,
  ): Promise<void> {
