...
export class CommonUpdateAttachmentLibraryByIdCommandHandler
  implements ICommandHandler<CommonUpdateAttachmentLibraryByIdCommand>
{
  constructor(
  ...
  async execute(
    command: CommonUpdateAttachmentLibraryByIdCommand,
  ): Promise<void> {
