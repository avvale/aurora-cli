import { CommonCreateAttachmentsCommand, commonMockAttachmentData } from '@app/common/attachment';
...
describe('commonCreateAttachmentsCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<CommonCreateAttachmentsCommandHandler>(CommonCreateAttachmentsCommandHandler);
    });
    ...
    describe('main', () =>
    {
        ...
        test('should return CommonMockAttachmentData created', async () =>
        {
            expect(await commandHandler.execute(
                new CommonCreateAttachmentsCommand(
