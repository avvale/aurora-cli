...
export class CommonUpsertAdministrativeAreaLevel3CommandHandler
  implements ICommandHandler<CommonUpsertAdministrativeAreaLevel3Command>
{
  constructor(
  ...
  async execute(
    command: CommonUpsertAdministrativeAreaLevel3Command,
  ): Promise<void> {
