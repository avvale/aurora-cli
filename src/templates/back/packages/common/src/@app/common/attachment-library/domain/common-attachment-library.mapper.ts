...
export class CommonAttachmentLibraryMapper implements IMapper
{
    ...
    private makeAggregate(attachmentLibrary: LiteralObject, cQMetadata?: CQMetadata): CommonAttachmentLibrary
    {
        return CommonAttachmentLibrary.register(
            ...
            new CommonAttachmentLibraryName(attachmentLibrary.name, { undefinable: true }),
            new CommonAttachmentLibraryPath(attachmentLibrary.path, { undefinable: true }),
            ...
            new CommonAttachmentLibraryMime(attachmentLibrary.mime, { undefinable: true }),
