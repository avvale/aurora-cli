...
export class CommonUpdateAdministrativeAreaLevel2ByIdCommandHandler
  implements ICommandHandler<CommonUpdateAdministrativeAreaLevel2ByIdCommand>
{
  constructor(
  ...
  async execute(
    command: CommonUpdateAdministrativeAreaLevel2ByIdCommand,
  ): Promise<void> {
