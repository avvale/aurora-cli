...
@Injectable()
export class CommonMockAttachmentRepository
  extends MockRepository<CommonAttachment>
    ...
    for (const itemCollection of <any[]>commonMockAttachmentData) {
      ...
      this.collectionSource.push(
        CommonAttachment.register(
          ...
          new CommonAttachmentLangId(itemCollection.langId),
          ...
          new CommonAttachmentOriginFilename(itemCollection.originFilename),
          ...
          new CommonAttachmentRelativePathSegments(
            itemCollection.relativePathSegments,
          ),
          ...
          new CommonAttachmentSizes(itemCollection.sizes),
