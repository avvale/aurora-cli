            ...
            command.payload
                .map(attachment =>
                {
                    return {
                        ...
                        attachableId: new CommonAttachmentAttachableId(attachment.attachableId),
                        ...
                        originFilename: new CommonAttachmentOriginFilename(attachment.originFilename),
                        ...
                        relativePathSegments: new CommonAttachmentRelativePathSegments(attachment.relativePathSegments),
