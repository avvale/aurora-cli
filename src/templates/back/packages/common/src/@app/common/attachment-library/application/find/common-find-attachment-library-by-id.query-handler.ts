import { CommonAttachmentLibraryMapper, CommonAttachmentLibraryResponse, CommonFindAttachmentLibraryByIdQuery } from '@app/common/attachment-library';
...
export class CommonFindAttachmentLibraryByIdQueryHandler implements IQueryHandler<CommonFindAttachmentLibraryByIdQuery>
{
    ...
    async execute(query: CommonFindAttachmentLibraryByIdQuery): Promise<CommonAttachmentLibraryResponse>
    {
