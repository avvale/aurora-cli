...
export class CommonDeleteLangsCommandHandler
  implements ICommandHandler<CommonDeleteLangsCommand>
{
  constructor(private readonly deleteLangsService: CommonDeleteLangsService) {}
