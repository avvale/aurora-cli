...
export class CommonUpdateAdministrativeAreasLevel3CommandHandler
  implements ICommandHandler<CommonUpdateAdministrativeAreasLevel3Command>
{
  constructor(
  ...
  async execute(
    command: CommonUpdateAdministrativeAreasLevel3Command,
  ): Promise<void> {
