...
export class CommonCountryMapper implements IMapper {
    ...
    mapModelsToAggregates(
        countries: LiteralObject[],
        cQMetadata?: CQMetadata,
    ): CommonCountry[] {
        if (!Array.isArray(countries)) return;

        return countries.map((country) =>
            this.makeAggregate(country, cQMetadata),
        );
    }
    ...
    private makeAggregate(
        ...
        return CommonCountry.register(
            ...
            new CommonCountryCreatedAt(
                country.createdAt,
                { undefinable: true },
                { addTimezone: cQMetadata?.timezone },
            ),
            new CommonCountryUpdatedAt(
                country.updatedAt,
                { undefinable: true },
                { addTimezone: cQMetadata?.timezone },
            ),
            new CommonCountryDeletedAt(
                country.deletedAt,
                { undefinable: true },
                { addTimezone: cQMetadata?.timezone },
            ),
            new CommonCountryI18nLangId(country.countryI18n.langId, {
                undefinable: true,
            }),
            new CommonCountryI18nName(country.countryI18n.name, {
                undefinable: true,
            }),
            new CommonCountryI18nSlug(country.countryI18n.slug, {
                undefinable: true,
            }),
            new CommonCountryI18nAdministrativeAreaLevel1(
                country.countryI18n.administrativeAreaLevel1,
                { undefinable: true },
            ),
            new CommonCountryI18nAdministrativeAreaLevel2(
                country.countryI18n.administrativeAreaLevel2,
                { undefinable: true },
            ),
            new CommonCountryI18nAdministrativeAreaLevel3(
                country.countryI18n.administrativeAreaLevel3,
                { undefinable: true },
            ),
