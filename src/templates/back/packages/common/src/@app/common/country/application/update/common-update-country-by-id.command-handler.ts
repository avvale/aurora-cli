...
export class CommonUpdateCountryByIdCommandHandler
  implements ICommandHandler<CommonUpdateCountryByIdCommand>
{
  constructor(
    ...
    await this.updateCountryByIdService.main(
      {
        ...
        administrativeAreas: new CommonCountryAdministrativeAreas(
          command.payload.administrativeAreas,
        ),
        ...
        administrativeAreaLevel1: new CommonCountryI18nAdministrativeAreaLevel1(
          command.payload.administrativeAreaLevel1,
        ),
        administrativeAreaLevel2: new CommonCountryI18nAdministrativeAreaLevel2(
          command.payload.administrativeAreaLevel2,
        ),
        administrativeAreaLevel3: new CommonCountryI18nAdministrativeAreaLevel3(
          command.payload.administrativeAreaLevel3,
        ),
      },
      command.constraint,
      command.cQMetadata,
