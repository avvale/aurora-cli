...
export class CommonCreateAdministrativeAreasLevel1Service
{
    ...
    ): Promise<void>
    {
        ...
        const aggregateAdministrativeAreasLevel1 = payload.map(administrativeAreaLevel1 => CommonAdministrativeAreaLevel1.register(
        ...
        const administrativeAreasLevel1Registered = this.publisher.mergeObjectContext(new CommonAddAdministrativeAreasLevel1ContextEvent(aggregateAdministrativeAreasLevel1));
