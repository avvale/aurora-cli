import { CommonIAttachmentLibraryRepository, CommonMockAttachmentLibraryRepository, CommonPaginateAttachmentLibrariesQuery } from '@app/common/attachment-library';
...
describe('CommonPaginateAttachmentLibrariesQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<CommonPaginateAttachmentLibrariesQueryHandler>(CommonPaginateAttachmentLibrariesQueryHandler);
        service = module.get<CommonPaginateAttachmentLibrariesService>(CommonPaginateAttachmentLibrariesService);
