import { CommonAttachmentMapper, CommonAttachmentResponse, CommonFindAttachmentByIdQuery } from '@app/common/attachment';
...
export class CommonFindAttachmentByIdQueryHandler implements IQueryHandler<CommonFindAttachmentByIdQuery>
{
    ...
    async execute(query: CommonFindAttachmentByIdQuery): Promise<CommonAttachmentResponse>
    {
