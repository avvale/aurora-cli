...
export class CommonAdministrativeAreaLevel1Mapper implements IMapper
{
     ...
     * @param administrativeAreaLevel1
     */
    mapAggregateToResponse(administrativeAreaLevel1: CommonAdministrativeAreaLevel1): CommonAdministrativeAreaLevel1Response
    {
     ...
     * @param administrativeAreasLevel1
     */
    mapAggregatesToResponses(administrativeAreasLevel1: CommonAdministrativeAreaLevel1[]): CommonAdministrativeAreaLevel1Response[]
    {
        if (!Array.isArray(administrativeAreasLevel1)) return;
    ...
    private makeAggregate(administrativeAreaLevel1: LiteralObject, cQMetadata?: CQMetadata): CommonAdministrativeAreaLevel1
    {
        return CommonAdministrativeAreaLevel1.register(
            new CommonAdministrativeAreaLevel1Id(administrativeAreaLevel1.id, { undefinable: true }),
            new CommonAdministrativeAreaLevel1CountryId(administrativeAreaLevel1.countryId, { undefinable: true }),
            new CommonAdministrativeAreaLevel1Code(administrativeAreaLevel1.code, { undefinable: true }),
            new CommonAdministrativeAreaLevel1CustomCode(administrativeAreaLevel1.customCode, { undefinable: true }),
            new CommonAdministrativeAreaLevel1Name(administrativeAreaLevel1.name, { undefinable: true }),
            new CommonAdministrativeAreaLevel1Slug(administrativeAreaLevel1.slug, { undefinable: true }),
            new CommonAdministrativeAreaLevel1Latitude(administrativeAreaLevel1.latitude, { undefinable: true }),
            new CommonAdministrativeAreaLevel1Longitude(administrativeAreaLevel1.longitude, { undefinable: true }),
            new CommonAdministrativeAreaLevel1Zoom(administrativeAreaLevel1.zoom, { undefinable: true }),
            new CommonAdministrativeAreaLevel1MapType(administrativeAreaLevel1.mapType, { undefinable: true }),
            new CommonAdministrativeAreaLevel1CreatedAt(administrativeAreaLevel1.createdAt, { undefinable: true }, { addTimezone: cQMetadata?.timezone }),
            new CommonAdministrativeAreaLevel1UpdatedAt(administrativeAreaLevel1.updatedAt, { undefinable: true }, { addTimezone: cQMetadata?.timezone }),
            new CommonAdministrativeAreaLevel1DeletedAt(administrativeAreaLevel1.deletedAt, { undefinable: true }, { addTimezone: cQMetadata?.timezone }),
            this.options.eagerLoading ? new CommonCountryMapper({ eagerLoading: true }).mapModelToAggregate(administrativeAreaLevel1.country, cQMetadata) : undefined,
        );
    }

    private makeResponse(administrativeAreaLevel1: CommonAdministrativeAreaLevel1): CommonAdministrativeAreaLevel1Response
    {
        if (!administrativeAreaLevel1) return;
        ...
        return new CommonAdministrativeAreaLevel1Response(
            ...
            this.options.eagerLoading ? new CommonCountryMapper({ eagerLoading: true }).mapAggregateToResponse(administrativeAreaLevel1.country) : undefined,
        );
    }
}