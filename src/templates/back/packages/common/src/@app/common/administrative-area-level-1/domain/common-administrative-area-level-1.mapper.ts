...
export class CommonAdministrativeAreaLevel1Mapper implements IMapper {
    ...
    private makeAggregate(
        ...
        return CommonAdministrativeAreaLevel1.register(
            ...
            new CommonAdministrativeAreaLevel1Code(
            ...
            new CommonAdministrativeAreaLevel1Name(
                administrativeAreaLevel1.name,
                { undefinable: true },
            ),
            new CommonAdministrativeAreaLevel1Slug(
            ...
            new CommonAdministrativeAreaLevel1Zoom(
