...
export class CommonAdministrativeAreaLevel2Mapper implements IMapper {
     ...
     */
    mapModelToAggregate(
        administrativeAreaLevel2: LiteralObject,
    ...
    mapModelsToAggregates(
        administrativeAreasLevel2: LiteralObject[],
        cQMetadata?: CQMetadata,
    ): CommonAdministrativeAreaLevel2[] {
        if (!Array.isArray(administrativeAreasLevel2)) return;

        return administrativeAreasLevel2.map((administrativeAreaLevel2) =>
            this.makeAggregate(administrativeAreaLevel2, cQMetadata),
        );
    }
    ...
    mapAggregatesToResponses(
        ...
        return administrativeAreasLevel2.map((administrativeAreaLevel2) =>
            this.makeResponse(administrativeAreaLevel2),
        );
    }
    ...
    private makeAggregate(
        ...
        return CommonAdministrativeAreaLevel2.register(
            ...
            new CommonAdministrativeAreaLevel2Code(
            ...
            new CommonAdministrativeAreaLevel2Name(
                administrativeAreaLevel2.name,
                { undefinable: true },
            ),
            new CommonAdministrativeAreaLevel2Slug(
            ...
            new CommonAdministrativeAreaLevel2Zoom(
            ...
            new CommonAdministrativeAreaLevel2CreatedAt(
                administrativeAreaLevel2.createdAt,
                { undefinable: true },
                { addTimezone: cQMetadata?.timezone },
            ),
            new CommonAdministrativeAreaLevel2UpdatedAt(
                administrativeAreaLevel2.updatedAt,
                { undefinable: true },
                { addTimezone: cQMetadata?.timezone },
            ),
            new CommonAdministrativeAreaLevel2DeletedAt(
                administrativeAreaLevel2.deletedAt,
                { undefinable: true },
                { addTimezone: cQMetadata?.timezone },
            ),
            this.options.eagerLoading
                ? new CommonCountryMapper({
                      ...
                      administrativeAreaLevel2.country,
                      cQMetadata,
                  )
                : undefined,
            this.options.eagerLoading
    ...
    private makeResponse(
        ...
        if (!administrativeAreaLevel2) return null;
        ...
        return new CommonAdministrativeAreaLevel2Response(
            ...
            this.options.eagerLoading
                ? new CommonCountryMapper({
                      eagerLoading: true,
                  }).mapAggregateToResponse(administrativeAreaLevel2.country)
                : undefined,
            this.options.eagerLoading
                ? new CommonAdministrativeAreaLevel1Mapper({
                      eagerLoading: true,
