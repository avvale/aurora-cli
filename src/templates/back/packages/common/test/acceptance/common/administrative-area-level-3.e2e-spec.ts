...
describe('administrative-area-level-3', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [CommonMockAdministrativeAreaLevel3Seeder],
    })
    ...
    administrativeAreaLevel3Repository =
      module.get<CommonIAdministrativeAreaLevel3Repository>(
        CommonIAdministrativeAreaLevel3Repository,
      );
    administrativeAreaLevel3Seeder =
      module.get<CommonMockAdministrativeAreaLevel3Seeder>(
        CommonMockAdministrativeAreaLevel3Seeder,
      );

    // seed mock data in memory database
    await administrativeAreaLevel3Repository.insert(
      administrativeAreaLevel3Seeder.collectionSource,
    );
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3Id must be defined, can not be null',
        );
      });
  });

  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3RowId property can not to be null', () => {
    return request(app.getHttpServer())
      .post('/common/administrative-area-level-3/create')
      .set('Accept', 'application/json')
      .send({
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3RowId must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3CountryId property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3CountryId must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3AdministrativeAreaLevel1Id property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3AdministrativeAreaLevel1Id must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3AdministrativeAreaLevel2Id property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3AdministrativeAreaLevel2Id must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3Code property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3Code must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3Name property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3Name must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3Slug property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3Slug must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3Id property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3Id must be defined, can not be undefined',
        );
      });
  });

  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3RowId property can not to be undefined', () => {
    return request(app.getHttpServer())
      .post('/common/administrative-area-level-3/create')
      .set('Accept', 'application/json')
      .send({
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3RowId must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3CountryId property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3CountryId must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3AdministrativeAreaLevel1Id property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3AdministrativeAreaLevel1Id must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3AdministrativeAreaLevel2Id property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3AdministrativeAreaLevel2Id must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3Code property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3Code must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3Name property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3Name must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3Slug property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3Slug must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3Id is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3Id is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3CountryId is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3CountryId is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3AdministrativeAreaLevel1Id is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3AdministrativeAreaLevel1Id is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3AdministrativeAreaLevel2Id is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3AdministrativeAreaLevel2Id is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3Code is too large, has a maximum length of 8', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3Code is too large, has a maximum length of 8',
        );
      });
  });

  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3CustomCode is too large, has a maximum length of 64', () => {
    return request(app.getHttpServer())
      .post('/common/administrative-area-level-3/create')
      .set('Accept', 'application/json')
      .send({
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3CustomCode is too large, has a maximum length of 64',
        );
      });
  });

  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3Name is too large, has a maximum length of 128', () => {
    return request(app.getHttpServer())
      .post('/common/administrative-area-level-3/create')
      .set('Accept', 'application/json')
      .send({
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3Name is too large, has a maximum length of 128',
        );
      });
  });

  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3Slug is too large, has a maximum length of 128', () => {
    return request(app.getHttpServer())
      .post('/common/administrative-area-level-3/create')
      .set('Accept', 'application/json')
      .send({
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3Slug is too large, has a maximum length of 128',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3MapType has to be a enum option of ROADMAP, SATELLITE, HYBRID, TERRAIN', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3MapType has to be any of this options: ROADMAP, SATELLITE, HYBRID, TERRAIN',
        );
      });
  });
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3Latitude is too large, has a maximum decimal integers length of 2', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3Latitude is too large, has a maximum length of 2 integers in',
        );
      });
  });
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3Longitude is too large, has a maximum decimal integers length of 3', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3Longitude is too large, has a maximum length of 3 integers in',
        );
      });
  });
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3Latitude is too large, has a maximum decimals length of 14', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3Latitude is too large, has a maximum length of 14 decimals in',
        );
      });
  });
  test('/REST:POST common/administrative-area-level-3/create - Got 400 Conflict, AdministrativeAreaLevel3Longitude is too large, has a maximum decimals length of 14', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel3Longitude is too large, has a maximum length of 14 decimals in',
        );
      });
  });
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body).toEqual({
          ...
          rows: administrativeAreaLevel3Seeder.collectionResponse
            .map((item) =>
  ...
  test('/REST:POST common/administrative-areas-level-3/get', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body).toEqual(
          administrativeAreaLevel3Seeder.collectionResponse.map((item) =>
            expect.objectContaining(
              _.omit(item, ['createdAt', 'updatedAt', 'deletedAt']),
            ),
          ),
  ...
  test('/REST:POST common/administrative-area-level-3/find/{id} - Got 404 Not Found', () => {
    return request(app.getHttpServer())
      .post(
        '/common/administrative-area-level-3/find/78484f74-0fab-5d35-bbe4-0ce9f02f98c7',
      )
      .set('Accept', 'application/json')
      .expect(404);
  });
  ...
  test('/REST:POST common/administrative-area-level-3/find/{id}', () => {
    return request(app.getHttpServer())
      .post(
        '/common/administrative-area-level-3/find/5b19d6ac-4081-573b-96b3-56964d5326a8',
      )
      .set('Accept', 'application/json')
      .expect(200)
      .then((res) => {
  ...
  test('/REST:DELETE common/administrative-area-level-3/delete/{id} - Got 404 Not Found', () => {
    return request(app.getHttpServer())
      .delete(
        '/common/administrative-area-level-3/delete/e2035779-8b36-509f-991a-2298eb2c9099',
      )
      .set('Accept', 'application/json')
      .expect(404);
  });
  ...
  test('/REST:DELETE common/administrative-area-level-3/delete/{id}', () => {
    return request(app.getHttpServer())
      .delete(
        '/common/administrative-area-level-3/delete/5b19d6ac-4081-573b-96b3-56964d5326a8',
      )
      .set('Accept', 'application/json')
      .expect(200);
  });
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        for (const [
          index,
          value,
        ] of res.body.data.commonGetAdministrativeAreasLevel3.entries()) {
          expect(
            administrativeAreaLevel3Seeder.collectionResponse[index],
          ).toEqual(
            expect.objectContaining(
  ...
  test('/GraphQL commonCreateAdministrativeAreaLevel3', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(
          res.body.data.commonCreateAdministrativeAreaLevel3,
  ...
  test('/GraphQL commonFindAdministrativeAreaLevel3', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(
          res.body.data.commonFindAdministrativeAreaLevel3.id,
  ...
  test('/GraphQL commonFindAdministrativeAreaLevel3ById', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(
          res.body.data.commonFindAdministrativeAreaLevel3ById.id,
        ).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
      });
  });
  ...
  test('/GraphQL commonUpdateAdministrativeAreaLevel3ById', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(
          res.body.data.commonUpdateAdministrativeAreaLevel3ById.id,
        ).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
      });
  });
  ...
  test('/GraphQL commonUpdateAdministrativeAreasLevel3', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(
          res.body.data.commonUpdateAdministrativeAreasLevel3[0].id,
        ).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
      });
  });
  ...
  test('/GraphQL commonDeleteAdministrativeAreaLevel3ById', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(
          res.body.data.commonDeleteAdministrativeAreaLevel3ById.id,
        ).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
      });
  });
