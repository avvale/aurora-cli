...
describe('attachment', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [CommonMockAttachmentSeeder],
    })
    ...
    attachmentRepository = module.get<CommonIAttachmentRepository>(
      CommonIAttachmentRepository,
    );
    attachmentSeeder = module.get<CommonMockAttachmentSeeder>(
      CommonMockAttachmentSeeder,
    );
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentId must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentAttachableId property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentAttachableId must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentOriginFilename property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentOriginFilename must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentFilename property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentFilename must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentMimetype property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentMimetype must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentExtension property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentExtension must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentRelativePathSegments property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentRelativePathSegments must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentSize property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentSize must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentUrl property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentUrl must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentIsCropable property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentIsCropable must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentId property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentId must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentAttachableId property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentAttachableId must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentOriginFilename property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentOriginFilename must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentFilename property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentFilename must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentMimetype property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentMimetype must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentExtension property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentExtension must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentRelativePathSegments property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentRelativePathSegments must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentSize property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentSize must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentUrl property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentUrl must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentIsCropable property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentIsCropable must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentId is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentId is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentAttachableId is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentAttachableId is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentLangId is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLangId is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentLibraryId is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryId is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentAlt is too large, has a maximum length of 255', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentAlt is too large, has a maximum length of 255',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentTitle is too large, has a maximum length of 255', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentTitle is too large, has a maximum length of 255',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentOriginFilename is too large, has a maximum length of 255', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentOriginFilename is too large, has a maximum length of 255',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentFilename is too large, has a maximum length of 255', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentFilename is too large, has a maximum length of 255',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentMimetype is too large, has a maximum length of 63', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentMimetype is too large, has a maximum length of 63',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentExtension is too large, has a maximum length of 10', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentExtension is too large, has a maximum length of 10',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentUrl is too large, has a maximum length of 2047', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentUrl is too large, has a maximum length of 2047',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentLibraryFilename is too large, has a maximum length of 255', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryFilename is too large, has a maximum length of 255',
        );
      });
  });
  ...
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentWidth has to be a integer value', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentWidth has to be a integer value',
        );
      });
  });
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentHeight has to be a integer value', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentHeight has to be a integer value',
        );
      });
  });
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentSize has to be a integer value', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentSize has to be a integer value',
        );
      });
  });
  test('/REST:POST common/attachment/create - Got 400 Conflict, AttachmentIsCropable has to be a boolean value', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentIsCropable has to be a boolean value',
        );
      });
  });
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body).toEqual({
          ...
          rows: attachmentSeeder.collectionResponse
            .map((item) =>
  ...
  test('/REST:POST common/attachments/get', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body).toEqual(
          attachmentSeeder.collectionResponse.map((item) =>
            expect.objectContaining(
              _.omit(item, ['createdAt', 'updatedAt', 'deletedAt']),
            ),
          ),
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        for (const [
          index,
          value,
        ] of res.body.data.commonGetAttachments.entries()) {
          expect(attachmentSeeder.collectionResponse[index]).toEqual(
            expect.objectContaining(
  ...
  test('/GraphQL commonCreateAttachment', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.commonCreateAttachment).toHaveProperty(
          'id',
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  ...
  test('/GraphQL commonFindAttachment', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.commonFindAttachment.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL commonFindAttachmentById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.commonFindAttachmentById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL commonUpdateAttachmentById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.commonUpdateAttachmentById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL commonUpdateAttachments', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.commonUpdateAttachments[0].id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL commonDeleteAttachmentById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.commonDeleteAttachmentById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
