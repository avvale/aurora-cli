...
describe('resource', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resourceRepository = module.get<CommonIResourceRepository>(CommonIResourceRepository);
        resourceSeeder = module.get<CommonMockResourceSeeder>(CommonMockResourceSeeder);
        ...
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body).toEqual({
                    ...
                    rows : resourceSeeder.collectionResponse.map(item => expect.objectContaining(_.omit(item, ['createdAt', 'updatedAt', 'deletedAt']))).slice(0, 5),
                });
            });
    });
    ...
    test('/REST:POST common/resources/get', () =>
    {
        return request(app.getHttpServer())
            ...
            {
                expect(res.body).toEqual(
                    resourceSeeder.collectionResponse.map(item => expect.objectContaining(_.omit(item, ['createdAt', 'updatedAt', 'deletedAt']))),
                );
            });
    });
    ...
    test('/GraphQL commonGetResources', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                for (const [index, value] of res.body.data.commonGetResources.entries())
                {
                    expect(resourceSeeder.collectionResponse[index]).toEqual(expect.objectContaining(_.omit(value, ['createdAt', 'updatedAt', 'deletedAt'])));
                }
            });
    });
    ...
    test('/GraphQL commonCreateResource', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.data.commonCreateResource).toHaveProperty('id', '5b19d6ac-4081-573b-96b3-56964d5326a8');
            });
    });
    ...
    test('/GraphQL commonFindResource', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.data.commonFindResource.id).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
            });
    });
    ...
    test('/GraphQL commonFindResourceById', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.data.commonFindResourceById.id).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
            });
    });
    ...
    test('/GraphQL commonUpdateResourceById', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.data.commonUpdateResourceById.id).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
            });
    });
    ...
    test('/GraphQL commonUpdateResources', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.data.commonUpdateResources[0].id).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
            });
    });
    ...
    test('/GraphQL commonDeleteResourceById', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.data.commonDeleteResourceById.id).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
            });
    });
