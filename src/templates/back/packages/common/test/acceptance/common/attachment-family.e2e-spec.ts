...
describe('attachment-family', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        attachmentFamilyRepository = module.get<CommonIAttachmentFamilyRepository>(CommonIAttachmentFamilyRepository);
        attachmentFamilySeeder = module.get<CommonMockAttachmentFamilySeeder>(CommonMockAttachmentFamilySeeder);

        // seed mock data in memory database
        await attachmentFamilyRepository.insert(attachmentFamilySeeder.collectionSource);
    ...
    {
        return request(app.getHttpServer())
            .post('/common/attachment-family/find/f28d7125-c6d2-5526-a327-514b4bc9e34e')
            .set('Accept', 'application/json')
            .expect(404);
    });
    ...
    {
        return request(app.getHttpServer())
            .post('/common/attachment-family/find/5b19d6ac-4081-573b-96b3-56964d5326a8')
            .set('Accept', 'application/json')
            .expect(200)
            .then(res =>
            {
    ...
    {
        return request(app.getHttpServer())
            .delete('/common/attachment-family/delete/ccd4138a-49f0-596e-9dde-16a462d202ae')
            .set('Accept', 'application/json')
            .expect(404);
    });
    ...
    {
        return request(app.getHttpServer())
            .delete('/common/attachment-family/delete/5b19d6ac-4081-573b-96b3-56964d5326a8')
            .set('Accept', 'application/json')
            .expect(200);
    });
    ...
    test('/GraphQL commonGetAttachmentFamilies', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                for (const [index, value] of res.body.data.commonGetAttachmentFamilies.entries())
                {
                    expect(attachmentFamilySeeder.collectionResponse[index]).toEqual(expect.objectContaining(_.omit(value, ['createdAt', 'updatedAt', 'deletedAt'])));
                }
            });
    });
    ...
    test('/GraphQL commonCreateAttachmentFamily', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.data.commonCreateAttachmentFamily).toHaveProperty('id', '5b19d6ac-4081-573b-96b3-56964d5326a8');
            });
    });
    ...
    test('/GraphQL commonFindAttachmentFamily', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.data.commonFindAttachmentFamily.id).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
            });
    });
    ...
    test('/GraphQL commonFindAttachmentFamilyById', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.data.commonFindAttachmentFamilyById.id).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
            });
    });
    ...
    test('/GraphQL commonUpdateAttachmentFamilyById', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.data.commonUpdateAttachmentFamilyById.id).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
            });
    });
    ...
    test('/GraphQL commonUpdateAttachmentFamilies', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.data.commonUpdateAttachmentFamilies[0].id).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
            });
    });
    ...
    test('/GraphQL commonDeleteAttachmentFamilyById', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.data.commonDeleteAttachmentFamilyById.id).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
            });
    });
