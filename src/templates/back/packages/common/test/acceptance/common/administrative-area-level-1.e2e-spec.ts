...
describe('administrative-area-level-1', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        administrativeAreaLevel1Repository = module.get<CommonIAdministrativeAreaLevel1Repository>(CommonIAdministrativeAreaLevel1Repository);
        administrativeAreaLevel1Seeder = module.get<CommonMockAdministrativeAreaLevel1Seeder>(CommonMockAdministrativeAreaLevel1Seeder);
    ...
    test('/REST:POST common/administrative-area-level-1/create - Got 400 Conflict, AdministrativeAreaLevel1Id property can not to be null', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for CommonAdministrativeAreaLevel1Id must be defined, can not be null');
            });
    });
    ...
    test('/REST:POST common/administrative-area-level-1/create - Got 400 Conflict, AdministrativeAreaLevel1CountryId property can not to be null', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for CommonAdministrativeAreaLevel1CountryId must be defined, can not be null');
            });
    });
    ...
    test('/REST:POST common/administrative-area-level-1/create - Got 400 Conflict, AdministrativeAreaLevel1Code property can not to be null', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for CommonAdministrativeAreaLevel1Code must be defined, can not be null');
            });
    });
    ...
    test('/REST:POST common/administrative-area-level-1/create - Got 400 Conflict, AdministrativeAreaLevel1Name property can not to be null', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for CommonAdministrativeAreaLevel1Name must be defined, can not be null');
            });
    });
    ...
    test('/REST:POST common/administrative-area-level-1/create - Got 400 Conflict, AdministrativeAreaLevel1Slug property can not to be null', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for CommonAdministrativeAreaLevel1Slug must be defined, can not be null');
            });
    });
    ...
    test('/REST:POST common/administrative-area-level-1/create - Got 400 Conflict, AdministrativeAreaLevel1Id property can not to be undefined', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for CommonAdministrativeAreaLevel1Id must be defined, can not be undefined');
            });
    });
    ...
    test('/REST:POST common/administrative-area-level-1/create - Got 400 Conflict, AdministrativeAreaLevel1CountryId property can not to be undefined', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for CommonAdministrativeAreaLevel1CountryId must be defined, can not be undefined');
            });
    });
    ...
    test('/REST:POST common/administrative-area-level-1/create - Got 400 Conflict, AdministrativeAreaLevel1Code property can not to be undefined', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for CommonAdministrativeAreaLevel1Code must be defined, can not be undefined');
            });
    });
    ...
    test('/REST:POST common/administrative-area-level-1/create - Got 400 Conflict, AdministrativeAreaLevel1Name property can not to be undefined', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for CommonAdministrativeAreaLevel1Name must be defined, can not be undefined');
            });
    });
    ...
    test('/REST:POST common/administrative-area-level-1/create - Got 400 Conflict, AdministrativeAreaLevel1Slug property can not to be undefined', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for CommonAdministrativeAreaLevel1Slug must be defined, can not be undefined');
            });
    });
    ...
    test('/REST:POST common/administrative-area-level-1/create - Got 400 Conflict, AdministrativeAreaLevel1Id is not allowed, must be a length of 36', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for CommonAdministrativeAreaLevel1Id is not allowed, must be a length of 36');
            });
    });
    ...
    test('/REST:POST common/administrative-area-level-1/create - Got 400 Conflict, AdministrativeAreaLevel1CountryId is not allowed, must be a length of 36', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for CommonAdministrativeAreaLevel1CountryId is not allowed, must be a length of 36');
            });
    });
    ...
    test('/REST:POST common/administrative-area-level-1/create - Got 400 Conflict, AdministrativeAreaLevel1Code is too large, has a maximum length of 8', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for CommonAdministrativeAreaLevel1Code is too large, has a maximum length of 8');
            });
    });
    ...
    test('/REST:POST common/administrative-area-level-1/create - Got 400 Conflict, AdministrativeAreaLevel1CustomCode is too large, has a maximum length of 63', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for CommonAdministrativeAreaLevel1CustomCode is too large, has a maximum length of 63');
            });
    });
    ...
    test('/REST:POST common/administrative-area-level-1/create - Got 400 Conflict, AdministrativeAreaLevel1Name is too large, has a maximum length of 127', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for CommonAdministrativeAreaLevel1Name is too large, has a maximum length of 127');
            });
    });
    ...
    test('/REST:POST common/administrative-area-level-1/create - Got 400 Conflict, AdministrativeAreaLevel1Slug is too large, has a maximum length of 100', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for CommonAdministrativeAreaLevel1Slug is too large, has a maximum length of 100');
            });
    });
    ...
    test('/REST:POST common/administrative-area-level-1/create - Got 400 Conflict, AdministrativeAreaLevel1MapType has to be a enum option of ROADMAP, SATELLITE, HYBRID, TERRAIN', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for CommonAdministrativeAreaLevel1MapType has to be any of this options: ROADMAP, SATELLITE, HYBRID, TERRAIN');
            });
    });
    test('/REST:POST common/administrative-area-level-1/create - Got 400 Conflict, AdministrativeAreaLevel1Latitude is too large, has a maximum decimal integers length of 2', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for CommonAdministrativeAreaLevel1Latitude is too large, has a maximum length of 2 integers in');
            });
    });
    test('/REST:POST common/administrative-area-level-1/create - Got 400 Conflict, AdministrativeAreaLevel1Longitude is too large, has a maximum decimal integers length of 3', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for CommonAdministrativeAreaLevel1Longitude is too large, has a maximum length of 3 integers in');
            });
    });
    test('/REST:POST common/administrative-area-level-1/create - Got 400 Conflict, AdministrativeAreaLevel1Latitude is too large, has a maximum decimals length of 14', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for CommonAdministrativeAreaLevel1Latitude is too large, has a maximum length of 14 decimals in');
            });
    });
    test('/REST:POST common/administrative-area-level-1/create - Got 400 Conflict, AdministrativeAreaLevel1Longitude is too large, has a maximum decimals length of 14', () =>
    {
        return request(app.getHttpServer())
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for CommonAdministrativeAreaLevel1Longitude is too large, has a maximum length of 14 decimals in');
            });
    });
    ...
    {
        return request(app.getHttpServer())
            .post('/common/administrative-area-level-1/find/34f5ee7b-3597-5415-88f4-82f52682a122')
            .set('Accept', 'application/json')
            .expect(404);
    });
    ...
    {
        return request(app.getHttpServer())
            .delete('/common/administrative-area-level-1/delete/d18b4ebb-c426-5e98-b9cb-05a77bd5ee6a')
            .set('Accept', 'application/json')
            .expect(404);
    });
