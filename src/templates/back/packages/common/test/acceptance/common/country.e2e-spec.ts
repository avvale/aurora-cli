...
describe('country', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [CommonMockCountrySeeder],
    })
    ...
    countryRepository = module.get<CommonICountryRepository>(
      CommonICountryRepository,
    );
    repositoryI18n = module.get<CommonICountryI18nRepository>(
      CommonICountryI18nRepository,
    );
    countrySeeder = module.get<CommonMockCountrySeeder>(
      CommonMockCountrySeeder,
    );

    // seed mock data in memory database
    await countryRepository.insert(
      countrySeeder.collectionSource.filter(
        (item, index, self) =>
          index === self.findIndex((t) => t.id.value === item.id.value),
      ),
    );
    await repositoryI18n.insert(countrySeeder.collectionSource, {
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryId must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/country/create - Got 400 Conflict, CountryIso3166Alpha2 property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryIso3166Alpha2 must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/country/create - Got 400 Conflict, CountryIso3166Alpha3 property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryIso3166Alpha3 must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/country/create - Got 400 Conflict, CountryIso3166Numeric property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryIso3166Numeric must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/country/create - Got 400 Conflict, CountryI18nLangId property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryI18nLangId must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/country/create - Got 400 Conflict, CountryI18nName property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryI18nName must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/country/create - Got 400 Conflict, CountryI18nSlug property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryI18nSlug must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/country/create - Got 400 Conflict, CountryIso3166Alpha2 property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryIso3166Alpha2 must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/country/create - Got 400 Conflict, CountryIso3166Alpha3 property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryIso3166Alpha3 must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/country/create - Got 400 Conflict, CountryIso3166Numeric property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryIso3166Numeric must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/country/create - Got 400 Conflict, CountryI18nLangId property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryI18nLangId must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/country/create - Got 400 Conflict, CountryI18nName property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryI18nName must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/country/create - Got 400 Conflict, CountryI18nSlug property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryI18nSlug must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/country/create - Got 400 Conflict, CountryId is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryId is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST common/country/create - Got 400 Conflict, CountryIso3166Alpha2 is not allowed, must be a length of 2', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryIso3166Alpha2 is not allowed, must be a length of 2',
        );
      });
  });
  ...
  test('/REST:POST common/country/create - Got 400 Conflict, CountryIso3166Alpha3 is not allowed, must be a length of 3', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryIso3166Alpha3 is not allowed, must be a length of 3',
        );
      });
  });
  ...
  test('/REST:POST common/country/create - Got 400 Conflict, CountryIso3166Numeric is not allowed, must be a length of 3', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryIso3166Numeric is not allowed, must be a length of 3',
        );
      });
  });
  ...
  test('/REST:POST common/country/create - Got 400 Conflict, CountryI18nLangId is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryI18nLangId is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST common/country/create - Got 400 Conflict, CountryPrefix is too large, has a maximum length of 5', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryPrefix is too large, has a maximum length of 5',
        );
      });
  });
  ...
  test('/REST:POST common/country/create - Got 400 Conflict, CountryImage is too large, has a maximum length of 1022', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryImage is too large, has a maximum length of 1022',
        );
      });
  });
  ...
  test('/REST:POST common/country/create - Got 400 Conflict, CountryMapType has to be a enum option of ROADMAP, SATELLITE, HYBRID, TERRAIN', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryMapType has to be any of this options: ROADMAP, SATELLITE, HYBRID, TERRAIN',
        );
      });
  });
  test('/REST:POST common/country/create - Got 400 Conflict, CountryLatitude is too large, has a maximum decimal integers length of 2', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryLatitude is too large, has a maximum length of 2 integers in',
        );
      });
  });
  test('/REST:POST common/country/create - Got 400 Conflict, CountryLongitude is too large, has a maximum decimal integers length of 3', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryLongitude is too large, has a maximum length of 3 integers in',
        );
      });
  });
  test('/REST:POST common/country/create - Got 400 Conflict, CountryLatitude is too large, has a maximum decimals length of 14', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryLatitude is too large, has a maximum length of 14 decimals in',
        );
      });
  });
  test('/REST:POST common/country/create - Got 400 Conflict, CountryLongitude is too large, has a maximum decimals length of 14', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonCountryLongitude is too large, has a maximum length of 14 decimals in',
        );
      });
  });
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body).toEqual({
          total: countrySeeder.collectionResponse.filter(
            (item) => item.langId === '4470b5ab-9d57-4c9d-a68f-5bf8e32f543a',
          ).length,
          count: countrySeeder.collectionResponse.filter(
            (item) => item.langId === '4470b5ab-9d57-4c9d-a68f-5bf8e32f543a',
          ).length,
          rows: countrySeeder.collectionResponse
            .filter(
              (item) => item.langId === '4470b5ab-9d57-4c9d-a68f-5bf8e32f543a',
            )
            .map((item) =>
  ...
  test('/REST:POST common/countries/get', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body).toEqual(
          countrySeeder.collectionResponse
            .filter(
              (item) => item.langId === '4470b5ab-9d57-4c9d-a68f-5bf8e32f543a',
            )
            .map((item) =>
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        for (const [
          index,
          value,
        ] of res.body.data.commonGetCountries.entries()) {
          expect(countrySeeder.collectionResponse[index]).toEqual(
            expect.objectContaining(
  ...
  test('/GraphQL commonCreateCountry', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.commonCreateCountry).toHaveProperty(
          'id',
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  ...
  test('/GraphQL commonFindCountry', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.commonFindCountry.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL commonFindCountryById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.commonFindCountryById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL commonUpdateCountryById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.commonUpdateCountryById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL commonUpdateCountries', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.commonUpdateCountries[0].id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL commonDeleteCountryById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.commonDeleteCountryById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
