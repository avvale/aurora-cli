...
describe('administrative-area-level-2', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [CommonMockAdministrativeAreaLevel2Seeder],
    })
    ...
    administrativeAreaLevel2Repository =
      module.get<CommonIAdministrativeAreaLevel2Repository>(
        CommonIAdministrativeAreaLevel2Repository,
      );
    administrativeAreaLevel2Seeder =
      module.get<CommonMockAdministrativeAreaLevel2Seeder>(
        CommonMockAdministrativeAreaLevel2Seeder,
      );

    // seed mock data in memory database
    await administrativeAreaLevel2Repository.insert(
      administrativeAreaLevel2Seeder.collectionSource,
    );
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2Id must be defined, can not be null',
        );
      });
  });

  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2RowId property can not to be null', () => {
    return request(app.getHttpServer())
      .post('/common/administrative-area-level-2/create')
      .set('Accept', 'application/json')
      .send({
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2RowId must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2CountryId property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2CountryId must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2AdministrativeAreaLevel1Id property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2AdministrativeAreaLevel1Id must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2Code property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2Code must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2Name property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2Name must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2Slug property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2Slug must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2Id property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2Id must be defined, can not be undefined',
        );
      });
  });

  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2RowId property can not to be undefined', () => {
    return request(app.getHttpServer())
      .post('/common/administrative-area-level-2/create')
      .set('Accept', 'application/json')
      .send({
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2RowId must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2CountryId property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2CountryId must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2AdministrativeAreaLevel1Id property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2AdministrativeAreaLevel1Id must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2Code property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2Code must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2Name property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2Name must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2Slug property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2Slug must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2Id is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2Id is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2CountryId is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2CountryId is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2AdministrativeAreaLevel1Id is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2AdministrativeAreaLevel1Id is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2Code is too large, has a maximum length of 8', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2Code is too large, has a maximum length of 8',
        );
      });
  });

  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2CustomCode is too large, has a maximum length of 64', () => {
    return request(app.getHttpServer())
      .post('/common/administrative-area-level-2/create')
      .set('Accept', 'application/json')
      .send({
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2CustomCode is too large, has a maximum length of 64',
        );
      });
  });

  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2Name is too large, has a maximum length of 128', () => {
    return request(app.getHttpServer())
      .post('/common/administrative-area-level-2/create')
      .set('Accept', 'application/json')
      .send({
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2Name is too large, has a maximum length of 128',
        );
      });
  });

  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2Slug is too large, has a maximum length of 128', () => {
    return request(app.getHttpServer())
      .post('/common/administrative-area-level-2/create')
      .set('Accept', 'application/json')
      .send({
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2Slug is too large, has a maximum length of 128',
        );
      });
  });
  ...
  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2MapType has to be a enum option of ROADMAP, SATELLITE, HYBRID, TERRAIN', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2MapType has to be any of this options: ROADMAP, SATELLITE, HYBRID, TERRAIN',
        );
      });
  });
  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2Latitude is too large, has a maximum decimal integers length of 2', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2Latitude is too large, has a maximum length of 2 integers in',
        );
      });
  });
  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2Longitude is too large, has a maximum decimal integers length of 3', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2Longitude is too large, has a maximum length of 3 integers in',
        );
      });
  });
  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2Latitude is too large, has a maximum decimals length of 14', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2Latitude is too large, has a maximum length of 14 decimals in',
        );
      });
  });
  test('/REST:POST common/administrative-area-level-2/create - Got 400 Conflict, AdministrativeAreaLevel2Longitude is too large, has a maximum decimals length of 14', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAdministrativeAreaLevel2Longitude is too large, has a maximum length of 14 decimals in',
        );
      });
  });
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body).toEqual({
          ...
          rows: administrativeAreaLevel2Seeder.collectionResponse
            .map((item) =>
  ...
  test('/REST:POST common/administrative-areas-level-2/get', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body).toEqual(
          administrativeAreaLevel2Seeder.collectionResponse.map((item) =>
            expect.objectContaining(
              _.omit(item, ['createdAt', 'updatedAt', 'deletedAt']),
            ),
          ),
  ...
  test('/REST:POST common/administrative-area-level-2/find/{id} - Got 404 Not Found', () => {
    return request(app.getHttpServer())
      .post(
        '/common/administrative-area-level-2/find/a571a0e2-d47c-5a9f-9997-4a746a5b10e4',
      )
      .set('Accept', 'application/json')
      .expect(404);
  });
  ...
  test('/REST:POST common/administrative-area-level-2/find/{id}', () => {
    return request(app.getHttpServer())
      .post(
        '/common/administrative-area-level-2/find/5b19d6ac-4081-573b-96b3-56964d5326a8',
      )
      .set('Accept', 'application/json')
      .expect(200)
      .then((res) => {
  ...
  test('/REST:DELETE common/administrative-area-level-2/delete/{id} - Got 404 Not Found', () => {
    return request(app.getHttpServer())
      .delete(
        '/common/administrative-area-level-2/delete/cf61bf53-ce15-5bab-915e-86b9574d064e',
      )
      .set('Accept', 'application/json')
      .expect(404);
  });
  ...
  test('/REST:DELETE common/administrative-area-level-2/delete/{id}', () => {
    return request(app.getHttpServer())
      .delete(
        '/common/administrative-area-level-2/delete/5b19d6ac-4081-573b-96b3-56964d5326a8',
      )
      .set('Accept', 'application/json')
      .expect(200);
  });
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        for (const [
          index,
          value,
        ] of res.body.data.commonGetAdministrativeAreasLevel2.entries()) {
          expect(
            administrativeAreaLevel2Seeder.collectionResponse[index],
          ).toEqual(
            expect.objectContaining(
  ...
  test('/GraphQL commonCreateAdministrativeAreaLevel2', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(
          res.body.data.commonCreateAdministrativeAreaLevel2,
  ...
  test('/GraphQL commonFindAdministrativeAreaLevel2', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(
          res.body.data.commonFindAdministrativeAreaLevel2.id,
  ...
  test('/GraphQL commonFindAdministrativeAreaLevel2ById', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(
          res.body.data.commonFindAdministrativeAreaLevel2ById.id,
        ).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
      });
  });
  ...
  test('/GraphQL commonUpdateAdministrativeAreaLevel2ById', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(
          res.body.data.commonUpdateAdministrativeAreaLevel2ById.id,
        ).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
      });
  });
  ...
  test('/GraphQL commonUpdateAdministrativeAreasLevel2', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(
          res.body.data.commonUpdateAdministrativeAreasLevel2[0].id,
        ).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
      });
  });
  ...
  test('/GraphQL commonDeleteAdministrativeAreaLevel2ById', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(
          res.body.data.commonDeleteAdministrativeAreaLevel2ById.id,
        ).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
      });
  });
