...
describe('attachment-library', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [CommonMockAttachmentLibrarySeeder],
    })
    ...
    attachmentLibrarySeeder = module.get<CommonMockAttachmentLibrarySeeder>(
      CommonMockAttachmentLibrarySeeder,
    );

    // seed mock data in memory database
    await attachmentLibraryRepository.insert(
      attachmentLibrarySeeder.collectionSource,
    );
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryId must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryOriginFilename property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryOriginFilename must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryFilename property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryFilename must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryMimetype property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryMimetype must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryExtension property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryExtension must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryRelativePathSegments property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryRelativePathSegments must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryWidth property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryWidth must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryHeight property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryHeight must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibrarySize property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibrarySize must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryUrl property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryUrl must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryId property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryId must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryOriginFilename property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryOriginFilename must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryFilename property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryFilename must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryMimetype property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryMimetype must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryExtension property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryExtension must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryRelativePathSegments property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryRelativePathSegments must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryWidth property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryWidth must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryHeight property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryHeight must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibrarySize property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibrarySize must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryUrl property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryUrl must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryOriginFilename is too large, has a maximum length of 255', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryOriginFilename is too large, has a maximum length of 255',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryMimetype is too large, has a maximum length of 63', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryMimetype is too large, has a maximum length of 63',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryExtension is too large, has a maximum length of 10', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryExtension is too large, has a maximum length of 10',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryUrl is too large, has a maximum length of 2047', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryUrl is too large, has a maximum length of 2047',
        );
      });
  });
  ...
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryWidth has to be a integer value', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryWidth has to be a integer value',
        );
      });
  });
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibraryHeight has to be a integer value', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibraryHeight has to be a integer value',
        );
      });
  });
  test('/REST:POST common/attachment-library/create - Got 400 Conflict, AttachmentLibrarySize has to be a integer value', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for CommonAttachmentLibrarySize has to be a integer value',
        );
      });
  });
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body).toEqual({
          ...
          rows: attachmentLibrarySeeder.collectionResponse
            .map((item) =>
  ...
  test('/REST:POST common/attachment-libraries/get', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body).toEqual(
          attachmentLibrarySeeder.collectionResponse.map((item) =>
            expect.objectContaining(
              _.omit(item, ['createdAt', 'updatedAt', 'deletedAt']),
            ),
          ),
  ...
  test('/REST:POST common/attachment-library/find/{id} - Got 404 Not Found', () => {
    return request(app.getHttpServer())
      .post(
        '/common/attachment-library/find/12429b2e-93ec-5c89-a897-eb9b4f414514',
      )
      .set('Accept', 'application/json')
      .expect(404);
  });
  ...
  test('/REST:POST common/attachment-library/find/{id}', () => {
    return request(app.getHttpServer())
      .post(
        '/common/attachment-library/find/5b19d6ac-4081-573b-96b3-56964d5326a8',
      )
      .set('Accept', 'application/json')
      .expect(200)
      .then((res) => {
  ...
  test('/REST:DELETE common/attachment-library/delete/{id} - Got 404 Not Found', () => {
    return request(app.getHttpServer())
      .delete(
        '/common/attachment-library/delete/bf8e5e68-a22c-5123-b82c-afc1943be6c4',
      )
      .set('Accept', 'application/json')
      .expect(404);
  });
  ...
  test('/REST:DELETE common/attachment-library/delete/{id}', () => {
    return request(app.getHttpServer())
      .delete(
        '/common/attachment-library/delete/5b19d6ac-4081-573b-96b3-56964d5326a8',
      )
      .set('Accept', 'application/json')
      .expect(200);
  });
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        for (const [
          index,
          value,
        ] of res.body.data.commonGetAttachmentLibraries.entries()) {
          expect(attachmentLibrarySeeder.collectionResponse[index]).toEqual(
            expect.objectContaining(
  ...
  test('/GraphQL commonCreateAttachmentLibrary', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.commonCreateAttachmentLibrary).toHaveProperty(
          'id',
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  ...
  test('/GraphQL commonFindAttachmentLibrary', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.commonFindAttachmentLibrary.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL commonFindAttachmentLibraryById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.commonFindAttachmentLibraryById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL commonUpdateAttachmentLibraryById', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(
          res.body.data.commonUpdateAttachmentLibraryById.id,
  ...
  test('/GraphQL commonUpdateAttachmentLibraries', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(
          res.body.data.commonUpdateAttachmentLibraries[0].id,
        ).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
      });
  });
  ...
  test('/GraphQL commonDeleteAttachmentLibraryById', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(
          res.body.data.commonDeleteAttachmentLibraryById.id,
        ).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
      });
  });
