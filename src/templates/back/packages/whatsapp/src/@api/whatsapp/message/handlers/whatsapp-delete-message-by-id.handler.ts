...
import { WhatsappDeleteMessageByIdCommand, WhatsappFindMessageByIdQuery } from '@app/whatsapp/message';
...
export class WhatsappDeleteMessageByIdHandler
{
    ...
    ): Promise<WhatsappMessage | WhatsappMessageDto>
    {
        ...
        await this.commandBus.dispatch(new WhatsappDeleteMessageByIdCommand(
            id,
            constraint,
            {
                timezone,
