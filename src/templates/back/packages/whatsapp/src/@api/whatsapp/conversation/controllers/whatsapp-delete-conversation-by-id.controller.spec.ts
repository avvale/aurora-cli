...
import { WhatsappDeleteConversationByIdController, WhatsappDeleteConversationByIdHandler } from '@api/whatsapp/conversation';
...
describe('WhatsappDeleteConversationByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<WhatsappDeleteConversationByIdController>(WhatsappDeleteConversationByIdController);
        handler = module.get<WhatsappDeleteConversationByIdHandler>(WhatsappDeleteConversationByIdHandler);
    });
    ...
    describe('main', () =>
    {
        ...
        test('should return an conversation deleted', async () =>
        {
            ...
            expect(await controller.main(whatsappMockConversationData[0].id)).toBe(whatsappMockConversationData[0]);
        });
    });
});
