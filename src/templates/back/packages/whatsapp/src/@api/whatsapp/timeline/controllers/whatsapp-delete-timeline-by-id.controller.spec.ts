...
import { WhatsappDeleteTimelineByIdController, WhatsappDeleteTimelineByIdHandler } from '@api/whatsapp/timeline';
...
describe('WhatsappDeleteTimelineByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<WhatsappDeleteTimelineByIdController>(WhatsappDeleteTimelineByIdController);
    ...
    describe('main', () =>
    {
        ...
        test('should return an timeline deleted', async () =>
        {
            ...
            expect(await controller.main(whatsappMockTimelineData[0].id)).toBe(whatsappMockTimelineData[0]);
        });
    });
});
