...
import { WhatsappDeleteTimelinesHandler, WhatsappDeleteTimelinesResolver } from '@api/whatsapp/timeline';
...
describe('WhatsappDeleteTimelinesResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<WhatsappDeleteTimelinesResolver>(WhatsappDeleteTimelinesResolver);
