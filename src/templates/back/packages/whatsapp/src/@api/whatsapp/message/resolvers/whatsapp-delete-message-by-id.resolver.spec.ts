...
import { WhatsappDeleteMessageByIdHandler, WhatsappDeleteMessageByIdResolver } from '@api/whatsapp/message';
...
describe('WhatsappDeleteMessageByIdResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<WhatsappDeleteMessageByIdResolver>(WhatsappDeleteMessageByIdResolver);
