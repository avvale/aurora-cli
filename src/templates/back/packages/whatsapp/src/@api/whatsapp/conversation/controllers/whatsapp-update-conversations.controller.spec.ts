import { WhatsappUpdateConversationsController, WhatsappUpdateConversationsHandler } from '@api/whatsapp/conversation';
...
describe('WhatsappUpdateConversationsController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<WhatsappUpdateConversationsController>(WhatsappUpdateConversationsController);
