import { WhatsappFindTimelineByIdController, WhatsappFindTimelineByIdHandler } from '@api/whatsapp/timeline';
...
describe('WhatsappFindTimelineByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<WhatsappFindTimelineByIdController>(WhatsappFindTimelineByIdController);
