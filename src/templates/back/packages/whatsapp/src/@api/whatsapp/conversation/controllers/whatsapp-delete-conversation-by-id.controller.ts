...
import { WhatsappConversationDto, WhatsappDeleteConversationByIdHandler } from '@api/whatsapp/conversation';
...
export class WhatsappDeleteConversationByIdController
{
    ...
    @ApiOkResponse({ description: 'The record has been deleted successfully.', type: WhatsappConversationDto })
    async main(
        @Param('id') id: string,
