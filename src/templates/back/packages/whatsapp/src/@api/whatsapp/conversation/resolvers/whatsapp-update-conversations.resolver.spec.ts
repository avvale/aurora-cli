...
import { WhatsappUpdateConversationsHandler, WhatsappUpdateConversationsResolver } from '@api/whatsapp/conversation';
...
describe('WhatsappUpdateConversationsResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<WhatsappUpdateConversationsResolver>(WhatsappUpdateConversationsResolver);
    ...
    describe('main', () =>
    {
        ...
        test('should return a conversations updated', async () =>
        {
            ...
            expect(await resolver.main(<WhatsappUpdateConversationsInput>whatsappMockConversationData[0])).toBe(whatsappMockConversationData[0]);
        });
    });
});
