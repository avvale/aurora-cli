...
import { WhatsappUpdateTimelineByIdHandler, WhatsappUpdateTimelineByIdResolver } from '@api/whatsapp/timeline';
...
describe('WhatsappUpdateTimelineByIdResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<WhatsappUpdateTimelineByIdResolver>(WhatsappUpdateTimelineByIdResolver);
    ...
    describe('main', () =>
    {
        ...
        test('should return a timeline by id updated', async () =>
        {
            ...
            expect(await resolver.main(<WhatsappUpdateTimelineByIdInput>whatsappMockTimelineData[0])).toBe(whatsappMockTimelineData[0]);
        });
    });
});
