import { WhatsappGetMessagesController, WhatsappGetMessagesHandler } from '@api/whatsapp/message';
...
describe('WhatsappGetMessagesController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<WhatsappGetMessagesController>(WhatsappGetMessagesController);
