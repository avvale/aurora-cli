...
import { WhatsappDeleteMessagesHandler, WhatsappDeleteMessagesResolver } from '@api/whatsapp/message';
...
describe('WhatsappDeleteMessagesResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<WhatsappDeleteMessagesResolver>(WhatsappDeleteMessagesResolver);
