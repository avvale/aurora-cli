import { WhatsappUpdateMessagesController, WhatsappUpdateMessagesHandler } from '@api/whatsapp/message';
...
describe('WhatsappUpdateMessagesController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<WhatsappUpdateMessagesController>(WhatsappUpdateMessagesController);
