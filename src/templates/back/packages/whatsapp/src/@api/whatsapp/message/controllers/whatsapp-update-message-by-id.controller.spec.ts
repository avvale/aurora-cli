...
describe('WhatsappUpdateMessageByIdController', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      imports: [],
      controllers: [WhatsappUpdateMessageByIdController],
      providers: [
        {
    ...
    controller = module.get<WhatsappUpdateMessageByIdController>(
      WhatsappUpdateMessageByIdController,
    );
    handler = module.get<WhatsappUpdateMessageByIdHandler>(
      WhatsappUpdateMessageByIdHandler,
    );
  });
