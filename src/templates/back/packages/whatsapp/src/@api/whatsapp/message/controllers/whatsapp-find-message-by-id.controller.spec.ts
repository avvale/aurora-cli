import { WhatsappFindMessageByIdController, WhatsappFindMessageByIdHandler } from '@api/whatsapp/message';
...
describe('WhatsappFindMessageByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<WhatsappFindMessageByIdController>(WhatsappFindMessageByIdController);
