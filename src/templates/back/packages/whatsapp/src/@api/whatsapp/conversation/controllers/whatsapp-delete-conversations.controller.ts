...
import { WhatsappConversationDto, WhatsappDeleteConversationsHandler } from '@api/whatsapp/conversation';
...
export class WhatsappDeleteConversationsController
{
    ...
    @ApiOkResponse({ description: 'The records has been deleted successfully.', type: [WhatsappConversationDto]})
