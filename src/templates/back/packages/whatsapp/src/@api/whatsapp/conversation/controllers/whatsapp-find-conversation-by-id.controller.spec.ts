import { WhatsappFindConversationByIdController, WhatsappFindConversationByIdHandler } from '@api/whatsapp/conversation';
...
describe('WhatsappFindConversationByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<WhatsappFindConversationByIdController>(WhatsappFindConversationByIdController);
