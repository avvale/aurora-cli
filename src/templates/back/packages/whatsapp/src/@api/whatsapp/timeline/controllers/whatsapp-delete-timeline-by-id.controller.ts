...
import { WhatsappDeleteTimelineByIdHandler, WhatsappTimelineDto } from '@api/whatsapp/timeline';
...
export class WhatsappDeleteTimelineByIdController
{
    ...
    @ApiOkResponse({ description: 'The record has been deleted successfully.', type: WhatsappTimelineDto })
    async main(
        @Param('id') id: string,
