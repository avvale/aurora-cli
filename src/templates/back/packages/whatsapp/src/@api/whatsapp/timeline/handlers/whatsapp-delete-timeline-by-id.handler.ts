...
import { WhatsappDeleteTimelineByIdCommand, WhatsappFindTimelineByIdQuery } from '@app/whatsapp/timeline';
...
export class WhatsappDeleteTimelineByIdHandler
{
    ...
    ): Promise<WhatsappTimeline | WhatsappTimelineDto>
    {
        ...
        await this.commandBus.dispatch(new WhatsappDeleteTimelineByIdCommand(
            id,
            constraint,
            {
                timezone,
