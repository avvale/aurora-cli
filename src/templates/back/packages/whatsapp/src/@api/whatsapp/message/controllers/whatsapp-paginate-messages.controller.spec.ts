...
describe('WhatsappPaginateMessagesController', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      imports: [],
      controllers: [WhatsappPaginateMessagesController],
      providers: [
        {
    ...
    controller = module.get<WhatsappPaginateMessagesController>(
      WhatsappPaginateMessagesController,
    );
    handler = module.get<WhatsappPaginateMessagesHandler>(
      WhatsappPaginateMessagesHandler,
    );
  });
