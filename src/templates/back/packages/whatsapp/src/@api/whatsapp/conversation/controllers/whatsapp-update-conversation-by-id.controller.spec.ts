import { WhatsappUpdateConversationByIdController, WhatsappUpdateConversationByIdHandler } from '@api/whatsapp/conversation';
...
describe('WhatsappUpdateConversationByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<WhatsappUpdateConversationByIdController>(WhatsappUpdateConversationByIdController);
