...
import { WhatsappDeleteConversationByIdHandler, WhatsappDeleteConversationByIdResolver } from '@api/whatsapp/conversation';
...
describe('WhatsappDeleteConversationByIdResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<WhatsappDeleteConversationByIdResolver>(WhatsappDeleteConversationByIdResolver);
