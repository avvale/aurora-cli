...
import { WhatsappFindTimelineHandler, WhatsappFindTimelineResolver } from '@api/whatsapp/timeline';
...
describe('WhatsappFindTimelineResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<WhatsappFindTimelineResolver>(WhatsappFindTimelineResolver);
