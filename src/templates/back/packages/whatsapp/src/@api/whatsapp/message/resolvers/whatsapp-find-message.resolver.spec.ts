...
import { WhatsappFindMessageHandler, WhatsappFindMessageResolver } from '@api/whatsapp/message';
...
describe('WhatsappFindMessageResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<WhatsappFindMessageResolver>(WhatsappFindMessageResolver);
