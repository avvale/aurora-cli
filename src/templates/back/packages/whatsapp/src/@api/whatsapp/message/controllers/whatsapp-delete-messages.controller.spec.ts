import { WhatsappDeleteMessagesController, WhatsappDeleteMessagesHandler } from '@api/whatsapp/message';
...
describe('WhatsappDeleteMessagesController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<WhatsappDeleteMessagesController>(WhatsappDeleteMessagesController);
