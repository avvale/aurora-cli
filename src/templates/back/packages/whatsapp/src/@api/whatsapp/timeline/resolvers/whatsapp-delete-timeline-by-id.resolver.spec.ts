...
import { WhatsappDeleteTimelineByIdHandler, WhatsappDeleteTimelineByIdResolver } from '@api/whatsapp/timeline';
...
describe('WhatsappDeleteTimelineByIdResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<WhatsappDeleteTimelineByIdResolver>(WhatsappDeleteTimelineByIdResolver);
