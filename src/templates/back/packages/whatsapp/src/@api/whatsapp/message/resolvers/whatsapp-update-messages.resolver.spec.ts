...
import { WhatsappUpdateMessagesHandler, WhatsappUpdateMessagesResolver } from '@api/whatsapp/message';
...
describe('WhatsappUpdateMessagesResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<WhatsappUpdateMessagesResolver>(WhatsappUpdateMessagesResolver);
    ...
    describe('main', () =>
    {
        ...
        test('should return a messages updated', async () =>
        {
            ...
            expect(await resolver.main(<WhatsappUpdateMessagesInput>whatsappMockMessageData[0])).toBe(whatsappMockMessageData[0]);
        });
    });
});
