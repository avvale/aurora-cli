import { WhatsappDeleteTimelinesController, WhatsappDeleteTimelinesHandler } from '@api/whatsapp/timeline';
...
describe('WhatsappDeleteTimelinesController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<WhatsappDeleteTimelinesController>(WhatsappDeleteTimelinesController);
        handler = module.get<WhatsappDeleteTimelinesHandler>(WhatsappDeleteTimelinesHandler);
    });
