import { WhatsappFindConversationController, WhatsappFindConversationHandler } from '@api/whatsapp/conversation';
...
describe('WhatsappFindConversationController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<WhatsappFindConversationController>(WhatsappFindConversationController);
