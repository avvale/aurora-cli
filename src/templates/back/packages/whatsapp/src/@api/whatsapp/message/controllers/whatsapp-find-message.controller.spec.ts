import { WhatsappFindMessageController, WhatsappFindMessageHandler } from '@api/whatsapp/message';
...
describe('WhatsappFindMessageController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<WhatsappFindMessageController>(WhatsappFindMessageController);
