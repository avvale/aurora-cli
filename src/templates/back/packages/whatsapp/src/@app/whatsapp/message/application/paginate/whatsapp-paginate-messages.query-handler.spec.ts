import { WhatsappIMessageRepository, WhatsappMockMessageRepository, WhatsappPaginateMessagesQuery } from '@app/whatsapp/message';
...
describe('WhatsappPaginateMessagesQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<WhatsappPaginateMessagesQueryHandler>(WhatsappPaginateMessagesQueryHandler);
        service = module.get<WhatsappPaginateMessagesService>(WhatsappPaginateMessagesService);
