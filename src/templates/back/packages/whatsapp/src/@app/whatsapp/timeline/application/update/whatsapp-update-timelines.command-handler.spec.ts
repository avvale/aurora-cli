import { whatsappMockTimelineData, WhatsappUpdateTimelinesCommand } from '@app/whatsapp/timeline';
...
describe('WhatsappUpdateTimelinesCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<WhatsappUpdateTimelinesCommandHandler>(WhatsappUpdateTimelinesCommandHandler);
    });
