...
export class WhatsappCreateTimelinesService
{
    ...
    ): Promise<void>
    {
        ...
        const aggregateTimelines = payload.map(timeline => WhatsappTimeline.register(
            timeline.id,
            timeline.accounts,
        ...
        const timelinesRegistered = this.publisher.mergeObjectContext(new WhatsappAddTimelinesContextEvent(aggregateTimelines));
