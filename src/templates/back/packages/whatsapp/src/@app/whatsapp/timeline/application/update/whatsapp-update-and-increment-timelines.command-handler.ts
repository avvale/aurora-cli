...
export class WhatsappUpdateAndIncrementTimelinesCommandHandler
  implements ICommandHandler<WhatsappUpdateAndIncrementTimelinesCommand>
{
  constructor(
  ...
  async execute(
    command: WhatsappUpdateAndIncrementTimelinesCommand,
  ): Promise<void> {
