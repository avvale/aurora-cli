...
export class WhatsappFindConversationQueryHandler
  implements IQueryHandler<WhatsappFindConversationQuery>
{
  ...
  async execute(
    query: WhatsappFindConversationQuery,
