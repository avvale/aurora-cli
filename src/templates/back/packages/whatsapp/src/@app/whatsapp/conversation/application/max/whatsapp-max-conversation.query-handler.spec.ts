import { WhatsappIConversationRepository, WhatsappMaxConversationQuery, WhatsappMockConversationRepository } from '@app/whatsapp/conversation';
...
describe('WhatsappMaxConversationQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<WhatsappMaxConversationQueryHandler>(WhatsappMaxConversationQueryHandler);
        service = module.get<WhatsappMaxConversationService>(WhatsappMaxConversationService);
    ...
    describe('main', () =>
    {
        ...
        test('should max inboxes', async () =>
        {
            ...
            expect(await queryHandler.execute(
                new WhatsappMaxConversationQuery('id'),
