...
export class WhatsappCreateTimelinesCommandHandler implements ICommandHandler<WhatsappCreateTimelinesCommand>
{
    constructor(
            ...
            command.payload
                .map(timeline =>
                {
                    return {
                        ...
                        wabaPhoneNumberId: new WhatsappTimelineWabaPhoneNumberId(timeline.wabaPhoneNumberId),
                        wabaContactId: new WhatsappTimelineWabaContactId(timeline.wabaContactId),
                    };
                }),
            command.cQMetadata,
        );
