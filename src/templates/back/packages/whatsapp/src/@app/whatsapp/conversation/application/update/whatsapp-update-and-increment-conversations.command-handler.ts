...
export class WhatsappUpdateAndIncrementConversationsCommandHandler
  implements ICommandHandler<WhatsappUpdateAndIncrementConversationsCommand>
{
  constructor(
  ...
  async execute(
    command: WhatsappUpdateAndIncrementConversationsCommand,
  ): Promise<void> {
