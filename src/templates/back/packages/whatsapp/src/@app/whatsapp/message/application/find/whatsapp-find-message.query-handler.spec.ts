import { WhatsappFindMessageQuery, WhatsappIMessageRepository, WhatsappMessageMapper, WhatsappMockMessageRepository } from '@app/whatsapp/message';
...
describe('WhatsappFindMessageQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<WhatsappFindMessageQueryHandler>(WhatsappFindMessageQueryHandler);
        service = module.get<WhatsappFindMessageService>(WhatsappFindMessageService);
