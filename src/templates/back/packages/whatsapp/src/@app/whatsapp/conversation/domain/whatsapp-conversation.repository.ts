...
export abstract class WhatsappIConversationRepository implements IRepository<WhatsappConversation>
{
    ...
    abstract create(
        ...
        options?: {
            ...
            finderQueryStatement?: (aggregate: WhatsappConversation) => QueryStatement;
        }
    ): Promise<void>;
