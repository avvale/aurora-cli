import {
  WhatsappCreatedMessageEvent,
  WhatsappCreatedMessagesEvent,
  WhatsappDeletedMessageEvent,
  WhatsappDeletedMessagesEvent,
  WhatsappMessage,
  WhatsappUpdatedAndIncrementedMessageEvent,
  WhatsappUpdatedAndIncrementedMessagesEvent,
  WhatsappUpdatedMessageEvent,
  WhatsappUpdatedMessagesEvent,
} from '@app/whatsapp/message';
import { AggregateRoot } from '@nestjs/cqrs';

export class WhatsappAddMessagesContextEvent extends AggregateRoot {
  constructor(public readonly aggregateRoots: WhatsappMessage[] = []) {
    super();
  }
