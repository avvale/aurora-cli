import { WhatsappCreateTimelinesCommand, whatsappMockTimelineData } from '@app/whatsapp/timeline';
...
describe('whatsappCreateTimelinesCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<WhatsappCreateTimelinesCommandHandler>(WhatsappCreateTimelinesCommandHandler);
    });
    ...
    describe('main', () =>
    {
        ...
        test('should return WhatsappMockTimelineData created', async () =>
        {
            expect(await commandHandler.execute(
                new WhatsappCreateTimelinesCommand(
