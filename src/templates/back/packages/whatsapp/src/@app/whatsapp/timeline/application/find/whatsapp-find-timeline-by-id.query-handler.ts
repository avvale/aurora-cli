import { WhatsappFindTimelineByIdQuery, WhatsappTimelineMapper, WhatsappTimelineResponse } from '@app/whatsapp/timeline';
...
export class WhatsappFindTimelineByIdQueryHandler implements IQueryHandler<WhatsappFindTimelineByIdQuery>
{
    ...
    async execute(query: WhatsappFindTimelineByIdQuery): Promise<WhatsappTimelineResponse>
    {
