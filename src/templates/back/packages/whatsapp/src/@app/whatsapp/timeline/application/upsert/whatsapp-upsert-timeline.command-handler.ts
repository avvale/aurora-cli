...
export class WhatsappUpsertTimelineCommandHandler implements ICommandHandler<WhatsappUpsertTimelineCommand>
{
    constructor(
        ...
        await this.upsertTimelineService.main(
            {
                ...
                wabaPhoneNumberId: new WhatsappTimelineWabaPhoneNumberId(command.payload.wabaPhoneNumberId),
                wabaContactId: new WhatsappTimelineWabaContactId(command.payload.wabaContactId),
            },
            command.cQMetadata,
        );
    }
