import { WhatsappIMessageRepository, WhatsappMessageMapper, WhatsappMockMessageRepository, WhatsappRawSQLMessagesQuery } from '@app/whatsapp/message';
...
describe('RawSQLMessagesQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<WhatsappRawSQLMessagesQueryHandler>(WhatsappRawSQLMessagesQueryHandler);
        service = module.get<WhatsappRawSQLMessagesService>(WhatsappRawSQLMessagesService);
    ...
    describe('main', () =>
    {
        ...
        test('should return an messages founded', async () =>
        {
            ...
            expect(await queryHandler.execute(
                new WhatsappRawSQLMessagesQuery(),
