import { WhatsappFindTimelineByIdQuery, WhatsappITimelineRepository, whatsappMockTimelineData, WhatsappMockTimelineRepository, WhatsappTimelineMapper } from '@app/whatsapp/timeline';
...
describe('WhatsappFindTimelineByIdQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<WhatsappFindTimelineByIdQueryHandler>(WhatsappFindTimelineByIdQueryHandler);
        service = module.get<WhatsappFindTimelineByIdService>(WhatsappFindTimelineByIdService);
    ...
    describe('main', () =>
    {
        ...
        test('should return an timeline founded', async () =>
        {
            ...
            expect(await queryHandler.execute(
                new WhatsappFindTimelineByIdQuery(
