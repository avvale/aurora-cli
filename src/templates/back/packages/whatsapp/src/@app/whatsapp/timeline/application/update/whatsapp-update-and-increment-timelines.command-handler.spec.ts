import { whatsappMockTimelineData, WhatsappUpdateAndIncrementTimelinesCommand } from '@app/whatsapp/timeline';
...
describe('WhatsappUpdateAndIncrementTimelinesCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<WhatsappUpdateAndIncrementTimelinesCommandHandler>(WhatsappUpdateAndIncrementTimelinesCommandHandler);
    });
