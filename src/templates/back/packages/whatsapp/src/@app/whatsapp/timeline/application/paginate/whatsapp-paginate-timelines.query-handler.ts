...
export class WhatsappPaginateTimelinesQueryHandler implements IQueryHandler<WhatsappPaginateTimelinesQuery>
{
    constructor(
        private readonly paginateTimelinesService: WhatsappPaginateTimelinesService,
    ) {}

    async execute(query: WhatsappPaginateTimelinesQuery): Promise<PaginationResponse>
    {
