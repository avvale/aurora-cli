import { WhatsappConversationMapper, WhatsappGetConversationsQuery, WhatsappIConversationRepository, WhatsappMockConversationRepository } from '@app/whatsapp/conversation';
...
describe('GetConversationsQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<WhatsappGetConversationsQueryHandler>(WhatsappGetConversationsQueryHandler);
        service = module.get<WhatsappGetConversationsService>(WhatsappGetConversationsService);
