import { WhatsappDeleteTimelineByIdCommand, whatsappMockTimelineData } from '@app/whatsapp/timeline';
...
describe('WhatsappDeleteTimelineByIdCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<WhatsappDeleteTimelineByIdCommandHandler>(WhatsappDeleteTimelineByIdCommandHandler);
    });
    ...
    describe('main', () =>
    {
        ...
        test('should create the value object id and pass them as parameters to the WhatsappDeleteTimelineByIdService', async () =>
        {
            expect(await commandHandler.execute(
                new WhatsappDeleteTimelineByIdCommand(
