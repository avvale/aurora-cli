...
export class WhatsappPaginateConversationsQueryHandler
  implements IQueryHandler<WhatsappPaginateConversationsQuery>
{
  constructor(
  ...
  async execute(
    query: WhatsappPaginateConversationsQuery,
