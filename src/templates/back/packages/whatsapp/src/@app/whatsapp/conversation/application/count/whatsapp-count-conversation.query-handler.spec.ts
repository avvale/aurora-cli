import { WhatsappCountConversationQuery, WhatsappIConversationRepository, WhatsappMockConversationRepository } from '@app/whatsapp/conversation';
...
describe('WhatsappCountConversationQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<WhatsappCountConversationQueryHandler>(WhatsappCountConversationQueryHandler);
        service = module.get<WhatsappCountConversationService>(WhatsappCountConversationService);
    ...
    describe('main', () =>
    {
        ...
        test('should count total inboxes', async () =>
        {
            ...
            expect(await queryHandler.execute(
                new WhatsappCountConversationQuery(),
