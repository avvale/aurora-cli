import { WhatsappCountTimelineQuery, WhatsappITimelineRepository, WhatsappMockTimelineRepository } from '@app/whatsapp/timeline';
...
describe('WhatsappCountTimelineQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<WhatsappCountTimelineQueryHandler>(WhatsappCountTimelineQueryHandler);
        service = module.get<WhatsappCountTimelineService>(WhatsappCountTimelineService);
    ...
    describe('main', () =>
    {
        ...
        test('should count total inboxes', async () =>
        {
            ...
            expect(await queryHandler.execute(
                new WhatsappCountTimelineQuery(),
