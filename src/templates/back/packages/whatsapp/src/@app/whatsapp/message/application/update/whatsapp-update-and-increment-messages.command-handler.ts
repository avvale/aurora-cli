...
export class WhatsappUpdateAndIncrementMessagesCommandHandler
  implements ICommandHandler<WhatsappUpdateAndIncrementMessagesCommand>
{
  constructor(
  ...
  async execute(
    command: WhatsappUpdateAndIncrementMessagesCommand,
  ): Promise<void> {
