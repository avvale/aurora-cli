...
export class WhatsappRawSQLMessagesQueryHandler
  implements IQueryHandler<WhatsappRawSQLMessagesQuery>
{
  ...
  async execute(
    query: WhatsappRawSQLMessagesQuery,
  ): Promise<WhatsappMessageResponse[]> {
    return this.mapper.mapAggregatesToResponses(
      await this.rawSQLMessagesService.main(query.rawSQL, query.cQMetadata),
    );
  }
}
