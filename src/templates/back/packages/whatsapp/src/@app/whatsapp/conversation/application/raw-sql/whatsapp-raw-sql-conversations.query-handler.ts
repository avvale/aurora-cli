import {
  ...
  WhatsappRawSQLConversationsQuery,
...
export class WhatsappRawSQLConversationsQueryHandler
  implements IQueryHandler<WhatsappRawSQLConversationsQuery>
{
  ...
  async execute(
    query: WhatsappRawSQLConversationsQuery,
  ): Promise<WhatsappConversationResponse[]> {
    return this.mapper.mapAggregatesToResponses(
      await this.rawSQLConversationsService.main(
        query.rawSQL,
        query.cQMetadata,
      ),
    );
