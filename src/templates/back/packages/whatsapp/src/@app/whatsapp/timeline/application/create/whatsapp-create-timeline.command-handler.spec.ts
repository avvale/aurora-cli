...
import { WhatsappCreateTimelineCommand, whatsappMockTimelineData } from '@app/whatsapp/timeline';
...
describe('WhatsappCreateTimelineCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<WhatsappCreateTimelineCommandHandler>(WhatsappCreateTimelineCommandHandler);
    });
