import { WhatsappConversationMapper, WhatsappFindConversationByIdQuery, WhatsappIConversationRepository, whatsappMockConversationData, WhatsappMockConversationRepository } from '@app/whatsapp/conversation';
...
describe('WhatsappFindConversationByIdQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<WhatsappFindConversationByIdQueryHandler>(WhatsappFindConversationByIdQueryHandler);
        service = module.get<WhatsappFindConversationByIdService>(WhatsappFindConversationByIdService);
