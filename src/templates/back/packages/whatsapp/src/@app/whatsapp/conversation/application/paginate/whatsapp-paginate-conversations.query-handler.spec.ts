import { WhatsappIConversationRepository, WhatsappMockConversationRepository, WhatsappPaginateConversationsQuery } from '@app/whatsapp/conversation';
...
describe('WhatsappPaginateConversationsQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<WhatsappPaginateConversationsQueryHandler>(WhatsappPaginateConversationsQueryHandler);
        service = module.get<WhatsappPaginateConversationsService>(WhatsappPaginateConversationsService);
