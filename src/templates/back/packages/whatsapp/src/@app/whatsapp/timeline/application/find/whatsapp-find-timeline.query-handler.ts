...
export class WhatsappFindTimelineQueryHandler
  implements IQueryHandler<WhatsappFindTimelineQuery>
{
  ...
  async execute(
    query: WhatsappFindTimelineQuery,
