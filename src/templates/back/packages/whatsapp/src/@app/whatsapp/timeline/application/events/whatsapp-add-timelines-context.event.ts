import { WhatsappCreatedTimelineEvent, WhatsappCreatedTimelinesEvent, WhatsappDeletedTimelineEvent, WhatsappDeletedTimelinesEvent, WhatsappTimeline, WhatsappUpdatedAndIncrementedTimelineEvent, WhatsappUpdatedAndIncrementedTimelinesEvent, WhatsappUpdatedTimelineEvent, WhatsappUpdatedTimelinesEvent } from '@app/whatsapp/timeline';
import { AggregateRoot } from '@nestjs/cqrs';

export class WhatsappAddTimelinesContextEvent extends AggregateRoot
{
    constructor(
        public readonly aggregateRoots: WhatsappTimeline[] = [],
    )
    {
        super();
    }
    ...
    created(): void
    {
        this.apply(
            new WhatsappCreatedTimelinesEvent(
                this.aggregateRoots.map(timeline =>
