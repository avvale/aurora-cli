...
@Injectable()
export class WhatsappMockTimelineRepository
  extends MockRepository<WhatsappTimeline>
  implements WhatsappITimelineRepository
{
    ...
    for (const itemCollection of <any[]>whatsappMockTimelineData) {
      ...
      this.collectionSource.push(
        WhatsappTimeline.register(
          ...
          new WhatsappTimelineWabaPhoneNumberId(
            itemCollection.wabaPhoneNumberId,
          ),
