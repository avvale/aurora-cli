import { WhatsappConversationMapper, WhatsappConversationResponse, WhatsappFindConversationByIdQuery } from '@app/whatsapp/conversation';
...
export class WhatsappFindConversationByIdQueryHandler implements IQueryHandler<WhatsappFindConversationByIdQuery>
{
    ...
    async execute(query: WhatsappFindConversationByIdQuery): Promise<WhatsappConversationResponse>
    {
