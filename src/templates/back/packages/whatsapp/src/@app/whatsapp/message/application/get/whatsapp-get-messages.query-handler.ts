import { WhatsappGetMessagesQuery, WhatsappMessageMapper, WhatsappMessageResponse } from '@app/whatsapp/message';
...
export class WhatsappGetMessagesQueryHandler implements IQueryHandler<WhatsappGetMessagesQuery>
{
    ...
    async execute(query: WhatsappGetMessagesQuery): Promise<WhatsappMessageResponse[]>
    {
