...
export class WhatsappMaxMessageQueryHandler implements IQueryHandler<WhatsappMaxMessageQuery>
{
    constructor(
        private readonly maxMessageService: WhatsappMaxMessageService,
    ) {}
