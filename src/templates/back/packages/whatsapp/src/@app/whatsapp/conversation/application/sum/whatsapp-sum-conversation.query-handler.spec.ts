import { WhatsappIConversationRepository, WhatsappMockConversationRepository, WhatsappSumConversationQuery } from '@app/whatsapp/conversation';
...
describe('WhatsappSumConversationQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<WhatsappSumConversationQueryHandler>(WhatsappSumConversationQueryHandler);
        service = module.get<WhatsappSumConversationService>(WhatsappSumConversationService);
    ...
    describe('main', () =>
    {
        ...
        test('should sum inboxes', async () =>
        {
            ...
            expect(await queryHandler.execute(
                new WhatsappSumConversationQuery('id'),
