import { WhatsappGetMessagesQuery, WhatsappIMessageRepository, WhatsappMessageMapper, WhatsappMockMessageRepository } from '@app/whatsapp/message';
...
describe('GetMessagesQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<WhatsappGetMessagesQueryHandler>(WhatsappGetMessagesQueryHandler);
        service = module.get<WhatsappGetMessagesService>(WhatsappGetMessagesService);
