...
describe('message', () => {
  ...
  beforeAll(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [WhatsappMockMessageSeeder],
    })
    ...
    messageRepository = module.get<WhatsappIMessageRepository>(
      WhatsappIMessageRepository,
    );
    messageSeeder = module.get<WhatsappMockMessageSeeder>(
      WhatsappMockMessageSeeder,
    );
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageId must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageWabaMessageId property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageWabaMessageId must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageTimelineId property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageTimelineId must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageStatuses property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageStatuses must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageDirection property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageDirection must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageWabaContactId property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageWabaContactId must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageType property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageType must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessagePayload property can not to be null', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessagePayload must be defined, can not be null',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageId property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageId must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageWabaMessageId property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageWabaMessageId must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageTimelineId property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageTimelineId must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageStatuses property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageStatuses must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageDirection property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageDirection must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageWabaContactId property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageWabaContactId must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageType property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageType must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessagePayload property can not to be undefined', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessagePayload must be defined, can not be undefined',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageId is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageId is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageTimelineId is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageTimelineId is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageConversationId is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageConversationId is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageAccountId is not allowed, must be a length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageAccountId is not allowed, must be a length of 36',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageWabaMessageId is too large, has a maximum length of 128', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageWabaMessageId is too large, has a maximum length of 128',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageWabaContactId is too large, has a maximum length of 36', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageWabaContactId is too large, has a maximum length of 36',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageContactName is too large, has a maximum length of 127', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageContactName is too large, has a maximum length of 127',
        );
      });
  });
  ...
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageDirection has to be a enum option of INPUT, OUTPUT', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageDirection has to be any of this options: INPUT, OUTPUT',
        );
      });
  });
  test('/REST:POST whatsapp/message/create - Got 400 Conflict, MessageType has to be a enum option of AUDIO, BUTTON, CONTACTS, DOCUMENT, IMAGE, INTERACTIVE, LOCATION, ORDER, REACTION, STICKER, SYSTEM, TEMPLATE, TEXT, UNKNOWN, VIDEO', () => {
    return request(app.getHttpServer())
      ...
      .then((res) => {
        expect(res.body.message).toContain(
          'Value for WhatsappMessageType has to be any of this options: AUDIO, BUTTON, CONTACTS, DOCUMENT, IMAGE, INTERACTIVE, LOCATION, ORDER, REACTION, STICKER, SYSTEM, TEMPLATE, TEXT, UNKNOWN, VIDEO',
        );
      });
  });
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        for (const [
          index,
          value,
        ] of res.body.data.whatsappGetMessages.entries()) {
  ...
  test('/GraphQL whatsappCreateMessage', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.whatsappCreateMessage).toHaveProperty(
          'id',
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  ...
  test('/GraphQL whatsappFindMessage', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.whatsappFindMessage.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL whatsappFindMessageById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.whatsappFindMessageById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL whatsappUpdateMessageById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.whatsappUpdateMessageById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL whatsappUpdateMessages', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.whatsappUpdateMessages[0].id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL whatsappDeleteMessageById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.whatsappDeleteMessageById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
