    ...
    for (const itemCollection of <any[]>supportMockIssueData) {
      ...
      this.collectionSource.push(
        SupportIssue.register(
          ...
          new SupportIssueFrontEnvironment(itemCollection.frontEnvironment),
          new SupportIssueFrontVersion(itemCollection.frontVersion),
          new SupportIssueBackEnvironment(itemCollection.backEnvironment),
          ...
          new SupportIssueScreenRecording(itemCollection.screenRecording),
