          ...
          new SupportCreateCommentCommand(
            {
              ...
              externalParentId: supportMockCommentData[0].externalParentId,
              issueId: supportMockCommentData[0].issueId,
              accountId: supportMockCommentData[0].accountId,
              accountUsername: supportMockCommentData[0].accountUsername,
              ...
              screenRecording: supportMockCommentData[0].screenRecording,
