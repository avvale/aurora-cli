...
describe('webhook-log', () => {
    ...
    test('/REST:POST tools/webhook-log/find/{id} - Got 404 Not Found', () => {
        return request(app.getHttpServer())
            .post(
                '/tools/webhook-log/find/3054e447-af13-5ddf-8ed9-b70e5f605203',
            )
            .set('Accept', 'application/json')
            .expect(404);
    });
    ...
    test('/REST:POST tools/webhook-log/find/{id}', () => {
        return request(app.getHttpServer())
            .post(
                '/tools/webhook-log/find/5b19d6ac-4081-573b-96b3-56964d5326a8',
            )
            .set('Accept', 'application/json')
            .expect(200)
            .then((res) => {
    ...
    test('/REST:DELETE tools/webhook-log/delete/{id} - Got 404 Not Found', () => {
        return request(app.getHttpServer())
            .delete(
                '/tools/webhook-log/delete/c35c7b15-e65d-5452-93c3-e5d0d026433a',
            )
            .set('Accept', 'application/json')
            .expect(404);
    });
    ...
    test('/REST:DELETE tools/webhook-log/delete/{id}', () => {
        return request(app.getHttpServer())
            .delete(
                '/tools/webhook-log/delete/5b19d6ac-4081-573b-96b3-56964d5326a8',
            )
            .set('Accept', 'application/json')
            .expect(200);
    });
    ...
    test('/GraphQL toolsUpdateWebhookLogById', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(
                    res.body.data.toolsUpdateWebhookLogById.id,
    ...
    test('/GraphQL toolsUpdateWebhookLogs', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(
                    res.body.data.toolsUpdateWebhookLogs[0].id,
                ).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
            });
    });
    ...
    test('/GraphQL toolsDeleteWebhookLogById', () => {
        return request(app.getHttpServer())
            ...
            .then((res) => {
                expect(
                    res.body.data.toolsDeleteWebhookLogById.id,
                ).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
            });
    });
