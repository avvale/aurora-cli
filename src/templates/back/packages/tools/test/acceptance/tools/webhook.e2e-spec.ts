...
describe('webhook', () => {
  ...
  beforeAll(async () => {
    ...
    webhookSeeder = module.get<ToolsMockWebhookSeeder>(ToolsMockWebhookSeeder);
  ...
  test('/REST:DELETE tools/webhook/delete/{id} - Got 404 Not Found', () => {
    return request(app.getHttpServer())
      .delete('/tools/webhook/delete/7765e755-3850-5098-97af-2abb76adc25b')
      .set('Accept', 'application/json')
      .expect(404);
  });
  ...
  test('/REST:DELETE tools/webhook/delete/{id}', () => {
    return request(app.getHttpServer())
      .delete('/tools/webhook/delete/5b19d6ac-4081-573b-96b3-56964d5326a8')
      .set('Accept', 'application/json')
      .expect(200);
  });
  ...
  test('/GraphQL toolsGetWebhooks', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        for (const [index, value] of res.body.data.toolsGetWebhooks.entries()) {
