...
describe('webhook-logger', () => {
  ...
  beforeAll(async () => {
    ...
    await webhookLoggerRepository.insert(webhookLoggerSeeder.collectionSource);
  ...
  test('/REST:POST tools/webhook-logger/find/{id} - Got 404 Not Found', () => {
    return request(app.getHttpServer())
      .post('/tools/webhook-logger/find/bae7e139-ec1e-5864-8e78-889613276c2b')
      .set('Accept', 'application/json')
      .expect(404);
  });
  ...
  test('/REST:POST tools/webhook-logger/find/{id}', () => {
    return request(app.getHttpServer())
      .post('/tools/webhook-logger/find/5b19d6ac-4081-573b-96b3-56964d5326a8')
      .set('Accept', 'application/json')
      .expect(200)
      .then((res) => {
        expect(res.body).toHaveProperty(
    ...
    return request(app.getHttpServer())
      ...
      .then((res) => {
        for (const [
          ...
          expect(webhookLoggerSeeder.collectionResponse[index]).toEqual(
            expect.objectContaining(
  ...
  test('/GraphQL toolsFindWebhookLoggerById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.toolsFindWebhookLoggerById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL toolsUpdateWebhookLoggerById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.toolsUpdateWebhookLoggerById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL toolsUpdateWebhookLoggers', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.toolsUpdateWebhookLoggers[0].id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
  ...
  test('/GraphQL toolsDeleteWebhookLoggerById', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.data.toolsDeleteWebhookLoggerById.id).toStrictEqual(
          '5b19d6ac-4081-573b-96b3-56964d5326a8',
        );
      });
  });
