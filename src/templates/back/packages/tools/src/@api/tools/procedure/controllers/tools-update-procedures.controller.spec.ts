import { ToolsUpdateProceduresController, ToolsUpdateProceduresHandler } from '@api/tools/procedure';
...
describe('ToolsUpdateProceduresController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<ToolsUpdateProceduresController>(ToolsUpdateProceduresController);
    ...
    describe('main', () =>
    {
        ...
        test('should return a procedures updated', async () =>
        {
            ...
            expect(await controller.main(toolsMockProcedureData[0])).toBe(toolsMockProcedureData[0]);
        });
    });
});
