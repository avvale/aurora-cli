...
import { ToolsGetMigrationsHandler, ToolsGetMigrationsResolver } from '@api/tools/migration';
...
describe('ToolsGetMigrationsResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<ToolsGetMigrationsResolver>(ToolsGetMigrationsResolver);
