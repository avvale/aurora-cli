...
import { ToolsFindKeyValueHandler, ToolsKeyValueDto } from '@api/tools/key-value';
...
export class ToolsFindKeyValueController
{
    ...
    @ApiOkResponse({ description: 'The record has been successfully created.', type: ToolsKeyValueDto })
