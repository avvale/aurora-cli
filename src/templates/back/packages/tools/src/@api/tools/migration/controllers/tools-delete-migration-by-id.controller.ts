...
import { ToolsDeleteMigrationByIdHandler, ToolsMigrationDto } from '@api/tools/migration';
...
export class ToolsDeleteMigrationByIdController
{
    ...
    @ApiOkResponse({ description: 'The record has been deleted successfully.', type: ToolsMigrationDto })
    async main(
        @Param('id') id: string,
