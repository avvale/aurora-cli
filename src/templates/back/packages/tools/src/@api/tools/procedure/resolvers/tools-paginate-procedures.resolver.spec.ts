...
import { ToolsPaginateProceduresHandler, ToolsPaginateProceduresResolver } from '@api/tools/procedure';
...
describe('ToolsPaginateProceduresResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<ToolsPaginateProceduresResolver>(ToolsPaginateProceduresResolver);
