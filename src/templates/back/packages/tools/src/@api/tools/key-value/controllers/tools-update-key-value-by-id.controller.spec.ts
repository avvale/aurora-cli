...
describe('ToolsUpdateKeyValueByIdController', () => {
    ...
    beforeAll(async () => {
        const module: TestingModule = await Test.createTestingModule({
            imports: [],
            controllers: [ToolsUpdateKeyValueByIdController],
            providers: [
                {
        ...
        controller = module.get<ToolsUpdateKeyValueByIdController>(
            ToolsUpdateKeyValueByIdController,
        );
    ...
    describe('main', () => {
        ...
        test('should return a keyValue updated', async () => {
            ...
            expect(await controller.main(toolsMockKeyValueData[0])).toBe(
