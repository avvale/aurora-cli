import { ToolsUpdateMigrationByIdController, ToolsUpdateMigrationByIdHandler } from '@api/tools/migration';
...
describe('ToolsUpdateMigrationByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<ToolsUpdateMigrationByIdController>(ToolsUpdateMigrationByIdController);
    ...
    describe('main', () =>
    {
        ...
        test('should return a migration updated', async () =>
        {
            ...
            expect(await controller.main(toolsMockMigrationData[0])).toBe(toolsMockMigrationData[0]);
        });
    });
});
