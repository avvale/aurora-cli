...
import { ToolsDeleteProcedureByIdCommand, ToolsFindProcedureByIdQuery } from '@app/tools/procedure';
...
export class ToolsDeleteProcedureByIdHandler
{
    ...
    ): Promise<ToolsProcedure | ToolsProcedureDto>
    {
        ...
        await this.commandBus.dispatch(new ToolsDeleteProcedureByIdCommand(
            id,
            constraint,
            {
                timezone,
