...
import { ToolsCreateProceduresHandler, ToolsCreateProceduresResolver } from '@api/tools/procedure';
...
describe('ToolsCreateProceduresResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<ToolsCreateProceduresResolver>(ToolsCreateProceduresResolver);
    });
    ...
    describe('main', () =>
    {
        ...
        {
            expect(await resolver.main(<ToolsCreateProcedureInput[]>toolsMockProcedureData)).toBe(undefined);
        });
    });
});
