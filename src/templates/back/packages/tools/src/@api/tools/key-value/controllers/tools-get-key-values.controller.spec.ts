import { ToolsGetKeyValuesController, ToolsGetKeyValuesHandler } from '@api/tools/key-value';
...
describe('ToolsGetKeyValuesController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<ToolsGetKeyValuesController>(ToolsGetKeyValuesController);
