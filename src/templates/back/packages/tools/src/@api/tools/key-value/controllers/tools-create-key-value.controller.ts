...
import { ToolsCreateKeyValueDto, ToolsCreateKeyValueHandler, ToolsKeyValueDto } from '@api/tools/key-value';
...
export class ToolsCreateKeyValueController
{
    ...
    @ApiCreatedResponse({ description: 'The record has been successfully created.', type: ToolsKeyValueDto })
    async main(
