import { ToolsCreateProcedureController, ToolsCreateProcedureHandler } from '@api/tools/procedure';
...
describe('ToolsCreateProcedureController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<ToolsCreateProcedureController>(ToolsCreateProcedureController);
