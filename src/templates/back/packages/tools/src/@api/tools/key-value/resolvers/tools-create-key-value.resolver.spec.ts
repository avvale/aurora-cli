...
import { ToolsCreateKeyValueHandler, ToolsCreateKeyValueResolver } from '@api/tools/key-value';
...
describe('ToolsCreateKeyValueResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<ToolsCreateKeyValueResolver>(ToolsCreateKeyValueResolver);
    ...
    describe('main', () =>
    {
        ...
        test('should return an keyValue created', async () =>
        {
            ...
            expect(await resolver.main(<ToolsCreateKeyValueInput>toolsMockKeyValueData[0])).toBe(toolsMockKeyValueData[0]);
        });
    });
});
