import { ToolsFindKeyValueController, ToolsFindKeyValueHandler } from '@api/tools/key-value';
...
describe('ToolsFindKeyValueController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<ToolsFindKeyValueController>(ToolsFindKeyValueController);
