...
import { ToolsPaginateMigrationsHandler, ToolsPaginateMigrationsResolver } from '@api/tools/migration';
...
describe('ToolsPaginateMigrationsResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<ToolsPaginateMigrationsResolver>(ToolsPaginateMigrationsResolver);
