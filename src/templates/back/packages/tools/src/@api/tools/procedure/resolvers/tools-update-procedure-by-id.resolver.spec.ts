...
import { ToolsUpdateProcedureByIdHandler, ToolsUpdateProcedureByIdResolver } from '@api/tools/procedure';
...
describe('ToolsUpdateProcedureByIdResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<ToolsUpdateProcedureByIdResolver>(ToolsUpdateProcedureByIdResolver);
    ...
    describe('main', () =>
    {
        ...
        test('should return a procedure by id updated', async () =>
        {
            ...
            expect(await resolver.main(<ToolsUpdateProcedureByIdInput>toolsMockProcedureData[0])).toBe(toolsMockProcedureData[0]);
        });
    });
});
