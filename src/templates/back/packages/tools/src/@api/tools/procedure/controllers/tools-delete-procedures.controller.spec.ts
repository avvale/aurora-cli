import { ToolsDeleteProceduresController, ToolsDeleteProceduresHandler } from '@api/tools/procedure';
...
describe('ToolsDeleteProceduresController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<ToolsDeleteProceduresController>(ToolsDeleteProceduresController);
