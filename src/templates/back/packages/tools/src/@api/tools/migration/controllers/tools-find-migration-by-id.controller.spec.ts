import { ToolsFindMigrationByIdController, ToolsFindMigrationByIdHandler } from '@api/tools/migration';
...
describe('ToolsFindMigrationByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<ToolsFindMigrationByIdController>(ToolsFindMigrationByIdController);
