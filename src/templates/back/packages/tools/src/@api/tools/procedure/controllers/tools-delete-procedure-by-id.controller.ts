...
import { ToolsDeleteProcedureByIdHandler, ToolsProcedureDto } from '@api/tools/procedure';
...
export class ToolsDeleteProcedureByIdController
{
    ...
    @ApiOkResponse({ description: 'The record has been deleted successfully.', type: ToolsProcedureDto })
    async main(
        @Param('id') id: string,
