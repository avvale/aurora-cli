...
import { ToolsDeleteKeyValueByIdController, ToolsDeleteKeyValueByIdHandler } from '@api/tools/key-value';
...
describe('ToolsDeleteKeyValueByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<ToolsDeleteKeyValueByIdController>(ToolsDeleteKeyValueByIdController);
