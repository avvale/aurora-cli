import { ToolsFindProcedureByIdController, ToolsFindProcedureByIdHandler } from '@api/tools/procedure';
...
describe('ToolsFindProcedureByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<ToolsFindProcedureByIdController>(ToolsFindProcedureByIdController);
