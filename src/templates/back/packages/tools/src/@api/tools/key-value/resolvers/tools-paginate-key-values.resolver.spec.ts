...
import { ToolsPaginateKeyValuesHandler, ToolsPaginateKeyValuesResolver } from '@api/tools/key-value';
...
describe('ToolsPaginateKeyValuesResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<ToolsPaginateKeyValuesResolver>(ToolsPaginateKeyValuesResolver);
