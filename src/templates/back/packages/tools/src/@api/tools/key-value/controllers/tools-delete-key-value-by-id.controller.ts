...
import { ToolsDeleteKeyValueByIdHandler, ToolsKeyValueDto } from '@api/tools/key-value';
...
export class ToolsDeleteKeyValueByIdController
{
    ...
    @ApiOkResponse({ description: 'The record has been deleted successfully.', type: ToolsKeyValueDto })
    async main(
        @Param('id') id: string,
