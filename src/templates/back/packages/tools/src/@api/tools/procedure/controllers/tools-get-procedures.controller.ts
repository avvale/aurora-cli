...
import { ToolsGetProceduresHandler, ToolsProcedureDto } from '@api/tools/procedure';
...
export class ToolsGetProceduresController
{
    ...
    @ApiOkResponse({ description: 'The records has been found successfully.', type: [ToolsProcedureDto]})
