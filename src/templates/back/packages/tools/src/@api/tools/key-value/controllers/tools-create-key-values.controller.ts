...
import { ToolsCreateKeyValueDto, ToolsCreateKeyValuesHandler, ToolsKeyValueDto } from '@api/tools/key-value';
...
export class ToolsCreateKeyValuesController
{
    ...
    @ApiCreatedResponse({ description: 'The records has been created successfully.' , type: [ToolsKeyValueDto]})
