...
import { ToolsDeleteKeyValuesHandler, ToolsKeyValueDto } from '@api/tools/key-value';
...
export class ToolsDeleteKeyValuesController
{
    ...
    @ApiOkResponse({ description: 'The records has been deleted successfully.', type: [ToolsKeyValueDto]})
