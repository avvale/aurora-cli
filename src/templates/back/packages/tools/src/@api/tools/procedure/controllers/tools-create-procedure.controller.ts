...
import { ToolsCreateProcedureDto, ToolsCreateProcedureHandler, ToolsProcedureDto } from '@api/tools/procedure';
...
export class ToolsCreateProcedureController
{
    ...
    @ApiCreatedResponse({ description: 'The record has been successfully created.', type: ToolsProcedureDto })
    async main(
