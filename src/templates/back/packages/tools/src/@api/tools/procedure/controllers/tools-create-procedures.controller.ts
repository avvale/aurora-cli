...
import { ToolsCreateProcedureDto, ToolsCreateProceduresHandler, ToolsProcedureDto } from '@api/tools/procedure';
...
export class ToolsCreateProceduresController
{
    ...
    @ApiCreatedResponse({ description: 'The records has been created successfully.' , type: [ToolsProcedureDto]})
