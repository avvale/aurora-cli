...
import { ToolsFindKeyValueByIdHandler, ToolsFindKeyValueByIdResolver } from '@api/tools/key-value';
...
describe('ToolsFindKeyValueByIdResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<ToolsFindKeyValueByIdResolver>(ToolsFindKeyValueByIdResolver);
