import { ToolsCreateMigrationsController, ToolsCreateMigrationsHandler } from '@api/tools/migration';
...
describe('ToolsCreateMigrationsController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<ToolsCreateMigrationsController>(ToolsCreateMigrationsController);
    });
