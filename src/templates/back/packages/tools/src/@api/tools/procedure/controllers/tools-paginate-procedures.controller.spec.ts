import { ToolsPaginateProceduresController, ToolsPaginateProceduresHandler } from '@api/tools/procedure';
...
describe('ToolsPaginateProceduresController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<ToolsPaginateProceduresController>(ToolsPaginateProceduresController);
