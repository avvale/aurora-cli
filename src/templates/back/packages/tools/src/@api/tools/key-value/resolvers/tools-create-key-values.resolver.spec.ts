...
import { ToolsCreateKeyValuesHandler, ToolsCreateKeyValuesResolver } from '@api/tools/key-value';
...
describe('ToolsCreateKeyValuesResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<ToolsCreateKeyValuesResolver>(ToolsCreateKeyValuesResolver);
    });
    ...
    describe('main', () =>
    {
        ...
        {
            expect(await resolver.main(<ToolsCreateKeyValueInput[]>toolsMockKeyValueData)).toBe(undefined);
        });
    });
});
