...
import { ToolsUpdateProceduresHandler, ToolsUpdateProceduresResolver } from '@api/tools/procedure';
...
describe('ToolsUpdateProceduresResolver', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        resolver = module.get<ToolsUpdateProceduresResolver>(ToolsUpdateProceduresResolver);
        handler = module.get<ToolsUpdateProceduresHandler>(ToolsUpdateProceduresHandler);
    });
    ...
    describe('main', () =>
    {
        ...
        test('should return a procedures updated', async () =>
        {
            ...
            expect(await resolver.main(<ToolsUpdateProceduresInput>toolsMockProcedureData[0])).toBe(toolsMockProcedureData[0]);
        });
    });
});
