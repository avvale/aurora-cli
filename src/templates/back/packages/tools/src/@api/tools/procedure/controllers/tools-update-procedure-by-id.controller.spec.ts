import { ToolsUpdateProcedureByIdController, ToolsUpdateProcedureByIdHandler } from '@api/tools/procedure';
...
describe('ToolsUpdateProcedureByIdController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<ToolsUpdateProcedureByIdController>(ToolsUpdateProcedureByIdController);
