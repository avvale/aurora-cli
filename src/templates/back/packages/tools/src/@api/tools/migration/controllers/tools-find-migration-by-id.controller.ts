...
import { ToolsFindMigrationByIdHandler, ToolsMigrationDto } from '@api/tools/migration';
...
export class ToolsFindMigrationByIdController
{
    ...
    @ApiOkResponse({ description: 'The record has been successfully requested.', type: ToolsMigrationDto })
    async main(
        @Param('id') id: string,
