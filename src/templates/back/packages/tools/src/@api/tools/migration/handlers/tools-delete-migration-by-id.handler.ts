...
import { ToolsDeleteMigrationByIdCommand, ToolsFindMigrationByIdQuery } from '@app/tools/migration';
...
export class ToolsDeleteMigrationByIdHandler
{
    ...
    ): Promise<ToolsMigration | ToolsMigrationDto>
    {
        ...
        await this.commandBus.dispatch(new ToolsDeleteMigrationByIdCommand(
            id,
            constraint,
            {
                timezone,
