import { ToolsGetMigrationsController, ToolsGetMigrationsHandler } from '@api/tools/migration';
...
describe('ToolsGetMigrationsController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<ToolsGetMigrationsController>(ToolsGetMigrationsController);
