import { ToolsPaginateKeyValuesController, ToolsPaginateKeyValuesHandler } from '@api/tools/key-value';
...
describe('ToolsPaginateKeyValuesController', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        controller = module.get<ToolsPaginateKeyValuesController>(ToolsPaginateKeyValuesController);
