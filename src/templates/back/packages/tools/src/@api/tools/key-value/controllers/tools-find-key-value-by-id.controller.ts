...
import { ToolsFindKeyValueByIdHandler, ToolsKeyValueDto } from '@api/tools/key-value';
...
export class ToolsFindKeyValueByIdController
{
    ...
    @ApiOkResponse({ description: 'The record has been successfully requested.', type: ToolsKeyValueDto })
    async main(
        @Param('id') id: string,
