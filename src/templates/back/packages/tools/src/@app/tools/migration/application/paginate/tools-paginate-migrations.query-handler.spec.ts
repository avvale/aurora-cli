import { ToolsIMigrationRepository, ToolsMockMigrationRepository, ToolsPaginateMigrationsQuery } from '@app/tools/migration';
...
describe('ToolsPaginateMigrationsQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<ToolsPaginateMigrationsQueryHandler>(ToolsPaginateMigrationsQueryHandler);
        service = module.get<ToolsPaginateMigrationsService>(ToolsPaginateMigrationsService);
