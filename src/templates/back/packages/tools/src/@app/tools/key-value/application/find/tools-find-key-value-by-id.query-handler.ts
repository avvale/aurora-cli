import { ToolsFindKeyValueByIdQuery, ToolsKeyValueMapper, ToolsKeyValueResponse } from '@app/tools/key-value';
...
export class ToolsFindKeyValueByIdQueryHandler implements IQueryHandler<ToolsFindKeyValueByIdQuery>
{
    ...
    async execute(query: ToolsFindKeyValueByIdQuery): Promise<ToolsKeyValueResponse>
    {
