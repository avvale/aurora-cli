import { ToolsCreateKeyValuesCommand, toolsMockKeyValueData } from '@app/tools/key-value';
...
describe('toolsCreateKeyValuesCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<ToolsCreateKeyValuesCommandHandler>(ToolsCreateKeyValuesCommandHandler);
    });
    ...
    describe('main', () =>
    {
        ...
        test('should return ToolsMockKeyValueData created', async () =>
        {
            expect(await commandHandler.execute(
                new ToolsCreateKeyValuesCommand(
