import { ToolsFindMigrationQuery, ToolsIMigrationRepository, ToolsMigrationMapper, ToolsMockMigrationRepository } from '@app/tools/migration';
...
describe('ToolsFindMigrationQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<ToolsFindMigrationQueryHandler>(ToolsFindMigrationQueryHandler);
