import { ToolsIKeyValueRepository, ToolsMockKeyValueRepository, ToolsPaginateKeyValuesQuery } from '@app/tools/key-value';
...
describe('ToolsPaginateKeyValuesQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<ToolsPaginateKeyValuesQueryHandler>(ToolsPaginateKeyValuesQueryHandler);
        service = module.get<ToolsPaginateKeyValuesService>(ToolsPaginateKeyValuesService);
