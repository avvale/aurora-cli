import { ToolsCreateProceduresCommand, toolsMockProcedureData } from '@app/tools/procedure';
...
describe('toolsCreateProceduresCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<ToolsCreateProceduresCommandHandler>(ToolsCreateProceduresCommandHandler);
    });
