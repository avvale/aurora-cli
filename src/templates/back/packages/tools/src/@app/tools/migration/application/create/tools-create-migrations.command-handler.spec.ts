import { ToolsCreateMigrationsCommand, toolsMockMigrationData } from '@app/tools/migration';
...
describe('toolsCreateMigrationsCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<ToolsCreateMigrationsCommandHandler>(ToolsCreateMigrationsCommandHandler);
    });
