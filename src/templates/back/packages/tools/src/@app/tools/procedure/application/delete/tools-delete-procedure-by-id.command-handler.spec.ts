import { ToolsDeleteProcedureByIdCommand, toolsMockProcedureData } from '@app/tools/procedure';
...
describe('ToolsDeleteProcedureByIdCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<ToolsDeleteProcedureByIdCommandHandler>(ToolsDeleteProcedureByIdCommandHandler);
    });
