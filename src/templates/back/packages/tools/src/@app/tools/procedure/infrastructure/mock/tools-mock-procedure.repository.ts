...
@Injectable()
export class ToolsMockProcedureRepository
  extends MockRepository<ToolsProcedure>
  implements ToolsIProcedureRepository
{
    ...
    for (const itemCollection of <any[]>toolsMockProcedureData) {
      ...
      this.collectionSource.push(
        ToolsProcedure.register(
          ...
          new ToolsProcedureRowId(itemCollection.rowId),
