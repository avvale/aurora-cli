...
export class ToolsRawSQLInformationSchemasQueryHandler
  implements IQueryHandler<ToolsRawSQLInformationSchemasQuery>
{
  private readonly mapper: ToolsInformationSchemaMapper =
    new ToolsInformationSchemaMapper();
  ...
  async execute(
    query: ToolsRawSQLInformationSchemasQuery,
  ): Promise<ToolsInformationSchemaResponse> {
