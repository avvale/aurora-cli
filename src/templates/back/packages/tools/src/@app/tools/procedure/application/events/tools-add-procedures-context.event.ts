import { ToolsCreatedProcedureEvent, ToolsCreatedProceduresEvent, ToolsDeletedProcedureEvent, ToolsDeletedProceduresEvent, ToolsProcedure, ToolsUpdatedProcedureEvent, ToolsUpdatedProceduresEvent } from '@app/tools/procedure';
    ...
    created(): void
    {
        this.apply(
            new ToolsCreatedProceduresEvent({
                payload: this.aggregateRoots.map(procedure =>
                    new ToolsCreatedProcedureEvent({
                        payload: {
                            ...
                            isInstalled: procedure.isInstalled.value,
