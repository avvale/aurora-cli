import { ToolsDeleteKeyValueByIdCommand, toolsMockKeyValueData } from '@app/tools/key-value';
...
describe('ToolsDeleteKeyValueByIdCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<ToolsDeleteKeyValueByIdCommandHandler>(ToolsDeleteKeyValueByIdCommandHandler);
    });
