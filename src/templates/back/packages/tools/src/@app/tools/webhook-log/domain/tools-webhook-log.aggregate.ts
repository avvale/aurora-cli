...
export class ToolsWebhookLog extends AggregateRoot {
  ...
  created(event: { payload: ToolsWebhookLog; cQMetadata?: CQMetadata }): void {
    this.apply(
  ...
  updated(event: { payload: ToolsWebhookLog; cQMetadata?: CQMetadata }): void {
    this.apply(
  ...
  deleted(event: { payload: ToolsWebhookLog; cQMetadata?: CQMetadata }): void {
    this.apply(
