import { ToolsFindProcedureByIdQuery, ToolsProcedureMapper, ToolsProcedureResponse } from '@app/tools/procedure';
...
export class ToolsFindProcedureByIdQueryHandler implements IQueryHandler<ToolsFindProcedureByIdQuery>
{
    ...
    async execute(query: ToolsFindProcedureByIdQuery): Promise<ToolsProcedureResponse>
    {
