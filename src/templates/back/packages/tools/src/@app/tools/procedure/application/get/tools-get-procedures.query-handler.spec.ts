import { ToolsGetProceduresQuery, ToolsIProcedureRepository, ToolsMockProcedureRepository, ToolsProcedureMapper } from '@app/tools/procedure';
...
describe('GetProceduresQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<ToolsGetProceduresQueryHandler>(ToolsGetProceduresQueryHandler);
