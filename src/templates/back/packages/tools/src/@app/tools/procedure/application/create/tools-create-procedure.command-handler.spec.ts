...
import { ToolsCreateProcedureCommand, toolsMockProcedureData } from '@app/tools/procedure';
...
describe('ToolsCreateProcedureCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<ToolsCreateProcedureCommandHandler>(ToolsCreateProcedureCommandHandler);
    });
