import { ToolsIProcedureRepository, ToolsMockProcedureRepository, ToolsPaginateProceduresQuery } from '@app/tools/procedure';
...
describe('ToolsPaginateProceduresQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<ToolsPaginateProceduresQueryHandler>(ToolsPaginateProceduresQueryHandler);
        service = module.get<ToolsPaginateProceduresService>(ToolsPaginateProceduresService);
