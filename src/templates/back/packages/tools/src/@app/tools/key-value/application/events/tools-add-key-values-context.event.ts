import { ToolsCreatedKeyValueEvent, ToolsCreatedKeyValuesEvent, ToolsDeletedKeyValueEvent, ToolsDeletedKeyValuesEvent, ToolsKeyValue, ToolsUpdatedKeyValueEvent, ToolsUpdatedKeyValuesEvent } from '@app/tools/key-value';
...
export class ToolsAddKeyValuesContextEvent extends AggregateRoot
{
    ...
    *[Symbol.iterator]()
    ...
    created(): void
    {
        this.apply(
            new ToolsCreatedKeyValuesEvent({
                payload: this.aggregateRoots.map(keyValue =>
    ...
    {
        this.apply(
            new ToolsUpdatedKeyValuesEvent({
                payload: this.aggregateRoots.map(keyValue =>
