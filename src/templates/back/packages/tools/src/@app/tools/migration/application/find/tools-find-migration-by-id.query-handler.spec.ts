import { ToolsFindMigrationByIdQuery, ToolsIMigrationRepository, ToolsMigrationMapper, toolsMockMigrationData, ToolsMockMigrationRepository } from '@app/tools/migration';
...
describe('ToolsFindMigrationByIdQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<ToolsFindMigrationByIdQueryHandler>(ToolsFindMigrationByIdQueryHandler);
        service = module.get<ToolsFindMigrationByIdService>(ToolsFindMigrationByIdService);
