import { toolsMockProcedureData, ToolsUpdateProceduresCommand } from '@app/tools/procedure';
...
describe('ToolsUpdateProceduresCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<ToolsUpdateProceduresCommandHandler>(ToolsUpdateProceduresCommandHandler);
    });
