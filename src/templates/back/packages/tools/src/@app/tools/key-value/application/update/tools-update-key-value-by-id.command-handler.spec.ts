import { toolsMockKeyValueData, ToolsUpdateKeyValueByIdCommand } from '@app/tools/key-value';
...
describe('ToolsUpdateKeyValueByIdCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<ToolsUpdateKeyValueByIdCommandHandler>(ToolsUpdateKeyValueByIdCommandHandler);
    });
