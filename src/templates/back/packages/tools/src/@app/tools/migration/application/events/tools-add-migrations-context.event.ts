import { ToolsCreatedMigrationEvent, ToolsCreatedMigrationsEvent, ToolsDeletedMigrationEvent, ToolsDeletedMigrationsEvent, ToolsMigration, ToolsUpdatedMigrationEvent, ToolsUpdatedMigrationsEvent } from '@app/tools/migration';
    ...
    created(): void
    {
        this.apply(
            new ToolsCreatedMigrationsEvent({
                payload: this.aggregateRoots.map(migration =>
