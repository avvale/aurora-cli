import { ToolsFindProcedureByIdQuery, ToolsIProcedureRepository, toolsMockProcedureData, ToolsMockProcedureRepository, ToolsProcedureMapper } from '@app/tools/procedure';
...
describe('ToolsFindProcedureByIdQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<ToolsFindProcedureByIdQueryHandler>(ToolsFindProcedureByIdQueryHandler);
        service = module.get<ToolsFindProcedureByIdService>(ToolsFindProcedureByIdService);
