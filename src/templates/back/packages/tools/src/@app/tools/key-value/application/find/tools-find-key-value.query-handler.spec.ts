import { ToolsFindKeyValueQuery, ToolsIKeyValueRepository, ToolsKeyValueMapper, ToolsMockKeyValueRepository } from '@app/tools/key-value';
...
describe('ToolsFindKeyValueQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<ToolsFindKeyValueQueryHandler>(ToolsFindKeyValueQueryHandler);
