import { ToolsIMigrationRepository, ToolsMigration, toolsMockMigrationData } from '@app/tools/migration';
import {
...
@Injectable()
export class ToolsMockMigrationRepository extends MockRepository<ToolsMigration> implements ToolsIMigrationRepository
{
