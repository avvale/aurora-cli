import { ToolsFindKeyValueByIdQuery, ToolsIKeyValueRepository, ToolsKeyValueMapper, toolsMockKeyValueData, ToolsMockKeyValueRepository } from '@app/tools/key-value';
...
describe('ToolsFindKeyValueByIdQueryHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        queryHandler = module.get<ToolsFindKeyValueByIdQueryHandler>(ToolsFindKeyValueByIdQueryHandler);
        service = module.get<ToolsFindKeyValueByIdService>(ToolsFindKeyValueByIdService);
