import { ToolsDeleteMigrationByIdCommand, toolsMockMigrationData } from '@app/tools/migration';
...
describe('ToolsDeleteMigrationByIdCommandHandler', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        commandHandler = module.get<ToolsDeleteMigrationByIdCommandHandler>(ToolsDeleteMigrationByIdCommandHandler);
    });
