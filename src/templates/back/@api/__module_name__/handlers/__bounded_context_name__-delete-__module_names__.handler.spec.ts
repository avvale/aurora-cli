...
{{
    setVar 'importsArray' (
        array
            ...
            (object items=(sumStrings (toPascalCase schema.boundedContextName) 'Delete' (toPascalCase schema.moduleNames) 'Handler') path=(sumStrings './' (toKebabCase schema.boundedContextName) '-delete-' (toKebabCase schema.moduleNames) '.handler'))
    )
~}}
