...
{{
    push ../importsArray
        (
            object
                items=(sumStrings (toPascalCase (getRelationshipBoundedContextNameProperty this ../schema)) 'Update' (toPascalCase (getRelationshipModuleNameProperty this ../schema)) 'ByIdDto')
