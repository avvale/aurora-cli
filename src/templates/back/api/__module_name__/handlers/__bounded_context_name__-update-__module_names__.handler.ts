...
import { {{ toPascalCase schema.boundedContextName }}{{ toPascalCase schema.moduleName }}, {{ toPascalCase schema.boundedContextName }}Update{{ toPascalCase schema.moduleNames }}Input } from '../../../../graphql';
...
export class {{ toPascalCase schema.boundedContextName }}Update{{ toPascalCase schema.moduleNames }}Handler
{
    ...
    {
        await this.commandBus.dispatch(new Update{{ toPascalCase schema.moduleNames }}Command(payload, queryStatement, constraint, { timezone }));
