...
## Descripción
StorageAccount es un módulo pensado para abstraer el uso de ficheros, independientemente de donde se estén guardando.
...
creaciónpPor una parte tenemos un acceso a la bandeja de entrada en la parte superior derecha de la aplicación, donde indica el número de mensajes pendiente de lectura.
