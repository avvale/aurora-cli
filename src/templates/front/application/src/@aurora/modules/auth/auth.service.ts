...
import { OAuthClientGrantType } from '@aurora/modules/auth/auth.types';
import { oAuthCreateCredentials } from '@aurora/modules/auth/auth.graphql';
...
export class AuthService
{
    ...
    // TODO, ver como desde el contructor poder esperar a tener la instancia de apollo construida
