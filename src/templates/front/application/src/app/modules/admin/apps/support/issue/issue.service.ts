...
import { SupportCreateIssue, SupportIssue, SupportUpdateIssueById, SupportUpdateIssues } from '@apps/support';
import { createMutation, deleteByIdMutation, deleteMutation, fields, findByIdQuery, findQuery, getQuery, insertMutation, paginationQuery, updateByIdMutation, updateMutation } from '@apps/support/issue';
...
{
    paginationSubject$: BehaviorSubject<GridData<SupportIssue> | null> = new BehaviorSubject(null);
    issueSubject$: BehaviorSubject<SupportIssue | null> = new BehaviorSubject(null);
    issuesSubject$: BehaviorSubject<SupportIssue[] | null> = new BehaviorSubject(null);

    // scoped subjects
    paginationScoped: { [key: string]: BehaviorSubject<GridData<SupportIssue> | null>; } = {};
    ...
    */
    ...
    setScopePagination(scope: string, pagination: GridData<SupportIssue>): void
    {
    ...
    {
        if (!this.issueScoped[scope]) this.issueScoped[scope] = new BehaviorSubject(null);
    ...
    {
        if (!this.issuesScoped[scope]) this.issuesScoped[scope] = new BehaviorSubject(null);
    ...
    }>
    {
        return this.graphqlService
            ...
            .pipe(
                ...
                tap(data => scope ? this.setScopeIssue(scope, data.object) : this.issueSubject$.next(data.object)),
            );
    }
    ...
    }>
    {
        return this.graphqlService
            ...
            .pipe(
                first(),
                map(result => result.data),
                tap(data => scope ? this.setScopeIssues(scope, data.objects) : this.issuesSubject$.next(data.objects)),
            );
    }
