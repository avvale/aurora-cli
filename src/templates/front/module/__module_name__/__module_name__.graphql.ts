...
export const relationsFields = `
    ...
    {{ toCamelCase (getRelationshipBoundedContextName this) }}Get{{ toPascalCase getRelationshipSchema.moduleNames }} (
    ...
    {{ toCamelCase (getRelationshipBoundedContextName this) }}Paginate{{ toPascalCase getRelationshipSchema.moduleNames }} (
