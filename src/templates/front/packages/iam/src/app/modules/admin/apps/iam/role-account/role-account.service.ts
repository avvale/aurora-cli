...
export class RoleAccountService {
    paginationSubject$: BehaviorSubject<GridData<IamRoleAccount> | null> =
        new BehaviorSubject(null);
    roleAccountSubject$: BehaviorSubject<IamRoleAccount | null> =
        new BehaviorSubject(null);
    rolesAccountsSubject$: BehaviorSubject<IamRoleAccount[] | null> =
        new BehaviorSubject(null);

    // scoped subjects
    paginationScoped: {
        [key: string]: BehaviorSubject<GridData<IamRoleAccount> | null>;
    } = {};
    roleAccountScoped: {
        [key: string]: BehaviorSubject<IamRoleAccount | null>;
    } = {};
    rolesAccountsScoped: {
        [key: string]: BehaviorSubject<IamRoleAccount[] | null>;
    } = {};
    ...
    setScopePagination(
        scope: string,
        pagination: GridData<IamRoleAccount>,
    ): void {
    ...
    getScopeRoleAccount(scope: string): Observable<IamRoleAccount> {
        if (!this.roleAccountScoped[scope])
            this.roleAccountScoped[scope] = new BehaviorSubject(null);
    ...
    getScopeRolesAccounts(scope: string): Observable<IamRoleAccount[]> {
        if (!this.rolesAccountsScoped[scope])
            this.rolesAccountsScoped[scope] = new BehaviorSubject(null);
    ...
    findById({
        ...
        return this.graphqlService
            ...
            .valueChanges.pipe(
                ...
                tap((data) =>
                    scope
                        ? this.setScopeRoleAccount(scope, data.object)
                        : this.roleAccountSubject$.next(data.object),
                ),
            );
    }
    ...
    get({
        ...
        return this.graphqlService
            ...
            .valueChanges.pipe(
                ...
                tap((data) =>
                    scope
                        ? this.setScopeRolesAccounts(scope, data.objects)
                        : this.rolesAccountsSubject$.next(data.objects),
                ),
            );
    }
