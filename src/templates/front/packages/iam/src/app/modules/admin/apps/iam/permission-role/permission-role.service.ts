...
export class PermissionRoleService {
    paginationSubject$: BehaviorSubject<GridData<IamPermissionRole> | null> =
        new BehaviorSubject(null);
    permissionRoleSubject$: BehaviorSubject<IamPermissionRole | null> =
        new BehaviorSubject(null);
    permissionsRolesSubject$: BehaviorSubject<IamPermissionRole[] | null> =
        new BehaviorSubject(null);

    // scoped subjects
    paginationScoped: {
        [key: string]: BehaviorSubject<GridData<IamPermissionRole> | null>;
    } = {};
    permissionRoleScoped: {
        [key: string]: BehaviorSubject<IamPermissionRole | null>;
    } = {};
    permissionsRolesScoped: {
        [key: string]: BehaviorSubject<IamPermissionRole[] | null>;
    } = {};
    ...
    setScopePagination(
        scope: string,
        pagination: GridData<IamPermissionRole>,
    ): void {
    ...
    getScopePermissionRole(scope: string): Observable<IamPermissionRole> {
        if (!this.permissionRoleScoped[scope])
            this.permissionRoleScoped[scope] = new BehaviorSubject(null);
        return this.permissionRoleScoped[scope].asObservable();
    }

    setScopePermissionsRoles(
        scope: string,
    ...
    getScopePermissionsRoles(scope: string): Observable<IamPermissionRole[]> {
        if (!this.permissionsRolesScoped[scope])
            this.permissionsRolesScoped[scope] = new BehaviorSubject(null);
    ...
    findById({
        ...
        return this.graphqlService
            ...
            .valueChanges.pipe(
                ...
                tap((data) =>
                    scope
                        ? this.setScopePermissionRole(scope, data.object)
    ...
    get({
        ...
        return this.graphqlService
            ...
            .valueChanges.pipe(
                ...
                tap((data) =>
                    scope
                        ? this.setScopePermissionsRoles(scope, data.objects)
