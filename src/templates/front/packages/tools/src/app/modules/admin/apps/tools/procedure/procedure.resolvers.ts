...
export const procedurePaginationResolver: ResolveFn<GridData<ToolsProcedure>> = (
...
) =>
{
    ...
    gridStateService.setPaginationActionId(gridId, 'tools::procedure.list.pagination');
