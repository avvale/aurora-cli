...
import {
    checkMessagesInboxMutation,
    countUnreadCustomerMessageInboxQuery,
    deleteCustomerMessageInboxMutation,
    findCustomerMessageInboxQuery,
    insertMutation,
    paginateCustomerMessagesInboxQuery,
    readCustomerMessageInboxMutation,
    unreadCustomerMessageInboxMutation,
} from './inbox.graphql';
...
export class InboxService {
    paginationSubject$: BehaviorSubject<GridData<MessageInbox> | null> =
        new BehaviorSubject(null);
    inboxSubject$: BehaviorSubject<MessageInbox | null> = new BehaviorSubject(
        null,
    );
    inboxesSubject$: BehaviorSubject<MessageInbox[] | null> =
        new BehaviorSubject(null);

    // scoped subjects
    paginationScoped: {
        [key: string]: BehaviorSubject<GridData<MessageInbox> | null>;
    } = {};
    ...
    getScopeInbox(scope: string): Observable<MessageInbox> {
        if (!this.inboxScoped[scope])
            this.inboxScoped[scope] = new BehaviorSubject(null);
        return this.inboxScoped[scope].asObservable();
    }
    ...
    getScopeInboxes(scope: string): Observable<MessageInbox[]> {
        if (!this.inboxesScoped[scope])
            this.inboxesScoped[scope] = new BehaviorSubject(null);
        return this.inboxesScoped[scope].asObservable();
    }
    ...
    findById({
        ...
        return this.graphqlService
            ...
            .valueChanges.pipe(
                ...
                tap((data) =>
                    scope
                        ? this.setScopeInbox(scope, data.object)
    ...
    get({
        ...
        return this.graphqlService
            ...
            .valueChanges.pipe(
                ...
                tap((data) =>
                    scope
                        ? this.setScopeInboxes(scope, data.objects)
    ...
    paginateCustomerCenterMessagesInbox({
        ...
        return this.graphqlService
            ...
            .valueChanges.pipe(
                ...
                map((result) => result.data.pagination),
                tap((pagination) =>
                    this.setScopePagination(
                        messageCustomerCenterMessageScope,
                        pagination,
                    ),
                ),
            );
    ...
    countUnreadCustomerMessageInbox({
        ...
        return this.graphqlService
            ...
            .valueChanges.pipe(
                ...
                map(
                    (result) =>
                        result.data.messageCountUnreadCustomerMessageInbox,
                ),
            );
    }
