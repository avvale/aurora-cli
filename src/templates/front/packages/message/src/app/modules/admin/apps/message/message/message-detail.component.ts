...
export const messageAccountsDialogGridId =
    'message::message.detail.accountsDialogGridList';
export const messageAccountsGridId =
    'message::message.detail.messageAccountsGridList';
export const messageSelectedAccountsScopePagination =
    'message::messageSelectedAccounts';
export const messageAccountsScopeDialogPagination =
    'message::messageDialogAccounts';
...
export class MessageDetailComponent extends ViewDetailComponent {
    ...
    filteredScopeRecipients$: ReplaySubject<OAuthScope[]> = new ReplaySubject<
        OAuthScope[]
    >(1);
    tagRecipientFilterCtrl: FormControl = new FormControl<string>('');
    filteredTagRecipients$: ReplaySubject<IamTag[]> = new ReplaySubject<
        IamTag[]
    >(1);
    ...
    status: Signal<string> = computed(() =>
        this.managedObject()
            ? this.managedObject().status
            : MessageMessageStatus.DRAFT,
    );
    ...
    initEditor: EditorComponent['init'] = {
        ...
        toolbar:
            'undo redo | bold italic | bullist numlist | link table | alignleft aligncenter alignright alignjustify | blockquote | code | removeformat',
        branding: false,
    ...
    tenantManagersAsyncMatSelectSearchState = initAsyncMatSelectSearchState<
        string,
        IamTenant
    >();
    tenantRecipientsAsyncMatSelectSearchState = initAsyncMatSelectSearchState<
        string,
        IamTenant
    >();
    tenantAccountRecipientsAsyncMatSelectSearchState =
        initAsyncMatSelectSearchState<string, IamTenant>();
    tenantDialogAccountRecipientsAsyncMatSelectSearchState =
        initAsyncMatSelectSearchState<string, IamTenant>();
    ...
    scopeAccountRecipientsAsyncMatSelectSearchState =
        initAsyncMatSelectSearchState<string, OAuthScope>();
    scopeDialogAccountRecipientsAsyncMatSelectSearchState =
        initAsyncMatSelectSearchState<string, OAuthScope>();
    ...
    tagAccountRecipientsAsyncMatSelectSearchState =
        initAsyncMatSelectSearchState<string, IamTag>();
    tagDialogAccountRecipientsAsyncMatSelectSearchState =
        initAsyncMatSelectSearchState<string, IamTag>();
    ...
    @ViewChild('messageAccountsGridSelectMultipleElements')
    messageAccountsGridSelectMultipleElementsComponent: GridSelectMultipleElementsComponent;
        ...
        ...accountColumnsConfig({
            ...
            tenantsAsyncMatSelectSearch: Object.defineProperties(
                {},
                {
                    ...
                    manageAsyncMatSelectSearch: {
                        value: this.tenantAsyncMatSelectSearch,
                    },
                },
            ),
            scopesAsyncMatSelectSearch: Object.defineProperties(
                {},
                {
                    ...
                    manageAsyncMatSelectSearch: {
                        value: this.scopeManageAsyncMatSelectSearch,
                    },
                },
            ),
            tagsAsyncMatSelectSearch: Object.defineProperties(
                {},
                {
                    ...
                    manageAsyncMatSelectSearch: {
                        value: this.tagManageAsyncMatSelectSearch,
                    },
                },
            ),
        }),
    ...
    selectedCheckboxRowModel = new SelectionModel<IamAccount>(
        true,
        [],
        true,
        (a: IamAccount, b: IamAccount) => a.id === b.id,
    );
    originMessageAccountsColumnsConfig: ColumnConfig[] = [
        {
            ...
            actions: (row) => {
                ...
                if (
                    this.managedObject()?.status !==
                    this.messageMessageStatus.SENT
                ) {
                    actions.push({
    ...
    constructor(
        ...
        initAsyncMatSelectSearch<string, IamTenant>({
            asyncMatSelectSearchState:
                this.tenantManagersAsyncMatSelectSearchState,
        ...
        initAsyncMatSelectSearch<string, IamTenant>({
            asyncMatSelectSearchState:
                this.tenantRecipientsAsyncMatSelectSearchState,
            manageAsyncMatSelectSearch: this.tenantAsyncMatSelectSearch,
            itemPagination:
                this.activatedRoute.snapshot.data.data.iamGetTenants,
            initSelectedItems:
        ...
        initAsyncMatSelectSearch<string, IamTenant>({
            asyncMatSelectSearchState:
                this.tenantAccountRecipientsAsyncMatSelectSearchState,
            manageAsyncMatSelectSearch: this.tenantAsyncMatSelectSearch,
            itemPagination:
                this.activatedRoute.snapshot.data.data.iamGetTenants,
            initSelectedItems:
                this.activatedRoute.snapshot.data.data
                    .iamGetSelectedTenantsAccount,
        });
        ...
        initAsyncMatSelectSearch<string, IamTenant>({
            asyncMatSelectSearchState:
                this.tenantDialogAccountRecipientsAsyncMatSelectSearchState,
            manageAsyncMatSelectSearch: this.tenantAsyncMatSelectSearch,
            itemPagination:
                this.activatedRoute.snapshot.data.data.iamGetTenants,
            initSelectedItems:
        ...
        initAsyncMatSelectSearch<string, OAuthScope>({
            asyncMatSelectSearchState:
                this.scopeAccountRecipientsAsyncMatSelectSearchState,
        ...
        initAsyncMatSelectSearch<string, OAuthScope>({
            asyncMatSelectSearchState:
                this.scopeDialogAccountRecipientsAsyncMatSelectSearchState,
            manageAsyncMatSelectSearch: this.scopeManageAsyncMatSelectSearch,
            itemPagination:
                this.activatedRoute.snapshot.data.data.oAuthGetScopes,
            initSelectedItems:
        ...
        initAsyncMatSelectSearch<string, IamTag>({
            asyncMatSelectSearchState:
                this.tagAccountRecipientsAsyncMatSelectSearchState,
        ...
        initAsyncMatSelectSearch<string, IamTag>({
            asyncMatSelectSearchState:
                this.tagDialogAccountRecipientsAsyncMatSelectSearchState,
            manageAsyncMatSelectSearch: this.tagManageAsyncMatSelectSearch,
            itemPagination: this.activatedRoute.snapshot.data.data.iamGetTags,
            initSelectedItems:
                this.activatedRoute.snapshot.data.data
                    .iamGetSelectedTagsDialogAccount,
            indexKey: 'name',
            valueKey: 'name',
        });
    ...
    init(): void {
        // tenants
        this.initScopeRecipientsFilter(
            this.activatedRoute.snapshot.data.data.oAuthGetScopes,
        );
        this.initTagRecipientsFilter(
            this.activatedRoute.snapshot.data.data.iamGetTags,
        );
        ...
        combineLatest([
            ...
            .pipe(takeUntil(this.unsubscribeAll$), skip(1))
            .subscribe(
                ([
                    tenantRecipientIds,
                    scopeRecipients,
    ...
    initScopeRecipientsFilter(scopes: OAuthScope[]): void {
        ...
        this.scopeRecipientFilterCtrl.valueChanges
            .pipe(takeUntil(this.unsubscribeAll$))
            .subscribe(async () => {
                this.selectSearchService.filterSelect<OAuthScope>(
    ...
    initTagRecipientsFilter(tags: IamTag[]): void {
        ...
        this.tagRecipientFilterCtrl.valueChanges
            .pipe(takeUntil(this.unsubscribeAll$))
            .subscribe(async () => {
                this.selectSearchService.filterSelect<IamTag>(
    ...
    handleAccountsDialogRowsSectionChange(
        $event: SelectionChange<IamAccount>,
    ): void {
    ...
    async handleAction(action: Action): Promise<void> {
        ...
        switch (action?.id) {
            ...
            case 'message::message.detail.new':
                ...
                // permissions grid
                this.messageAccountsColumnsConfig$ =
                    this.gridColumnsConfigStorageService
                        .getColumnsConfig(
                            this.messageAccountsGridId,
                            this.originMessageAccountsColumnsConfig,
                        )
                        .pipe(takeUntil(this.unsubscribeAll$));
                ...
                this.messageAccountsGridData$ =
                    this.accountService.getScopePagination(
                        messageSelectedAccountsScopePagination,
                    );

                // account dialog grid
                this.accountsDialogColumnsConfig$ =
                    this.gridColumnsConfigStorageService
                        .getColumnsConfig(
                            this.accountsDialogGridId,
                            this.accountsDialogOriginColumnsConfig,
                        )
                        .pipe(takeUntil(this.unsubscribeAll$));
                this.accountsDialogGridData$ =
                    this.accountService.getScopePagination(
                        messageAccountsScopeDialogPagination,
                    );
            ...
            case 'message::message.detail.create':
                try {
                    await lastValueFrom(
                        this.messageService.create<MessageMessage>({
                            object: {
                                ...this.fg.value,
            ...
            case 'message::message.detail.update':
                try {
                    await lastValueFrom(
                        this.messageService.updateById<MessageMessage>({
                            object: {
                                ...this.fg.value,
                                totalRecipients: undefined,
                                reads: undefined,
                    ...
                    this.router.navigate(
                        ['message/message/edit', this.fg.value.id],
            ...
            case 'message::message.detail.addMessageAccount':
                const accountRecipientIdAdded = new Set<string>([
                    ...this.fg.get('accountRecipientIds').value,
                    action.meta.row.id,
                ]);
                this.fg
                    .get('accountRecipientIds')
                    .setValue([...accountRecipientIdAdded]);
                this.fg.markAsDirty();
            ...
            case 'message::message.detail.addMessageAccounts':
                ...
                const accountRecipientIdsAdded = new Set<string>([
                    ...this.fg.get('accountRecipientIds').value,
                    ...rowIds,
                ]);
                this.fg
                    .get('accountRecipientIds')
                    .setValue([...accountRecipientIdsAdded]);
                this.fg.markAsDirty();
            ...
            case 'message::message.detail.removeMessageAccount':
                const accountRecipientIdRemoved = new Set<string>(
                    this.fg.get('accountRecipientIds').value,
                );
                accountRecipientIdRemoved.delete(action.meta.row.id);
                this.fg
                    .get('accountRecipientIds')
                    .setValue([...accountRecipientIdRemoved]);
                this.fg.markAsDirty();
            ...
            case 'message::message.detail.removeMessageAccounts':
                const accountRecipientIdsRemoved = new Set<string>(
                    this.fg.get('accountRecipientIds').value,
                );
                action.meta.rows.forEach((row) =>
                    accountRecipientIdsRemoved.delete(row.id),
                );
                this.fg
                    .get('accountRecipientIds')
                    .setValue([...accountRecipientIdsRemoved]);
                this.fg.markAsDirty();
            ...
            case 'message::message.detail.messageAccountsDialogPagination':
                await lastValueFrom(
                    this.accountService.paginationWithRelations({
                        query: action.meta.query
                            ? action.meta.query
                            : queryStatementHandler({
                                  columnsConfig: accountColumnsConfig(),
                        ...
                        queryGetSelectedTenants: {
                            where: {
                                id:
                                    this.gridFiltersStorageService.getColumnFilter(
                                        this.accountsDialogGridId,
                                        'tenants',
                                    )?.value || [],
                            },
            ...
            case 'message::message.detail.removeAttachment':
                if (action.meta.message) {
                    await lastValueFrom(
                        this.messageService.removeAttachmentMessage<MessageMessage>(
                            {
                                message: {
            ...
            case 'message::message.detail.downloadAttachment':
                if (action.meta.attachment instanceof File) {
                    this.downloadService.downloadTempFile(
                        action.meta.attachment,
                    );
                } else {
                    this.downloadService.download({
                        relativePathSegments:
                            action.meta.attachment.relativePathSegments,
            ...
            case 'message::message.detail.countTotalRecipients':
                const response = await lastValueFrom(
                    this.messageService.countTotalRecipientsMessage({
                        tenantRecipientIds:
                            action.meta.tenantRecipientIds.length === 0
                                ? undefined
                                : action.meta.tenantRecipientIds,
                        scopeRecipients:
                            action.meta.scopeRecipients.length === 0
                                ? undefined
                                : action.meta.scopeRecipients,
                        tagRecipients:
                            action.meta.tagRecipients.length === 0
                                ? undefined
                                : action.meta.tagRecipients,
                        accountRecipientIds:
                            action.meta.accountRecipientIds.length === 0
                                ? undefined
                                : action.meta.accountRecipientIds,
                    }),
                );
                this.totalRecipients.set(
                    response.messageCountTotalRecipientsMessage,
                );
                break;

            case 'message::message.detail.sendMessage':
                await lastValueFrom(
                    this.messageService.sendMessageMessage({
                        message: {
                            id: action.meta.message.id,
                            tenantIds: action.meta.message.tenantIds,
                        },
            ...
            case 'message::message.detail.draftMessage':
                await lastValueFrom(
                    this.messageService.draftMessageMessage({
                        message: {
                            id: action.meta.message.id,
                            tenantIds: action.meta.message.tenantIds,
                        },
