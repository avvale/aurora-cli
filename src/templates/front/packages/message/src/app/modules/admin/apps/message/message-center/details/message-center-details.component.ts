    ...
    async handleAction(action: Action): Promise<void> {
        ...
        switch (action?.id) {
            case 'message::messageCenter.detail.markAsRead':
                await lastValueFrom(
                    this.inboxService.readCustomerMessageInbox<MessageInbox>({
                        inbox: {
                ...
                this.messageService.toggleMessageAsReadSubject$.next(
                    action.meta.message,
                );
            ...
            case 'message::messageCenter.detail.markAsUnRead':
                await lastValueFrom(
                    this.inboxService.unreadCustomerMessageInbox<MessageInbox>({
                        inbox: {
                            id: action.meta.message.id,
                            tenantIds: action.meta.message.tenantIds,
                        },
