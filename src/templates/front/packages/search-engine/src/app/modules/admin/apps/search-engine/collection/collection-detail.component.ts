...
export class CollectionDetailComponent extends ViewDetailComponent {
    ...
    @ViewChild('fieldsGridElementsManager')
    fieldsComponent: GridElementsManagerComponent;
    ...
    breadcrumb: Crumb[] = [
        { translation: 'App' },
        {
            ...
            routerLink: ['/search-engine/collection'],
        },
    ...
    onSubmit($event): void {
        ...
        this.actionService.action({
            id: mapActions(this.currentViewAction.id, {
                'searchEngine::collection.detail.new':
                    'searchEngine::collection.detail.create',
                'searchEngine::collection.detail.edit':
                    'searchEngine::collection.detail.update',
            }),
            isViewAction: false,
        });
    }
        ...
        this.actionService.action({
            id: mapActions(dialog.componentInstance.data.currentActionId, {
                ...
                'searchEngine::collection.detail.editField':
                    'searchEngine::collection.detail.updateField',
            }),
            isViewAction: false,
        });
        ...
        switch (action?.id) {
            ...
            case 'searchEngine::collection.detail.edit':
                ...
                this.fieldsColumnsConfig$ = this.gridColumnsConfigStorageService
                    .getColumnsConfig(
                        this.fieldsGridId,
                        this.originFieldsColumnsConfig,
                    )
                    .pipe(takeUntil(this.unsubscribeAll$));
            ...
            case 'searchEngine::collection.detail.create':
                try {
                    await lastValueFrom(
                        this.collectionService.create<SearchEngineCollection>({
            ...
            case 'searchEngine::collection.detail.update':
                try {
                    await lastValueFrom(
                        this.collectionService.updateById<SearchEngineCollection>(
                            {
                                object: this.fg.value,
                            },
                        ),
                    ...
                    this.fieldService.pagination({
                        query: action.meta.query
                            ...
                            : QueryStatementHandler.init({
                                  columnsConfig: fieldColumnsConfig,
                              })
                                  .setColumFilters(
                                      this.gridFiltersStorageService.getColumnFilterState(
                                          this.fieldsGridId,
            ...
            case 'searchEngine::collection.detail.newField':
                ...
                this.fieldsComponent.handleElementDetailDialog({ action });
            ...
            case 'searchEngine::collection.detail.createField':
                await lastValueFrom(
                    this.fieldService.create<SearchEngineField>({
            ...
            case 'searchEngine::collection.detail.updateField':
                ...
                await lastValueFrom(
                    this.fieldService.updateById<SearchEngineField>({
                        object: this.fieldDialogFg.value,
                    }),
                );
                this.actionService.action({
            ...
            case 'searchEngine::collection.detail.deleteField':
                ...
                deleteFieldDialogRef.afterClosed().subscribe(async (result) => {
                    if (result === 'confirmed') {
                        try {
                            await lastValueFrom(
                                this.fieldService.deleteById<SearchEngineField>(
                                    {
                                        id: action.meta.row.id,
                                    },
                                ),
            ...
            case 'searchEngine::collection.detail.exportFields':
                ...
                const fieldColumns: string[] = fieldColumnsConfig.map(
                    (fieldColumnConfig) => fieldColumnConfig.field,
                );
                const fieldHeaders = fieldColumns.map((column) =>
                    this.translocoService.translate(
                        'searchEngine.' + column.toPascalCase(),
                    ),
                );
