...
{
    paginationSubject$: BehaviorSubject<GridData<CommonAdministrativeAreaLevel1> | null> = new BehaviorSubject(null);
    administrativeAreaLevel1Subject$: BehaviorSubject<CommonAdministrativeAreaLevel1 | null> = new BehaviorSubject(null);
    administrativeAreasLevel1Subject$: BehaviorSubject<CommonAdministrativeAreaLevel1[] | null> = new BehaviorSubject(null);
    ...
    */
    ...
    get administrativeAreasLevel1$(): Observable<CommonAdministrativeAreaLevel1[]>
    {
