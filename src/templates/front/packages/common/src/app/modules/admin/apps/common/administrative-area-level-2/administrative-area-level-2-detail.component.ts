...
export class AdministrativeAreaLevel2DetailComponent extends ViewDetailComponent {
  ...
  managedObject: WritableSignal<CommonAdministrativeAreaLevel2> = signal(null);
  ...
  breadcrumb: Crumb[] = [
    { translation: 'App' },
    {
      ...
      routerLink: ['/common/administrative-area-level-2'],
    },
  ...
  onSubmit($event): void {
    ...
    this.actionService.action({
      id: mapActions(this.currentViewAction.id, {
        'common::administrativeAreaLevel2.detail.new':
          'common::administrativeAreaLevel2.detail.create',
        'common::administrativeAreaLevel2.detail.edit':
          'common::administrativeAreaLevel2.detail.update',
      }),
      isViewAction: false,
    });
  }
  ...
  async handleAction(action: Action): Promise<void> {
    ...
    switch (action?.id) {
      ...
      case 'common::administrativeAreaLevel2.detail.edit':
        this.administrativeAreaLevel2Service.administrativeAreaLevel2$
      ...
      case 'common::administrativeAreaLevel2.detail.create':
        try {
          await lastValueFrom(
            this.administrativeAreaLevel2Service.create<CommonAdministrativeAreaLevel2>(
              {
      ...
      case 'common::administrativeAreaLevel2.detail.update':
        try {
          await lastValueFrom(
            this.administrativeAreaLevel2Service.updateById<CommonAdministrativeAreaLevel2>(
              {
                object: this.fg.value,
              },
            ),
