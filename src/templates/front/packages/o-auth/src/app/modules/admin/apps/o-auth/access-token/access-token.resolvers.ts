...
) =>
{
    ...
    gridStateService.setPaginationActionId(gridId, 'oAuth::accessToken.list.pagination');
    gridStateService.setExportActionId(gridId, 'oAuth::accessToken.list.export');
