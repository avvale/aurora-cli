...
export const refreshTokenPaginationResolver: ResolveFn<
    GridData<OAuthRefreshToken>
> = (route: ActivatedRouteSnapshot, state: RouterStateSnapshot) => {
    ...
    gridStateService.setPaginationActionId(
        gridId,
        'oAuth::refreshToken.list.pagination',
    );
    gridStateService.setExportActionId(
        gridId,
        'oAuth::refreshToken.list.export',
    );
...
export const refreshTokenEditResolver: ResolveFn<{
    ...
    return refreshTokenService.findById({
