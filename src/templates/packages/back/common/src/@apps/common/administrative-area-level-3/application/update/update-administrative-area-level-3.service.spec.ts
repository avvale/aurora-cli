...
describe('UpdateAdministrativeAreaLevel3Service', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        service         = module.get(UpdateAdministrativeAreaLevel3Service);
    ...
    describe('main', () =>
    {
        test('UpdateAdministrativeAreaLevel3Service should be defined', () =>
        {
