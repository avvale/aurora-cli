...
describe('UpdateAdministrativeAreaLevel2ByIdService', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        service         = module.get(UpdateAdministrativeAreaLevel2ByIdService);
    ...
    describe('main', () =>
    {
        test('UpdateAdministrativeAreaLevel2ByIdService should be defined', () =>
        {
