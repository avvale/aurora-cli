...
import { UpdateAdministrativeAreaLevel3CommandHandler } from './application/update/update-administrative-area-level-3.command-handler';
...
import { UpdateAdministrativeAreaLevel3Service } from './application/update/update-administrative-area-level-3.service';
...
export const CommonAdministrativeAreaLevel3Services = [
    ...
    UpdateAdministrativeAreaLevel3Service,
