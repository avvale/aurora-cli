...
import { UpdateAdministrativeAreaLevel1ByIdCommand } from '@apps/common/administrative-area-level-1/application/update/update-administrative-area-level-1-by-id.command';
import { CommonAdministrativeAreaLevel1, CommonUpdateAdministrativeAreaLevel1ByIdInput } from 'src/graphql';
