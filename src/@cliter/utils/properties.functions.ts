...
import {
  hasBelongsToDecoratorProperty,
  hasBelongsToManyDecoratorProperty,
  hasColumnDecoratorProperty,
  hasHasManyDecoratorProperty,
  hasHasOneDecoratorProperty,
  isPivotProperty,
 ...
 * CONST *
 *********/
export const timestampProperties: string[] = [
  'createdAt',
  'updatedAt',
  'deletedAt',
];
 ...
 * PROPERTIES *
 **************/
export const hasProperties = (properties: Property[]): boolean => {
...
export const hasForeignKeyDecoratorProperties = (
  ...
  return properties?.some(
    (property) =>
      (hasColumnDecoratorProperty(property) &&
...
export const hasBelongsToManyDecoratorProperties = (
  ...
  return properties?.some((property) =>
    hasBelongsToManyDecoratorProperty(property),
  );
};
...
export const hasBelongsToDecoratorProperties = (
  ...
  return properties?.some((property) =>
    hasBelongsToDecoratorProperty(property),
  );
};

// replace by Properties hasEnum
export const hasEnumProperties = (properties: Property[]): boolean => {
  return properties?.some((property) => property.type === PropertyType.ENUM);
};

export const hasBooleanProperties = (properties: Property[]): boolean => {
  return properties?.some((property) => property.type === PropertyType.BOOLEAN);
};

export const hasTimestampProperties = (properties: Property[]): boolean => {
  return properties
    ?.filter((property) => !timestampProperties.includes(property.name))
    .some((property) => property.type === PropertyType.TIMESTAMP);
};

export const hasDateProperties = (properties: Property[]): boolean => {
  return properties?.some((property) => property.type === PropertyType.DATE);
};

// replace by Properties hasIndexI18n
export const hasIndexI18nProperties = (properties: Property[]): boolean => {
  return properties?.some(
    (property) =>
      (property.index === PropertyIndex.INDEX ||
        property.index === PropertyIndex.UNIQUE) &&
      property.isI18n,
  );
};
...
export const hasAsyncSearchMultipleSelectWebComponentProperty = (
  ...
  return properties?.some(
    (property) =>
      property.webComponent?.type ===
      WebComponentType.ASYNC_SEARCH_MULTIPLE_SELECT,
  );
};
...
export const countGridSelectMultipleElementsWebComponentsProperties = (
  ...
  return getGridSelectMultipleElementsWebComponentsProperties(properties)
    .length;
};
...
export const getWithoutDeletedAtProperties = (
  ...
  return properties?.filter(
    (property) => !deletedAtProperty.includes(property.name),
  );
};
...
export const getI18nProperties = (properties: Property[]): Property[] => {
  return properties?.filter((property) => property.isI18n);
};

export const getNotI18nProperties = (properties: Property[]): Property[] => {
  return properties?.filter((property) => !property.isI18n);
};
...
export const hasIndexProperties = (properties: Property[]): boolean => {
  return properties?.some(
    (property) =>
      (property.index === PropertyIndex.INDEX ||
        property.index === PropertyIndex.UNIQUE) &&
...
export const getIndexesProperties = (properties: Property[]): Property[] => {
  return properties?.filter((property) => property.index); // only properties with index defined
};

export const getPrimaryKeyProperties = (properties: Property[]): Property[] => {
  return properties
    ?.filter((property) => property.primaryKey) // only primary key properties
    .filter(
      (property, index, array) =>
        array.findIndex(
          (originProperty) => originProperty.name === property.name,
        ) === index,
    ); // avoid duplicate primary keys, i18n aurora yaml has two primary key, the id and id from i18n
};
...
export const getValueObjectsProperties = (
  ...
  return properties
    ?.filter(
      (property) =>
        property.relationship?.type !== RelationshipType.ONE_TO_MANY,
    ) // exclude one to many relations
    .filter(
      (property) =>
        !(
          property.relationship?.type === RelationshipType.ONE_TO_ONE &&
...
export const getWithoutTimestampsProperties = (
  ...
  return properties?.filter(
    (property) => !timestampProperties.includes(property.name),
  );
};

// replace by Properties response
export const getResponseProperties = (properties: Property[]): Property[] => {
  return properties
    ?.filter(
      (property) =>
        property.relationship?.type !== RelationshipType.ONE_TO_MANY,
...
export const getSeedProperties = (properties: Property[]): Property[] => {
  return properties
    ...
    ); // exclude one to one relations without relationship field, is relation one to one without xxxxId
};

// replace by Properties mapper
export const getMapperProperties = (properties: Property[]): Property[] => {
  return properties
    ?.filter(
      (property) =>
        property.relationship?.type !== RelationshipType.ONE_TO_MANY,
...
export const getMockProperties = (properties: Property[]): Property[] => {
  return properties
    ?.filter(
      (property) =>
        property.relationship?.type !== RelationshipType.ONE_TO_MANY,
...
export const hasPivotProperties = (properties: Property[]): boolean => {
...
export const hasCompositePrimaryKeys = (properties: Property[]): boolean => {
  return (
    properties.reduce(
...
export const getForeignRelationshipProperties = (
  ...
  return getPropertiesWithRelationship(properties)?.filter((item) => {
...
export const getManyToManyRelationshipProperties = (
  ...
  return properties?.filter(
    (property) => property.relationship?.type === RelationshipType.MANY_TO_MANY,
  );
};
  ...
  return properties
    ?.filter(
      (value, index, self) =>
        ...
        self.findIndex(
          (t) =>
            t.relationship?.modulePath === value.relationship?.modulePath &&
            t.relationship?.aggregateName === value.relationship?.aggregateName,
        ),
    )
    .filter(
      (property) => property.relationship?.type === RelationshipType.ONE_TO_ONE,
    );
};
...
export const getWithRelationshipOneToOneWithRelationshipFieldProperties = (
  ...
  return getWithRelationshipOneToOneProperties(properties)?.filter((property) =>
...
export const getWithRelationshipOneToOneWithoutRelationshipFieldProperties = (
  ...
  return getWithRelationshipOneToOneProperties(properties)?.filter(
    (property) => !property.relationship?.field,
  );
};
...
export const getWithRelationshipManyToOneProperties = (
  ...
  return properties?.filter(
    (property) => property.relationship?.type === RelationshipType.MANY_TO_ONE,
  );
};
...
export const getWithRelationshipOneToManyProperties = (
  ...
  return properties?.filter(
    (property) => property.relationship?.type === RelationshipType.ONE_TO_MANY,
  );
};
...
export const getCreateControllerProperties = (
  ...
  if (!moduleName)
    throw new Error(
      'Module name parameter is not defined in getCreateControllerProperties function',
    );
  ...
  return properties
    ...
    .filter(
      (property) =>
        !hasI18nProperties(properties) ||
        (hasI18nProperties(properties) && property.name !== 'availableLangs'),
    ); // exclude availableLangs if has i18n table
};
...
export const getUpdateControllerProperties = (
  ...
  if (!moduleName)
    throw new Error(
      'Module name parameter is not defined in getUpdateControllerProperties function',
    );
...
export const getCreateServiceProperties = (
  ...
  if (!moduleName)
    throw new Error(
      'Module name parameter is not defined in getCreateServiceProperties function',
    );
...
export const getCreateItemsServiceProperties = (
  ...
  if (!moduleName)
    throw new Error(
      'Module name parameter is not defined in getCreateItemsServiceProperties function',
    );
...
export const getUpdateServiceProperties = (
  ...
  if (!moduleName)
    throw new Error(
      'Module name parameter is not defined in getUpdateServiceProperties function',
    );
...
export const getUpsertServiceProperties = (
  ...
  if (!moduleName)
    throw new Error(
      'Module name parameter is not defined in getUpsertServiceProperties function',
    );
...
export const getTestProperties = (
  ...
  if (!moduleName)
    throw new Error(
      'Module name parameter is not defined in getTestProperties function',
    );
...
export const getNotNullableProperties = (
  ...
  if (!moduleName)
    throw new Error(
      'Module name parameter is not defined in getNotNullableProperties function',
    );
...
export const getLengthProperties = (
  ...
  if (!moduleName)
    throw new Error(
      'Module name parameter is not defined in getLengthProperties function',
    );
    ...
    properties
      ...
      .filter(
        (property) =>
          !property.isI18n ||
          (property.isI18n &&
            property.name !== moduleName.toCamelCase() + 'Id'),
      ) // exclude relationship id of i18n table
      .filter(
        (property) =>
          !hasI18nProperties(properties) ||
...
export const getMaxLengthProperties = (properties: Property[]): Property[] => {
  return properties?.filter((property) => Boolean(property.maxLength));
};

// replace by Properties hasMinLength
export const getMinLengthProperties = (properties: Property[]): Property[] => {
  return properties?.filter((property) => Boolean(property.minLength));
};

// replace by Properties decimalProperties
export const getDecimalProperties = (properties: Property[]): Property[] => {
  return properties?.filter(
    (property) => property.type === PropertyType.DECIMAL,
  );
};

// replace by Properties isInteger
export const getIntegerProperties = (properties: Property[]): Property[] => {
...
export const getIntegerUnsignedProperties = (
  ...
  return properties?.filter(
    (property) => property.type === PropertyType.INT && property.unsigned,
  );
};

// replace by Properties isBoolean
export const getBooleanProperties = (properties: Property[]): Property[] => {
  return properties?.filter(
    (property) => property.type === PropertyType.BOOLEAN,
  );
};

// replace by Properties isTimestamp
export const getTimestampProperties = (properties: Property[]): Property[] => {
  return properties
    ?.filter((property) => !timestampProperties.includes(property.name)) // exclude timestamps
...
export const getPostmanGraphqlCreateMutationProperties = (
  ...
  if (!moduleName)
    throw new Error(
      'Module name parameter is not defined in getPostmanGraphqlCreateMutationProperties function',
    );
  ...
  return properties
    ...
    .filter(
      (property) =>
        property.relationship?.type !== RelationshipType.MANY_TO_MANY,
    ) // exclude many to many relations
    .filter(
      (property) =>
        !(
          property.relationship?.type === RelationshipType.ONE_TO_ONE &&
...
export const getPostmanGraphqlCreateVariablesProperties = (
  ...
  if (!moduleName)
    throw new Error(
      'Module name parameter is not defined in getPostmanGraphqlCreateVariablesProperties function',
    );
...
export const getPostmanGraphqlUpdateVariablesProperties = (
  ...
  if (!moduleName)
    throw new Error(
      'Module name parameter is not defined in getPostmanGraphqlUpdateVariablesProperties function',
    );
...
export const getGridFieldsProperties = (properties: Property[]): Property[] => {
  return properties
    ?.filter((property) => !timestampProperties.includes(property.name))
...
export const getFormDetailFieldsProperties = (
  ...
  return properties
    ?.filter((property) => !timestampProperties.includes(property.name))
    .filter((property) => property.name !== 'id')
    .filter((property) => !property.webComponent?.isDetailHidden)
    .sort((a, b) => {
...
export const getSelectWebComponentsProperties = (
  ...
  return properties?.filter(
    (property) => property.webComponent?.type === WebComponentType.SELECT,
  );
};
...
export const getMultipleSelectWebComponentsProperties = (
  ...
  return properties?.filter(
    (property) =>
      property.webComponent?.type === WebComponentType.MULTIPLE_SELECT,
  );
};
...
export const getAsyncSearchSelectWebComponentsProperties = (
  ...
  return properties?.filter(
    (property) =>
      property.webComponent?.type === WebComponentType.ASYNC_SEARCH_SELECT,
  );
};
...
export const getGridSelectElementWebComponentsProperties = (
  ...
  return properties?.filter(
    (property) =>
      property.webComponent?.type === WebComponentType.GRID_SELECT_ELEMENT,
  );
};
...
export const getGridSelectMultipleElementsWebComponentsProperties = (
  ...
  return properties?.filter(
    (property) =>
      property.webComponent?.type ===
      WebComponentType.GRID_SELECT_MULTIPLE_ELEMENTS,
  );
};
...
export const getGridElementsManagerWebComponentsProperties = (
  ...
  return properties?.filter(
    (property) =>
      property.webComponent?.type === WebComponentType.GRID_ELEMENTS_MANAGER,
  );
};
...
export const getImportWebComponentsManagerProperties = (
  ...
  if (hasI18nProperties(properties))
    importWebComponents.add('FlagLangComponent');
