...
class ExcludeOperations
{
    ...
    private operationsPatternPaths: { [key: string]: Set<string[]> } =
    {
        ...
        update: new Set([
            ['src', '@api', '__bounded_context_name__', '__module_name__', 'controllers', '__bounded_context_name__-update-__module_names__.controller.spec.ts'],
            ['src', '@api', '__bounded_context_name__', '__module_name__', 'controllers', '__bounded_context_name__-update-__module_names__.controller.ts'],
            ['src', '@api', '__bounded_context_name__', '__module_name__', 'handlers', '__bounded_context_name__-update-__module_names__.handler.spec.ts'],
            ['src', '@api', '__bounded_context_name__', '__module_name__', 'handlers', '__bounded_context_name__-update-__module_names__.handler.ts'],
            ['src', '@api', '__bounded_context_name__', '__module_name__', 'resolvers', '__bounded_context_name__-update-__module_names__.resolver.spec.ts'],
            ['src', '@api', '__bounded_context_name__', '__module_name__', 'resolvers', '__bounded_context_name__-update-__module_names__.resolver.ts'],
            ['src', '@app', '__bounded_context_name__', '__module_name__', 'application', 'update', '__bounded_context_name__-update-__module_names__.command-handler.spec.ts'],
            ['src', '@app', '__bounded_context_name__', '__module_name__', 'application', 'update', '__bounded_context_name__-update-__module_names__.command-handler.ts'],
            ['src', '@app', '__bounded_context_name__', '__module_name__', 'application', 'update', '__bounded_context_name__-update-__module_names__.command.ts'],
            ['src', '@app', '__bounded_context_name__', '__module_name__', 'application', 'update', '__bounded_context_name__-update-__module_names__.service.spec.ts'],
            ['src', '@app', '__bounded_context_name__', '__module_name__', 'application', 'update', '__bounded_context_name__-update-__module_names__.service.ts'],
            ['src', '@app', '__bounded_context_name__', '__module_name__', 'application', 'events', '__bounded_context_name__-updated-__module_names__.event-handler.ts'],
            ['src', '@app', '__bounded_context_name__', '__module_name__', 'application', 'events', '__bounded_context_name__-updated-__module_names__.event.ts'],
        ]),
        ...
        delete: new Set([
            ['src', '@api', '__bounded_context_name__', '__module_name__', 'controllers', '__bounded_context_name__-delete-__module_names__.controller.spec.ts'],
            ['src', '@api', '__bounded_context_name__', '__module_name__', 'controllers', '__bounded_context_name__-delete-__module_names__.controller.ts'],
            ['src', '@api', '__bounded_context_name__', '__module_name__', 'handlers', '__bounded_context_name__-delete-__module_names__.handler.spec.ts'],
            ['src', '@api', '__bounded_context_name__', '__module_name__', 'handlers', '__bounded_context_name__-delete-__module_names__.handler.ts'],
            ['src', '@api', '__bounded_context_name__', '__module_name__', 'resolvers', '__bounded_context_name__-delete-__module_names__.resolver.spec.ts'],
            ['src', '@api', '__bounded_context_name__', '__module_name__', 'resolvers', '__bounded_context_name__-delete-__module_names__.resolver.ts'],
            ['src', '@app', '__bounded_context_name__', '__module_name__', 'application', 'delete', '__bounded_context_name__-delete-__module_names__.command-handler.spec.ts'],
            ['src', '@app', '__bounded_context_name__', '__module_name__', 'application', 'delete', '__bounded_context_name__-delete-__module_names__.command-handler.ts'],
            ['src', '@app', '__bounded_context_name__', '__module_name__', 'application', 'delete', '__bounded_context_name__-delete-__module_names__.command.ts'],
            ['src', '@app', '__bounded_context_name__', '__module_name__', 'application', 'delete', '__bounded_context_name__-delete-__module_names__.service.spec.ts'],
            ['src', '@app', '__bounded_context_name__', '__module_name__', 'application', 'delete', '__bounded_context_name__-delete-__module_names__.service.ts'],
            ['src', '@app', '__bounded_context_name__', '__module_name__', 'application', 'events', '__bounded_context_name__-deleted-__module_names__.event-handler.ts'],
            ['src', '@app', '__bounded_context_name__', '__module_name__', 'application', 'events', '__bounded_context_name__-deleted-__module_names__.event.ts'],
        ]),
        count: new Set([
        ...
        getRaw: new Set([
            ['src', '@api', '__bounded_context_name__', '__module_name__', 'controllers', '__bounded_context_name__-get-raw-__module_names__.controller.spec.ts'],
            ['src', '@api', '__bounded_context_name__', '__module_name__', 'controllers', '__bounded_context_name__-get-raw-__module_names__.controller.ts'],
            ['src', '@api', '__bounded_context_name__', '__module_name__', 'handlers', '__bounded_context_name__-get-raw-__module_names__.handler.spec.ts'],
            ['src', '@api', '__bounded_context_name__', '__module_name__', 'handlers', '__bounded_context_name__-get-raw-__module_names__.handler.ts'],
            ['src', '@api', '__bounded_context_name__', '__module_name__', 'resolvers', '__bounded_context_name__-get-raw-__module_names__.resolver.spec.ts'],
            ['src', '@api', '__bounded_context_name__', '__module_name__', 'resolvers', '__bounded_context_name__-get-raw-__module_names__.resolver.ts'],
        ]),
    };
