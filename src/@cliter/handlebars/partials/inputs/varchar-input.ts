...
handlebars.registerPartial('varcharInput',
    ...
    <input matInput formControlName="{{ toCamelCase property.name }}"{{#if property.maxLength}} maxlength="{{ property.maxLength }}"{{/if}}{{#unless property.nullable }} required{{/unless}}>
